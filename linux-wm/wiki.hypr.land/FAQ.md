...
In that case, see the [Installation Page](https://wiki.hypr.land/Getting-Started/Installation)
and try compiling with LEGACY\_RENDERER

*For more info about bugs and crashes, see this*
*[wiki page](https://wiki.hypr.land/Crashes-and-Bugs)*
...
[Status bars](https://wiki.hypr.land/Useful-Utilities/Status-Bars) for solutions.
...
This is a side effect of the [decoration:blur:new\_optimizations](https://wiki.hypr.land/Configuring/Variables/#blur).
