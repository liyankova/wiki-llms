...
NVIDIA GPUs are often not usable out-of-the-box, follow the [Nvidia page](https://wiki.hypr.land/Nvidia) after installing
...
For more details, read the [Nix page](https://wiki.hypr.land/Nix).
...
[XDPH](https://wiki.hypr.land/Hypr-Ecosystem/xdg-desktop-portal-hyprland) and
