...
If you use the [Home Manager module](https://wiki.hypr.land/Nix/Hyprland-on-Home-Manager), make sure to disable the systemd integration, as it conflicts with uwsm.
...
Pay attention to the warnings in [Environment variables](https://wiki.hypr.land/Configuring/Environment-variables), [Multi-GPU](https://wiki.hypr.land/Configuring/Multi-GPU) and [Dispatchers](https://wiki.hypr.land/Configuring/Dispatchers) sections.
