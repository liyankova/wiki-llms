...
[overrideAttrs](https://wiki.hypr.land/Nix/Options-Overrides/#using-nix-repl) with
...
stacktraces from Hyprland, make sure it was [built in debug mode](https://wiki.hypr.land/Nix/Contributing-and-Debugging/#build-in-debug-mode).
...
[here](https://wiki.hypr.land/Crashes-and-Bugs#obtaining-a-debug-stacktrace), from step 3 onwards.
