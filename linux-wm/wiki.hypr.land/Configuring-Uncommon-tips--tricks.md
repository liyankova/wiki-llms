...
freedom. See [Using hyprctl](https://wiki.hypr.land/Configuring/Using-hyprctl).
...
This approach uses same principle as the [Minimize windows using special workspaces](https://wiki.hypr.land/Configuring/Uncommon-tips--tricks/#minimize-windows-using-special-workspaces) section.
