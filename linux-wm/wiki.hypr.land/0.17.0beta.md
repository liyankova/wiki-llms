---
url: https://wiki.hypr.land/0.17.0beta/
title: Hyprland Wiki
...
to try and use all Xorg applications on Wayland. See [this page](https://wiki.hypr.land/Useful-Utilities) for a
...
> [FAQ (GTK issue)](https://wiki.hypr.land/FAQ/#some-of-my-apps-take-a-really-long-time-to-open)
> and [FAQ (screensharing)](https://wiki.hypr.land/FAQ/#screenshare--obs-no-worky).
