...
Hyprland and some other projects under the hypr\* umbrella have *tests* that
...
GTests are GoogleTests that are *unit tests*. These tests simply check how
...
[PR Guidelines](https://wiki.hypr.land/Contributing-and-Debugging/PR-Guidelines/ "PR Guidelines")[Translations](https://wiki.hypr.land/Contributing-and-Debugging/Translations/ "Translations")