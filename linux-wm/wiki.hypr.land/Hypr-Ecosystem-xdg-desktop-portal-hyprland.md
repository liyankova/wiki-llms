...
[NixOS module for Hyprland](https://wiki.hypr.land/Nix/Hyprland-on-NixOS), through
...
and does not produce any error logs, it’s very likely your [XDG env variables](https://wiki.hypr.land/Configuring/Environment-variables/#xdg-specifications)
are messed up
...
[hyprlock](https://wiki.hypr.land/Hypr-Ecosystem/hyprlock/ "hyprlock")[hyprsysteminfo](https://wiki.hypr.land/Hypr-Ecosystem/hyprsysteminfo/ "hyprsysteminfo")