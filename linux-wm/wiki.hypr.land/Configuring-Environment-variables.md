...
[uwsm](https://wiki.hypr.land/Useful-Utilities/Systemd-start) users should avoid placing environment variables in the `hyprland.conf` file.  
...
[uwsm](https://wiki.hypr.land/Useful-Utilities/Systemd-start) users don’t need to explicitly set XDG environment variables, as uwsm sets them automatically.
