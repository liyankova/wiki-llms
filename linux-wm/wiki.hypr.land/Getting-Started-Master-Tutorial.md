...
Please take a look at [The Nvidia page](https://wiki.hypr.land/Nvidia) before launching. It has
...
See the [Must-have Software page](https://wiki.hypr.land/Useful-Utilities/Must-have) for the
crucial things to make Wayland / Hyprland / other apps work correctly.

## Monitors config

See [Configuring Hyprland page](https://wiki.hypr.land/Configuring/Monitors) to learn all about
configuring your displays.

## Apps / X11 replacements

See the [Useful Utilities page](https://wiki.hypr.land/Useful-Utilities) and the
...
Head onto the
[Configuring Hyprland page](https://wiki.hypr.land/Configuring) to learn all
about configuring Hyprland to your liking.

## Cursors

Cursors are a notorious pain to set up when you don’t know how. See
[this FAQ entry on changing your mouse cursor](https://wiki.hypr.land/FAQ#how-do-i-change-me-mouse-cursor)

If your cursor does not appear, see
[this FAQ entry on cursor not rendering](https://wiki.hypr.land/FAQ#me-cursor-no-render)
...
[here](https://wiki.hypr.land/Configuring/Environment-variables).
