...
[Dispatchers](https://wiki.hypr.land/Configuring/Dispatchers/#list-of-dispatchers).*
...
To get the correct name for an `unmodified_key`, refer to [the section on uncommon syms](https://wiki.hypr.land/Configuring/Binds/#uncommon-syms--binding-with-a-keycode)
...
| `m` | mouse | See the dedicated [Mouse Binds](https://wiki.hypr.land/Configuring/Binds/#mouse-binds) section. |
...
See the [`pass`](https://wiki.hypr.land/Configuring/Dispatchers/#list-of-dispatchers) and
[`sendshortcut`](https://wiki.hypr.land/Configuring/Dispatchers/#list-of-dispatchers) dispatchers for keybinds.
