---
url: https://docs.noctalia.dev/development/widget/
...
[Section titled “Overview”](https://docs.noctalia.dev/development/widget/#overview)

Adding a new widget is straightforward once you know the flow.  
You’ll go through these steps:

1. [Create the widget file](https://docs.noctalia.dev/development/widget/#step-1-create-the-widget-file)
2. [Register the widget in the registry](https://docs.noctalia.dev/development/widget/#step-2-register-the-widget-in-the-registry)
3. [Verify it shows up in the BarTab selector](https://docs.noctalia.dev/development/widget/#step-3-verify-it-shows-up-in-the-bartab-selector)
4. [Test the Widget from the Settings Panel](https://docs.noctalia.dev/development/widget/#step-4-test-the-widget-from-the-settings-panel)
5. [Add a settings UI](https://docs.noctalia.dev/development/widget/#step-5-add-a-settings-ui)
6. [Add more settings later (optional)](https://docs.noctalia.dev/development/widget/#step-6-optional-add-more-settings-later)
...
[Section titled “Step 1: Create the Widget File”](https://docs.noctalia.dev/development/widget/#step-1-create-the-widget-file)
...
[Section titled “Step 2: Register the Widget in the Registry”](https://docs.noctalia.dev/development/widget/#step-2-register-the-widget-in-the-registry)
...
[Section titled “Step 3: Verify It Shows Up in the BarTab Selector”](https://docs.noctalia.dev/development/widget/#step-3-verify-it-shows-up-in-the-bartab-selector)
...
[Section titled “Step 4: Test the Widget from the Settings Panel”](https://docs.noctalia.dev/development/widget/#step-4-test-the-widget-from-the-settings-panel)
...
[Section titled “Step 5: Add a Settings UI”](https://docs.noctalia.dev/development/widget/#step-5-add-a-settings-ui)
...
[Section titled “1) Create Modules/SettingsPanel/Bar/WidgetSettings/HelloWorldSettings.qml:”](https://docs.noctalia.dev/development/widget/#1-create-modulessettingspanelbarwidgetsettingshelloworldsettingsqml)
...
[Section titled “2) Map the settings component in Modules/SettingsPanel/Bar/BarWidgetSettingsDialog.qml:”](https://docs.noctalia.dev/development/widget/#2-map-the-settings-component-in-modulessettingspanelbarbarwidgetsettingsdialogqml)
...
[Section titled “Step 6 (Optional): Add More Settings Later”](https://docs.noctalia.dev/development/widget/#step-6-optional-add-more-settings-later)
