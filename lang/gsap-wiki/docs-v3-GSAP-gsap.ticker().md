...
title: gsap.ticker() | GSAP | Docs & Learning
...
2. **deltaTime** : *Number* - the amount of milliseconds that elapsed since the previous tick. Note: you can use [gsap.ticker.deltaRatio()](https://gsap.com/docs/v3/GSAP/gsap.ticker()#deltaRatio) to get a ratio instead that's based on a certain target FPS.
