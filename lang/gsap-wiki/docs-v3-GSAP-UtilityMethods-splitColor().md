---
url: https://gsap.com/docs/v3/GSAP/UtilityMethods/splitColor()
...
### Returns : Array[​](https://gsap.com/docs/v3/GSAP/UtilityMethods/splitColor()#returns--array "Direct link to Returns : Array")
