---
url: https://gsap.com/resources/get-started
...
The GreenSock Animation Platform (GSAP) is an industry-celebrated suite of tools used on over 11 million sites, including a ton of [award‑winning](https://www.awwwards.com/websites/gsap-animation) ones! You can use GSAP to **animate pretty much** ***anything JavaScript can touch, in any framework.*** Whether you want to animate UI, SVG, Three.js or React components - [GSAP has you covered](https://gsap.com/blog/why-gsap/).
...
## Repeats and alternating repeats[​](https://gsap.com/resources/get-started#repeats-and-alternating-repeats "Direct link to Repeats and alternating repeats")
