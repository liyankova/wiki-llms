---
url: https://bun.com/docs/runtime/c-compiler
...
## [​](https://bun.com/docs/runtime/c-compiler#usage-cc-in-bun:ffi) Usage (cc in `bun:ffi`)
...
### [​](https://bun.com/docs/runtime/c-compiler#primitive-types) Primitive types
...
### [​](https://bun.com/docs/runtime/c-compiler#strings,-objects,-and-non-primitive-types) Strings, objects, and non-primitive types
...
#### [​](https://bun.com/docs/runtime/c-compiler#returning-a-c-string-to-javascript) Returning a C string to JavaScript
...
### [​](https://bun.com/docs/runtime/c-compiler#cc-reference) `cc` Reference

#### [​](https://bun.com/docs/runtime/c-compiler#library:-string[]) `library: string[]`
...
#### [​](https://bun.com/docs/runtime/c-compiler#symbols) `symbols`
...
#### [​](https://bun.com/docs/runtime/c-compiler#source) `source`
...
#### [​](https://bun.com/docs/runtime/c-compiler#flags:-string-|-string[]) `flags: string | string[]`
...
#### [​](https://bun.com/docs/runtime/c-compiler#define:-record<string,-string>) `define: Record<string, string>`
...
[Suggest edits](https://github.com/oven-sh/bun/edit/main/docs/runtime/c-compiler.mdx)[Raise issue](https://github.com/oven-sh/bun/issues/new?title=Issue on docs&body=Path: /runtime/c-compiler)
