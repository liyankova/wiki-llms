---
url: https://bun.com/docs/runtime/s3
title: S3 - Bun
...
### [​](https://bun.com/docs/runtime/s3#bun’s-s3-api-is-fast) Bun’s S3 API is fast

![Bun's S3 API is fast](https://mintcdn.com/bun-1dd33a4e/DJXb5ll7I0cV-M4b/images/bun-s3-node.gif?s=2aa9cc04d2ae08fae0838cac5d18154b)
...
![https://mintcdn.com/bun-1dd33a4e/Hq64iapoQXHbYMEN/icons/typescript.svg?fit=max&auto=format&n=Hq64iapoQXHbYMEN&q=85&s=c6cceedec8f82d2cc803d7c6ec82b240](https://mintcdn.com/bun-1dd33a4e/Hq64iapoQXHbYMEN/icons/typescript.svg?fit=max&auto=format&n=Hq64iapoQXHbYMEN&q=85&s=c6cceedec8f82d2cc803d7c6ec82b240)s3.ts
...
## [​](https://bun.com/docs/runtime/s3#basic-usage) Basic Usage

There are several ways to interact with Bun’s S3 API.

### [​](https://bun.com/docs/runtime/s3#bun-s3client-&-bun-s3) `Bun.S3Client` & `Bun.s3`
...
### [​](https://bun.com/docs/runtime/s3#working-with-s3-files) Working with S3 Files
...
### [​](https://bun.com/docs/runtime/s3#reading-files-from-s3) Reading files from S3
...
#### [​](https://bun.com/docs/runtime/s3#memory-optimization) Memory optimization
...
### [​](https://bun.com/docs/runtime/s3#writing-&-uploading-files-to-s3) Writing & uploading files to S3
...
### [​](https://bun.com/docs/runtime/s3#working-with-large-files-streams) Working with large files (streams)
...
## [​](https://bun.com/docs/runtime/s3#presigning-urls) Presigning URLs
...
### [​](https://bun.com/docs/runtime/s3#setting-acls) Setting ACLs
...
### [​](https://bun.com/docs/runtime/s3#expiring-urls) Expiring URLs
...
### [​](https://bun.com/docs/runtime/s3#method) `method`
...
### [​](https://bun.com/docs/runtime/s3#new-response-s3file) `new Response(S3File)`
...
## [​](https://bun.com/docs/runtime/s3#support-for-s3-compatible-services) Support for S3-Compatible Services

Bun’s S3 implementation works with any S3-compatible storage service. Just specify the appropriate endpoint:

### [​](https://bun.com/docs/runtime/s3#using-bun’s-s3client-with-aws-s3) Using Bun’s S3Client with AWS S3
...
### [​](https://bun.com/docs/runtime/s3#using-bun’s-s3client-with-google-cloud-storage) Using Bun’s S3Client with Google Cloud Storage
...
### [​](https://bun.com/docs/runtime/s3#using-bun’s-s3client-with-cloudflare-r2) Using Bun’s S3Client with Cloudflare R2
...
### [​](https://bun.com/docs/runtime/s3#using-bun’s-s3client-with-digitalocean-spaces) Using Bun’s S3Client with DigitalOcean Spaces
...
### [​](https://bun.com/docs/runtime/s3#using-bun’s-s3client-with-minio) Using Bun’s S3Client with MinIO
...
### [​](https://bun.com/docs/runtime/s3#using-bun’s-s3client-with-supabase) Using Bun’s S3Client with supabase
...
### [​](https://bun.com/docs/runtime/s3#using-bun’s-s3client-with-s3-virtual-hosted-style-endpoints) Using Bun’s S3Client with S3 Virtual Hosted-Style endpoints
...
## [​](https://bun.com/docs/runtime/s3#credentials) Credentials
...
These environment variables are read from [`.env` files](https://bun.com/docs/runtime/environment-variables) or from the process environment at initialization time (`process.env` is not used for this).
...
### [​](https://bun.com/docs/runtime/s3#s3client-objects) `S3Client` objects
...
### [​](https://bun.com/docs/runtime/s3#s3client-prototype-write) `S3Client.prototype.write`
...
### [​](https://bun.com/docs/runtime/s3#s3client-prototype-delete) `S3Client.prototype.delete`
...
### [​](https://bun.com/docs/runtime/s3#s3client-prototype-exists) `S3Client.prototype.exists`
...
## [​](https://bun.com/docs/runtime/s3#s3file) `S3File`
...
### [​](https://bun.com/docs/runtime/s3#partial-reads-with-slice) Partial reads with `slice`
...
### [​](https://bun.com/docs/runtime/s3#deleting-files-from-s3) Deleting files from S3
...
## [​](https://bun.com/docs/runtime/s3#error-codes) Error codes
...
## [​](https://bun.com/docs/runtime/s3#s3client-static-methods) `S3Client` static methods

The `S3Client` class provides several static methods for interacting with S3.

### [​](https://bun.com/docs/runtime/s3#s3client-write-static) `S3Client.write` (static)
...
### [​](https://bun.com/docs/runtime/s3#s3client-presign-static) `S3Client.presign` (static)
...
### [​](https://bun.com/docs/runtime/s3#s3client-list-static) `S3Client.list` (static)
...
### [​](https://bun.com/docs/runtime/s3#s3client-exists-static) `S3Client.exists` (static)
...
### [​](https://bun.com/docs/runtime/s3#s3client-size-static) `S3Client.size` (static)
...
### [​](https://bun.com/docs/runtime/s3#s3client-stat-static) `S3Client.stat` (static)
...
### [​](https://bun.com/docs/runtime/s3#s3client-delete-static) `S3Client.delete` (static)
...
### [​](https://bun.com/docs/runtime/s3#utf-8,-utf-16,-and-bom-byte-order-mark) UTF-8, UTF-16, and BOM (byte order mark)
...
[Suggest edits](https://github.com/oven-sh/bun/edit/main/docs/runtime/s3.mdx)[Raise issue](https://github.com/oven-sh/bun/issues/new?title=Issue on docs&body=Path: /runtime/s3)
