---
url: https://bun.com/docs/runtime/ffi
title: FFI - Bun
...
stable way to interact with native code from Bun is to write a [Node-API module](https://bun.com/docs/runtime/node-api).
...
## [​](https://bun.com/docs/runtime/ffi#dlopen-usage-bun:ffi) dlopen usage (`bun:ffi`)
...
## [​](https://bun.com/docs/runtime/ffi#performance) Performance
...
## [​](https://bun.com/docs/runtime/ffi#usage) Usage

### [​](https://bun.com/docs/runtime/ffi#zig) Zig
...
### [​](https://bun.com/docs/runtime/ffi#rust) Rust
...
### [​](https://bun.com/docs/runtime/ffi#c++) C++
...
## [​](https://bun.com/docs/runtime/ffi#ffi-types) FFI types
...
## [​](https://bun.com/docs/runtime/ffi#strings) Strings
...
## [​](https://bun.com/docs/runtime/ffi#function-pointers) Function pointers
...
## [​](https://bun.com/docs/runtime/ffi#callbacks) Callbacks
...
### [​](https://bun.com/docs/runtime/ffi#experimental-thread-safe-callbacks) Experimental thread-safe callbacks
...
Currently, thread-safe callbacks work best when run from another thread that is running JavaScript code, i.e. a [`Worker`](https://bun.com/docs/runtime/workers). A future version of Bun will enable them to be called from any thread (such as new threads spawned by your native library that Bun is not aware of).
...
## [​](https://bun.com/docs/runtime/ffi#pointers) Pointers
...
### [​](https://bun.com/docs/runtime/ffi#memory-management) Memory management

`bun:ffi` does not manage memory for you. You must free the memory when you’re done with it.

#### [​](https://bun.com/docs/runtime/ffi#from-javascript) From JavaScript
...
#### [​](https://bun.com/docs/runtime/ffi#from-c,-rust,-zig,-etc) From C, Rust, Zig, etc
...
### [​](https://bun.com/docs/runtime/ffi#memory-safety) Memory safety
...
### [​](https://bun.com/docs/runtime/ffi#pointer-alignment) Pointer alignment
...
### [​](https://bun.com/docs/runtime/ffi#passing-a-pointer) Passing a pointer
...
### [​](https://bun.com/docs/runtime/ffi#reading-pointers) Reading pointers
...
[Suggest edits](https://github.com/oven-sh/bun/edit/main/docs/runtime/ffi.mdx)[Raise issue](https://github.com/oven-sh/bun/issues/new?title=Issue on docs&body=Path: /runtime/ffi)
