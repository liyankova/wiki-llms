...
| Class | Description |
| --- | --- |
| [`TypedArray`](https://bun.com/docs/runtime/binary-data#typedarray) | A family of classes that provide an `Array`-like interface for interacting with binary data. Includes `Uint8Array`, `Uint16Array`, `Int8Array`, and more. |
| [`Buffer`](https://bun.com/docs/runtime/binary-data#buffer) | A subclass of `Uint8Array` that implements a wide range of convenience methods. Unlike the other elements in this table, this is a Node.js API (which Bun implements). It can’t be used in the browser. |
| [`DataView`](https://bun.com/docs/runtime/binary-data#dataview) | A class that provides a `get/set` API for writing some number of bytes to an `ArrayBuffer` at a particular byte offset. Often used reading or writing binary protocols. |
| [`Blob`](https://bun.com/docs/runtime/binary-data#blob) | A readonly blob of binary data usually representing a file. Has a MIME `type`, a `size`, and methods for converting to `ArrayBuffer`, `ReadableStream`, and string. |
| [`File`](https://bun.com/docs/runtime/binary-data#file) | A subclass of `Blob` that represents a file. Has a `name` and `lastModified` timestamp. There is experimental support in Node.js v20. |
| [`BunFile`](https://bun.com/docs/runtime/binary-data#bunfile) | *Bun only*. A subclass of `Blob` that represents a lazily-loaded file on disk. Created with `Bun.file(path)`. |

---

## [​](https://bun.com/docs/runtime/binary-data#arraybuffer-and-views) `ArrayBuffer` and views
...
### [​](https://bun.com/docs/runtime/binary-data#dataview) `DataView`
...
### [​](https://bun.com/docs/runtime/binary-data#typedarray) `TypedArray`
...
### [​](https://bun.com/docs/runtime/binary-data#uint8array) `Uint8Array`
...
### [​](https://bun.com/docs/runtime/binary-data#buffer) `Buffer`
...
## [​](https://bun.com/docs/runtime/binary-data#blob) `Blob`
...
### [​](https://bun.com/docs/runtime/binary-data#bunfile) `BunFile`
...
### [​](https://bun.com/docs/runtime/binary-data#file) `File`
...
## [​](https://bun.com/docs/runtime/binary-data#streams) Streams
...
## [​](https://bun.com/docs/runtime/binary-data#conversion) Conversion

Converting from one binary format to another is a common task. This section is intended as a reference.

### [​](https://bun.com/docs/runtime/binary-data#from-arraybuffer) From `ArrayBuffer`
...
#### [​](https://bun.com/docs/runtime/binary-data#to-typedarray) To `TypedArray`
...
#### [​](https://bun.com/docs/runtime/binary-data#to-dataview) To `DataView`
...
#### [​](https://bun.com/docs/runtime/binary-data#to-buffer) To `Buffer`
...
#### [​](https://bun.com/docs/runtime/binary-data#to-string) To `string`
...
#### [​](https://bun.com/docs/runtime/binary-data#to-number[]) To `number[]`
...
#### [​](https://bun.com/docs/runtime/binary-data#to-blob) To `Blob`
...
#### [​](https://bun.com/docs/runtime/binary-data#to-readablestream) To `ReadableStream`
...
### [​](https://bun.com/docs/runtime/binary-data#from-typedarray) From `TypedArray`

#### [​](https://bun.com/docs/runtime/binary-data#to-arraybuffer) To `ArrayBuffer`
...
#### [​](https://bun.com/docs/runtime/binary-data#to-dataview-2) To `DataView`
...
#### [​](https://bun.com/docs/runtime/binary-data#to-buffer-2) To `Buffer`
...
#### [​](https://bun.com/docs/runtime/binary-data#to-string-2) To `string`
...
#### [​](https://bun.com/docs/runtime/binary-data#to-number[]-2) To `number[]`
...
#### [​](https://bun.com/docs/runtime/binary-data#to-blob-2) To `Blob`
...
#### [​](https://bun.com/docs/runtime/binary-data#to-readablestream-2) To `ReadableStream`
...
### [​](https://bun.com/docs/runtime/binary-data#from-dataview) From `DataView`

#### [​](https://bun.com/docs/runtime/binary-data#to-arraybuffer-2) To `ArrayBuffer`
...
#### [​](https://bun.com/docs/runtime/binary-data#to-typedarray-2) To `TypedArray`
...
#### [​](https://bun.com/docs/runtime/binary-data#to-buffer-3) To `Buffer`
...
#### [​](https://bun.com/docs/runtime/binary-data#to-string-3) To `string`
...
#### [​](https://bun.com/docs/runtime/binary-data#to-number[]-3) To `number[]`
...
#### [​](https://bun.com/docs/runtime/binary-data#to-blob-3) To `Blob`
...
#### [​](https://bun.com/docs/runtime/binary-data#to-readablestream-3) To `ReadableStream`
...
### [​](https://bun.com/docs/runtime/binary-data#from-buffer) From `Buffer`

#### [​](https://bun.com/docs/runtime/binary-data#to-arraybuffer-3) To `ArrayBuffer`
...
#### [​](https://bun.com/docs/runtime/binary-data#to-typedarray-3) To `TypedArray`
...
#### [​](https://bun.com/docs/runtime/binary-data#to-dataview-3) To `DataView`
...
#### [​](https://bun.com/docs/runtime/binary-data#to-string-4) To `string`
...
#### [​](https://bun.com/docs/runtime/binary-data#to-number[]-4) To `number[]`
...
#### [​](https://bun.com/docs/runtime/binary-data#to-blob-4) To `Blob`
...
#### [​](https://bun.com/docs/runtime/binary-data#to-readablestream-4) To `ReadableStream`
...
### [​](https://bun.com/docs/runtime/binary-data#from-blob) From `Blob`

#### [​](https://bun.com/docs/runtime/binary-data#to-arraybuffer-4) To `ArrayBuffer`
...
#### [​](https://bun.com/docs/runtime/binary-data#to-typedarray-4) To `TypedArray`
...
#### [​](https://bun.com/docs/runtime/binary-data#to-dataview-4) To `DataView`
...
#### [​](https://bun.com/docs/runtime/binary-data#to-buffer-4) To `Buffer`
...
#### [​](https://bun.com/docs/runtime/binary-data#to-string-5) To `string`
...
#### [​](https://bun.com/docs/runtime/binary-data#to-number[]-5) To `number[]`
...
#### [​](https://bun.com/docs/runtime/binary-data#to-readablestream-5) To `ReadableStream`
...
### [​](https://bun.com/docs/runtime/binary-data#from-readablestream) From `ReadableStream`
...
#### [​](https://bun.com/docs/runtime/binary-data#to-arraybuffer-5) To `ArrayBuffer`
...
#### [​](https://bun.com/docs/runtime/binary-data#to-uint8array) To `Uint8Array`
...
#### [​](https://bun.com/docs/runtime/binary-data#to-typedarray-5) To `TypedArray`
...
#### [​](https://bun.com/docs/runtime/binary-data#to-dataview-5) To `DataView`
...
#### [​](https://bun.com/docs/runtime/binary-data#to-buffer-5) To `Buffer`
...
#### [​](https://bun.com/docs/runtime/binary-data#to-string-6) To `string`
...
#### [​](https://bun.com/docs/runtime/binary-data#to-number[]-6) To `number[]`
...
#### [​](https://bun.com/docs/runtime/binary-data#to-blob-5) To `Blob`
...
#### [​](https://bun.com/docs/runtime/binary-data#to-readablestream-6) To `ReadableStream`
...
[Suggest edits](https://github.com/oven-sh/bun/edit/main/docs/runtime/binary-data.mdx)[Raise issue](https://github.com/oven-sh/bun/issues/new?title=Issue on docs&body=Path: /runtime/binary-data)
