---
url: https://bun.com/docs/test/dom
title: DOM testing - Bun
...
## [​](https://bun.com/docs/test/dom#happy-dom) happy-dom
...
### [​](https://bun.com/docs/test/dom#typescript-support) TypeScript Support
...
## [​](https://bun.com/docs/test/dom#react-testing-library) React Testing Library
...
![https://mintcdn.com/bun-1dd33a4e/Hq64iapoQXHbYMEN/icons/typescript.svg?fit=max&auto=format&n=Hq64iapoQXHbYMEN&q=85&s=c6cceedec8f82d2cc803d7c6ec82b240](https://mintcdn.com/bun-1dd33a4e/Hq64iapoQXHbYMEN/icons/typescript.svg?fit=max&auto=format&n=Hq64iapoQXHbYMEN&q=85&s=c6cceedec8f82d2cc803d7c6ec82b240)component.test.tsx
...
## [​](https://bun.com/docs/test/dom#advanced-dom-testing) Advanced DOM Testing

### [​](https://bun.com/docs/test/dom#custom-elements) Custom Elements

You can test custom elements and web components using the same setup:

![https://mintcdn.com/bun-1dd33a4e/Hq64iapoQXHbYMEN/icons/typescript.svg?fit=max&auto=format&n=Hq64iapoQXHbYMEN&q=85&s=c6cceedec8f82d2cc803d7c6ec82b240](https://mintcdn.com/bun-1dd33a4e/Hq64iapoQXHbYMEN/icons/typescript.svg?fit=max&auto=format&n=Hq64iapoQXHbYMEN&q=85&s=c6cceedec8f82d2cc803d7c6ec82b240)custom-element.test.ts
...
### [​](https://bun.com/docs/test/dom#event-testing) Event Testing

Test DOM events and user interactions:

![https://mintcdn.com/bun-1dd33a4e/Hq64iapoQXHbYMEN/icons/typescript.svg?fit=max&auto=format&n=Hq64iapoQXHbYMEN&q=85&s=c6cceedec8f82d2cc803d7c6ec82b240](https://mintcdn.com/bun-1dd33a4e/Hq64iapoQXHbYMEN/icons/typescript.svg?fit=max&auto=format&n=Hq64iapoQXHbYMEN&q=85&s=c6cceedec8f82d2cc803d7c6ec82b240)events.test.ts
...
## [​](https://bun.com/docs/test/dom#configuration-tips) Configuration Tips

### [​](https://bun.com/docs/test/dom#global-setup) Global Setup
...
## [​](https://bun.com/docs/test/dom#troubleshooting) Troubleshooting

### [​](https://bun.com/docs/test/dom#common-issues) Common Issues
...
### [​](https://bun.com/docs/test/dom#performance-considerations) Performance Considerations
...
[Suggest edits](https://github.com/oven-sh/bun/edit/main/docs/test/dom.mdx)[Raise issue](https://github.com/oven-sh/bun/issues/new?title=Issue on docs&body=Path: /test/dom)
