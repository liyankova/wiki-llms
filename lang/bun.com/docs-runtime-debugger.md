...
## [​](https://bun.com/docs/runtime/debugger#debugging-javascript-and-typescript) Debugging JavaScript and TypeScript
...
### [​](https://bun.com/docs/runtime/debugger#inspect) `--inspect`
...
### [​](https://bun.com/docs/runtime/debugger#inspect-brk) `--inspect-brk`
...
### [​](https://bun.com/docs/runtime/debugger#inspect-wait) `--inspect-wait`
...
### [​](https://bun.com/docs/runtime/debugger#setting-a-port-or-url-for-the-debugger) Setting a port or URL for the debugger
...
## [​](https://bun.com/docs/runtime/debugger#debuggers) Debuggers

Various debugging tools can connect to this server to provide an interactive debugging experience.

### [​](https://bun.com/docs/runtime/debugger#debug-bun-sh) `debug.bun.sh`
...
### [​](https://bun.com/docs/runtime/debugger#visual-studio-code-debugger) Visual Studio Code Debugger
...
## [​](https://bun.com/docs/runtime/debugger#debugging-network-requests) Debugging Network Requests
...
### [​](https://bun.com/docs/runtime/debugger#print-fetch-&-node:http-requests-as-curl-commands) Print fetch & node:http requests as curl commands
...
## [​](https://bun.com/docs/runtime/debugger#stacktraces-&-sourcemaps) Stacktraces & sourcemaps
...
### [​](https://bun.com/docs/runtime/debugger#syntax-highlighted-source-code-preview) Syntax-highlighted source code preview
...
### [​](https://bun.com/docs/runtime/debugger#v8-stack-traces) V8 Stack Traces
...
#### [​](https://bun.com/docs/runtime/debugger#v8-stack-trace-api) V8 Stack Trace API
...
[Suggest edits](https://github.com/oven-sh/bun/edit/main/docs/runtime/debugger.mdx)[Raise issue](https://github.com/oven-sh/bun/issues/new?title=Issue on docs&body=Path: /runtime/debugger)
