...
Under Bun-style module resolution, all imported packages are auto-installed on the fly into a [global module cache](https://bun.com/docs/pm/global-cache) during execution (the same cache used by [`bun install`](https://bun.com/docs/pm/cli/install)).
...
## [​](https://bun.com/docs/runtime/auto-install#version-resolution) Version resolution
...
## [​](https://bun.com/docs/runtime/auto-install#cache-behavior) Cache behavior
...
## [​](https://bun.com/docs/runtime/auto-install#installation) Installation
...
## [​](https://bun.com/docs/runtime/auto-install#version-specifiers) Version specifiers
...
## [​](https://bun.com/docs/runtime/auto-install#benefits) Benefits
...
## [​](https://bun.com/docs/runtime/auto-install#limitations) Limitations
...
## [​](https://bun.com/docs/runtime/auto-install#faq) FAQ
