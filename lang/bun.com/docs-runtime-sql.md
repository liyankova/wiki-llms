---
url: https://bun.com/docs/runtime/sql
title: SQL - Bun
...
### [​](https://bun.com/docs/runtime/sql#features) Features
...
## [​](https://bun.com/docs/runtime/sql#database-support) Database Support

`Bun.SQL` provides a unified API for multiple database systems:

### [​](https://bun.com/docs/runtime/sql#postgresql) PostgreSQL
...
### [​](https://bun.com/docs/runtime/sql#mysql) MySQL
...
### [​](https://bun.com/docs/runtime/sql#sqlite) SQLite
...
## [​](https://bun.com/docs/runtime/sql#inserting-data) Inserting data
...
### [​](https://bun.com/docs/runtime/sql#bulk-insert) Bulk Insert
...
### [​](https://bun.com/docs/runtime/sql#picking-columns-to-insert) Picking columns to insert
...
## [​](https://bun.com/docs/runtime/sql#query-results) Query Results
...
### [​](https://bun.com/docs/runtime/sql#sql``-values-format) ``` sql``.values() ``` format
...
### [​](https://bun.com/docs/runtime/sql#sql``-raw-format) ``` sql``.raw() ``` format
...
## [​](https://bun.com/docs/runtime/sql#sql-fragments) SQL Fragments
...
### [​](https://bun.com/docs/runtime/sql#dynamic-table-names) Dynamic Table Names
...
### [​](https://bun.com/docs/runtime/sql#conditional-queries) Conditional Queries
...
### [​](https://bun.com/docs/runtime/sql#dynamic-columns-in-updates) Dynamic columns in updates
...
### [​](https://bun.com/docs/runtime/sql#dynamic-values-and-where-in) Dynamic values and `where in`
...
### [​](https://bun.com/docs/runtime/sql#sql-array-helper) `sql.array` helper
...
## [​](https://bun.com/docs/runtime/sql#sql``-simple) ``` sql``.simple() ```
...
### [​](https://bun.com/docs/runtime/sql#queries-in-files) Queries in files

You can use the `sql.file` method to read a query from a file and execute it, if the file includes 1,1, 1,2, etc you can pass parameters to the query. If no parameters are used it can execute multiple commands per file.
...
### [​](https://bun.com/docs/runtime/sql#unsafe-queries) Unsafe Queries
...
### [​](https://bun.com/docs/runtime/sql#execute-and-cancelling-queries) Execute and Cancelling Queries
...
## [​](https://bun.com/docs/runtime/sql#database-environment-variables) Database Environment Variables
...
### [​](https://bun.com/docs/runtime/sql#automatic-database-detection) Automatic Database Detection
...
#### [​](https://bun.com/docs/runtime/sql#mysql-auto-detection) MySQL Auto-Detection
...
#### [​](https://bun.com/docs/runtime/sql#sqlite-auto-detection) SQLite Auto-Detection
...
#### [​](https://bun.com/docs/runtime/sql#postgresql-auto-detection) PostgreSQL Auto-Detection
...
### [​](https://bun.com/docs/runtime/sql#mysql-environment-variables) MySQL Environment Variables
...
### [​](https://bun.com/docs/runtime/sql#postgresql-environment-variables) PostgreSQL Environment Variables
...
### [​](https://bun.com/docs/runtime/sql#sqlite-environment-variables) SQLite Environment Variables
...
## [​](https://bun.com/docs/runtime/sql#runtime-preconnection) Runtime Preconnection
...
## [​](https://bun.com/docs/runtime/sql#connection-options) Connection Options
...
### [​](https://bun.com/docs/runtime/sql#mysql-options) MySQL Options
...
### [​](https://bun.com/docs/runtime/sql#postgresql-options) PostgreSQL Options
...
### [​](https://bun.com/docs/runtime/sql#sqlite-options) SQLite Options
...
## [​](https://bun.com/docs/runtime/sql#dynamic-passwords) Dynamic passwords
...
## [​](https://bun.com/docs/runtime/sql#sqlite-specific-features) SQLite-Specific Features

### [​](https://bun.com/docs/runtime/sql#query-execution) Query Execution
...
### [​](https://bun.com/docs/runtime/sql#sqlite-pragmas) SQLite Pragmas
...
### [​](https://bun.com/docs/runtime/sql#data-type-differences) Data Type Differences
...
## [​](https://bun.com/docs/runtime/sql#transactions) Transactions
...
### [​](https://bun.com/docs/runtime/sql#basic-transactions) Basic Transactions
...
### [​](https://bun.com/docs/runtime/sql#savepoints) Savepoints
...
### [​](https://bun.com/docs/runtime/sql#distributed-transactions) Distributed Transactions
...
## [​](https://bun.com/docs/runtime/sql#authentication) Authentication
...
### [​](https://bun.com/docs/runtime/sql#ssl-modes-overview) SSL Modes Overview
...
### [​](https://bun.com/docs/runtime/sql#using-with-connection-strings) Using With Connection Strings
...
## [​](https://bun.com/docs/runtime/sql#connection-pooling) Connection Pooling
...
## [​](https://bun.com/docs/runtime/sql#reserved-connections) Reserved Connections
...
## [​](https://bun.com/docs/runtime/sql#prepared-statements) Prepared Statements
...
## [​](https://bun.com/docs/runtime/sql#error-handling) Error Handling
...
### [​](https://bun.com/docs/runtime/sql#error-classes) Error Classes
...
### [​](https://bun.com/docs/runtime/sql#postgresql-connection-errors) PostgreSQL Connection Errors
...
### [​](https://bun.com/docs/runtime/sql#authentication-errors) Authentication Errors
...
### [​](https://bun.com/docs/runtime/sql#query-errors) Query Errors
...
### [​](https://bun.com/docs/runtime/sql#data-type-errors) Data Type Errors
...
### [​](https://bun.com/docs/runtime/sql#transaction-errors) Transaction Errors
...
### [​](https://bun.com/docs/runtime/sql#sqlite-specific-errors) SQLite-Specific Errors
...
## [​](https://bun.com/docs/runtime/sql#numbers-and-bigint) Numbers and BigInt
...
## [​](https://bun.com/docs/runtime/sql#bigint-instead-of-strings) BigInt Instead of Strings
...
## [​](https://bun.com/docs/runtime/sql#roadmap) Roadmap
...
## [​](https://bun.com/docs/runtime/sql#database-specific-features) Database-Specific Features

#### [​](https://bun.com/docs/runtime/sql#authentication-methods) Authentication Methods
...
#### [​](https://bun.com/docs/runtime/sql#prepared-statements-&-performance) Prepared Statements & Performance
...
#### [​](https://bun.com/docs/runtime/sql#multiple-result-sets) Multiple Result Sets
...
#### [​](https://bun.com/docs/runtime/sql#character-sets-&-collations) Character Sets & Collations
...
#### [​](https://bun.com/docs/runtime/sql#connection-attributes) Connection Attributes
...
#### [​](https://bun.com/docs/runtime/sql#type-handling) Type Handling
...
#### [​](https://bun.com/docs/runtime/sql#differences-from-postgresql) Differences from PostgreSQL
...
### [​](https://bun.com/docs/runtime/sql#mysql-specific-features) MySQL-Specific Features

We haven’t implemented `LOAD DATA INFILE` support yet

### [​](https://bun.com/docs/runtime/sql#postgresql-specific-features) PostgreSQL-Specific Features
...
## [​](https://bun.com/docs/runtime/sql#common-patterns-&-best-practices) Common Patterns & Best Practices

### [​](https://bun.com/docs/runtime/sql#working-with-mysql-result-sets) Working with MySQL Result Sets
...
### [​](https://bun.com/docs/runtime/sql#mysql-error-handling) MySQL Error Handling
...
### [​](https://bun.com/docs/runtime/sql#performance-tips-for-mysql) Performance Tips for MySQL
...
## [​](https://bun.com/docs/runtime/sql#frequently-asked-questions) Frequently Asked Questions
...
## [​](https://bun.com/docs/runtime/sql#why-not-just-use-an-existing-library) Why not just use an existing library?
...
## [​](https://bun.com/docs/runtime/sql#credits) Credits
...
[Suggest edits](https://github.com/oven-sh/bun/edit/main/docs/runtime/sql.mdx)[Raise issue](https://github.com/oven-sh/bun/issues/new?title=Issue on docs&body=Path: /runtime/sql)
