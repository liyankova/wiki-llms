---
url: https://bun.com/docs/guides/streams/to-arraybuffer
title: Convert a ReadableStream to an ArrayBuffer - Bun
source_domain: bun.com
---

# Convert a ReadableStream to an ArrayBuffer - Bun
