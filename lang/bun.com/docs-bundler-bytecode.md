---
url: https://bun.com/docs/bundler/bytecode
title: Bytecode Caching - Bun
...
## [​](https://bun.com/docs/bundler/bytecode#usage) Usage

### [​](https://bun.com/docs/bundler/bytecode#basic-usage) Basic usage
...
### [​](https://bun.com/docs/bundler/bytecode#with-standalone-executables) With standalone executables
...
### [​](https://bun.com/docs/bundler/bytecode#combining-with-other-optimizations) Combining with other optimizations
...
## [​](https://bun.com/docs/bundler/bytecode#performance-impact) Performance impact
...
## [​](https://bun.com/docs/bundler/bytecode#when-to-use-bytecode) When to use bytecode

### [​](https://bun.com/docs/bundler/bytecode#great-for:) Great for:

#### [​](https://bun.com/docs/bundler/bytecode#cli-tools) CLI tools
...
#### [​](https://bun.com/docs/bundler/bytecode#build-tools-and-task-runners) Build tools and task runners
...
#### [​](https://bun.com/docs/bundler/bytecode#standalone-executables) Standalone executables
...
### [​](https://bun.com/docs/bundler/bytecode#skip-it-for:) Skip it for:
...
## [​](https://bun.com/docs/bundler/bytecode#limitations) Limitations

### [​](https://bun.com/docs/bundler/bytecode#commonjs-only) CommonJS only
...
### [​](https://bun.com/docs/bundler/bytecode#version-compatibility) Version compatibility
...
### [​](https://bun.com/docs/bundler/bytecode#source-code-still-required) Source code still required
...
### [​](https://bun.com/docs/bundler/bytecode#bytecode-is-not-obfuscation) Bytecode is not obfuscation

Bytecode **does not obscure your source code**. It’s an optimization, not a security measure.

## [​](https://bun.com/docs/bundler/bytecode#production-deployment) Production deployment

### [​](https://bun.com/docs/bundler/bytecode#docker) Docker
...
### [​](https://bun.com/docs/bundler/bytecode#ci/cd) CI/CD
...
## [​](https://bun.com/docs/bundler/bytecode#debugging) Debugging

### [​](https://bun.com/docs/bundler/bytecode#verify-bytecode-is-being-used) Verify bytecode is being used
...
### [​](https://bun.com/docs/bundler/bytecode#common-issues) Common issues
...
## [​](https://bun.com/docs/bundler/bytecode#what-is-bytecode) What is bytecode?
...
### [​](https://bun.com/docs/bundler/bytecode#why-lazy-parsing-makes-this-even-better) Why lazy parsing makes this even better
...
## [​](https://bun.com/docs/bundler/bytecode#the-bytecode-format) The bytecode format

### [​](https://bun.com/docs/bundler/bytecode#inside-a-jsc-file) Inside a .jsc file
...
### [​](https://bun.com/docs/bundler/bytecode#what-bytecode-does-not-contain) What bytecode does NOT contain
...
## [​](https://bun.com/docs/bundler/bytecode#the-tradeoff:-file-size) The tradeoff: file size

Bytecode files are significantly larger than source code - typically 2-8x larger.

### [​](https://bun.com/docs/bundler/bytecode#why-is-bytecode-so-much-larger) Why is bytecode so much larger?
...
### [​](https://bun.com/docs/bundler/bytecode#mitigation-strategies) Mitigation strategies
...
## [​](https://bun.com/docs/bundler/bytecode#versioning-and-portability) Versioning and portability

### [​](https://bun.com/docs/bundler/bytecode#cross-architecture-portability:-✅) Cross-architecture portability: ✅
...
### [​](https://bun.com/docs/bundler/bytecode#cross-version-portability:-❌) Cross-version portability: ❌
...
## [​](https://bun.com/docs/bundler/bytecode#unlinked-vs-linked-bytecode) Unlinked vs. linked bytecode
...
### [​](https://bun.com/docs/bundler/bytecode#unlinked-bytecode-what’s-cached) Unlinked bytecode (what’s cached)
...
### [​](https://bun.com/docs/bundler/bytecode#linked-bytecode-runtime-execution) Linked bytecode (runtime execution)
...
[Suggest edits](https://github.com/oven-sh/bun/edit/main/docs/bundler/bytecode.mdx)[Raise issue](https://github.com/oven-sh/bun/issues/new?title=Issue on docs&body=Path: /bundler/bytecode)
