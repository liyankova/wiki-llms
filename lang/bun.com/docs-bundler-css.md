...
## [​](https://bun.com/docs/bundler/css#transpiling) Transpiling
...
## [​](https://bun.com/docs/bundler/css#browser-compatibility) Browser Compatibility
...
## [​](https://bun.com/docs/bundler/css#syntax-lowering) Syntax Lowering

### [​](https://bun.com/docs/bundler/css#nesting) Nesting
...
### [​](https://bun.com/docs/bundler/css#color-mix) Color mix
...
### [​](https://bun.com/docs/bundler/css#relative-colors) Relative colors
...
### [​](https://bun.com/docs/bundler/css#lab-colors) LAB colors
...
### [​](https://bun.com/docs/bundler/css#color-function) Color function
...
### [​](https://bun.com/docs/bundler/css#hwb-colors) HWB colors
...
### [​](https://bun.com/docs/bundler/css#color-notation) Color notation
...
### [​](https://bun.com/docs/bundler/css#light-dark-color-function) light-dark() color function
...
### [​](https://bun.com/docs/bundler/css#logical-properties) Logical properties
...
### [​](https://bun.com/docs/bundler/css#:dir-selector) :dir() selector
...
### [​](https://bun.com/docs/bundler/css#:lang-selector) :lang() selector
...
### [​](https://bun.com/docs/bundler/css#:is-selector) :is() selector
...
### [​](https://bun.com/docs/bundler/css#:not-selector) :not() selector
...
### [​](https://bun.com/docs/bundler/css#math-functions) Math functions
...
### [​](https://bun.com/docs/bundler/css#media-query-ranges) Media query ranges
...
### [​](https://bun.com/docs/bundler/css#shorthands) Shorthands
...
### [​](https://bun.com/docs/bundler/css#double-position-gradients) Double position gradients
...
### [​](https://bun.com/docs/bundler/css#system-ui-font) system-ui font
...
## [​](https://bun.com/docs/bundler/css#css-modules) CSS Modules
...
### [​](https://bun.com/docs/bundler/css#getting-started) Getting started
...
### [​](https://bun.com/docs/bundler/css#composition) Composition
...
### [​](https://bun.com/docs/bundler/css#composing-from-a-separate-css-module-file) Composing from a separate CSS module file
...
When composing classes from separate files, be sure that they do not contain the same properties.The CSS module spec says that composing classes from separate files with conflicting properties is undefined behavior, meaning that the output may differ and be unreliable.

Was this page helpful?

[Suggest edits](https://github.com/oven-sh/bun/edit/main/docs/bundler/css.mdx)[Raise issue](https://github.com/oven-sh/bun/issues/new?title=Issue on docs&body=Path: /bundler/css)
