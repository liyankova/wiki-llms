...
Bun is a fast, all-in-one toolkit for running, building, testing, and debugging JavaScript and TypeScript, from a single script to a full-stack application. If you're new to Bun, you can learn more in the [Bun 1.0](https://bun.com/blog/bun-v1.0#bun-is-an-all-in-one-toolkit) blog post.
...
## [Windows Support](https://bun.com/blog/bun-v1.1#windows-support)
...
### [`bun install` on Windows](https://bun.com/blog/bun-v1.1#bun-install-on-windows)
...
[![](https://bun.com/images/bun-install-on-windows.png)](https://bun.com/images/bun-install-on-windows.png)

Time spent installing dependencies in a vite react app using `--ignore-scripts` on Windows.

### [`bun run` on Windows](https://bun.com/blog/bun-v1.1#bun-run-on-windows)
...
[![](https://bun.com/images/bun-run-on-windows.png)](https://bun.com/images/bun-run-on-windows.png)
...
[![](https://bun.com/images/terminate-batch-job-bun.gif)](https://bun.com/images/terminate-batch-job-bun.gif)[![](https://bun.com/images/terminate-batch-job-npm.gif)](https://bun.com/images/terminate-batch-job-npm.gif)

### [`bun --watch` on Windows](https://bun.com/blog/bun-v1.1#bun-watch-on-windows)
...
[![](https://bun.com/images/bun-test-watch-windows.gif)](https://bun.com/images/bun-test-watch-windows.gif)

On the left, making changes to a test file. On the right, `bun test --watch` on Windows.

### [Node.js APIs on Windows](https://bun.com/blog/bun-v1.1#node-js-apis-on-windows)
...
[![](https://bun.com/images/fs-readdir-windows.png)](https://bun.com/images/fs-readdir-windows.png)

Time spent listing files in a directory, 1000 times on Windows.

While we haven't optimized *every* API, if you notice something on Windows that is slow or slower than Node.js, [file an issue](https://bun.com/issues) and we will figure out how to make it faster.

## [Bun is a JavaScript runtime](https://bun.com/blog/bun-v1.1#bun-is-a-javascript-runtime)
...
### [Large projects start 2x faster](https://bun.com/blog/bun-v1.1#large-projects-start-2x-faster)
...
This makes command-line tools, like `tsc`, run up to [2x faster](https://bun.com/blog/bun-v1.0.15#transpiler-cache-makes-clis-like-tsc-up-to-2x-faster) than in Bun 1.0.

[![](https://bun.com/images/tsc-2x-faster.png)](https://bun.com/images/tsc-2x-faster.png)

Time spent running `tsc --help` in Bun and Node.js.

### [The Bun Shell](https://bun.com/blog/bun-v1.1#the-bun-shell)
...
The [Bun Shell](https://bun.com/docs/runtime/shell) is a lexer, parser, and interpreter that implements a bash-like programming language, along with a selection of core utilities like `ls`, `rm`, and `cat`.
...
The Bun Shell is enabled by default on Windows when running `package.json` scripts with `bun run`. To learn more, check out the [documentation](https://bun.com/docs/runtime/shell) or the announcement [blog post](https://bun.com/blog/the-bun-shell).

### [`Bun.Glob`](https://bun.com/blog/bun-v1.1#bun-glob)

Bun now has a built-in [Glob API](https://bun.com/docs/api/glob) for matching files and strings using glob patterns. It's similar to popular Node.js libraries like `fast-glob` and `micromatch`, except it matches strings [3x faster](https://bun.com/blog/bun-v1.0.14#bun-glob).
...
### [`Bun.Semver`](https://bun.com/blog/bun-v1.1#bun-semver)

Bun has a new [Semver API](https://bun.com/docs/api/semver) for parsing and sorting semver strings. It's similar to the popular `node-semver` package, except it's [20x faster](https://twitter.com/jarredsumner/status/1722225679570473173).
...
### [`Bun.stringWidth()`](https://bun.com/blog/bun-v1.1#bun-stringwidth)
...
It's similar to the popular `string-width` package, except it's [6000x faster](https://bun.com/blog/bun-v1.0.29#bun-stringwidth-6-756x-faster-string-width-replacement).
...
### [`server.url`](https://bun.com/blog/bun-v1.1#server-url)
...
### [`server.requestIP()`](https://bun.com/blog/bun-v1.1#server-requestip)
...
### [`subprocess.resourceUsage()`](https://bun.com/blog/bun-v1.1#subprocess-resourceusage)
...
### [`import.meta.env`](https://bun.com/blog/bun-v1.1#import-meta-env)
...
## [Node.js compatibility](https://bun.com/blog/bun-v1.1#node-js-compatibility)
...
### [HTTP/2 client](https://bun.com/blog/bun-v1.1#http-2-client)
...
### [`Date.parse()` compatible with Node.js](https://bun.com/blog/bun-v1.1#date-parse-compatible-with-node-js)
...
### [Recursive `fs.readdir()`](https://bun.com/blog/bun-v1.1#recursive-fs-readdir)
...
[![](https://bun.com/images/fs-readdir-recursive.png)](https://bun.com/images/fs-readdir-recursive.png)

Time spent listing files using recursive `fs.readdir()` in a large directory.

### [IPC support between Bun and Node.js](https://bun.com/blog/bun-v1.1#ipc-support-between-bun-and-node-js)
...
### [Undocumented Node.js APIs](https://bun.com/blog/bun-v1.1#undocumented-node-js-apis)
...
### [So much more](https://bun.com/blog/bun-v1.1#so-much-more)
...
## [Web APIs](https://bun.com/blog/bun-v1.1#web-apis)
...
### [`WebSocket` is stable](https://bun.com/blog/bun-v1.1#websocket-is-stable)
...
### [`performance.mark()`](https://bun.com/blog/bun-v1.1#performance-mark)
...
### [`fetch()` using Brotli compression](https://bun.com/blog/bun-v1.1#fetch-using-brotli-compression)
...
### [`URL.canParse()`](https://bun.com/blog/bun-v1.1#url-canparse)
...
### [`fetch()` over Unix sockets](https://bun.com/blog/bun-v1.1#fetch-over-unix-sockets)
...
### [`Response` body as an `AsyncIterator`](https://bun.com/blog/bun-v1.1#response-body-as-an-asynciterator)
...
### [Other changes](https://bun.com/blog/bun-v1.1#other-changes)
...
## [Bun is an npm-compatible package manager](https://bun.com/blog/bun-v1.1#bun-is-an-npm-compatible-package-manager)
...
### [Lifecycle scripts](https://bun.com/blog/bun-v1.1#lifecycle-scripts)
...
### [`trustedDependencies`](https://bun.com/blog/bun-v1.1#trusteddependencies)
...
### [`bun pm untrusted`](https://bun.com/blog/bun-v1.1#bun-pm-untrusted)
...
### [`bun pm trust`](https://bun.com/blog/bun-v1.1#bun-pm-trust)
...
### [`bun add --trust`](https://bun.com/blog/bun-v1.1#bun-add-trust)
...
### [`bun pm migrate`](https://bun.com/blog/bun-v1.1#bun-pm-migrate)
...
## [Bun is a JavaScript bundler](https://bun.com/blog/bun-v1.1#bun-is-a-javascript-bundler)
...
### [`bun build --target=node`](https://bun.com/blog/bun-v1.1#bun-build-target-node)
...
### [`bun build --compile`](https://bun.com/blog/bun-v1.1#bun-build-compile)
...
### [Macros](https://bun.com/blog/bun-v1.1#macros)
...
## [Bun is a test runner](https://bun.com/blog/bun-v1.1#bun-is-a-test-runner)
...
### [Matchers](https://bun.com/blog/bun-v1.1#matchers)
...
### [Custom matchers with `expect.extend()`](https://bun.com/blog/bun-v1.1#custom-matchers-with-expect-extend)
...
### [Module mocking](https://bun.com/blog/bun-v1.1#module-mocking)
...
## [Bun has built-in support for SQLite](https://bun.com/blog/bun-v1.1#bun-has-built-in-support-for-sqlite)
...
### [Multi-statement queries](https://bun.com/blog/bun-v1.1#multi-statement-queries)
...
### [Detailed errors](https://bun.com/blog/bun-v1.1#detailed-errors)
...
### [Import databases](https://bun.com/blog/bun-v1.1#import-databases)
...
### [Embed databases](https://bun.com/blog/bun-v1.1#embed-databases)

You can also compile your application and SQLite database into a [single-file executable](https://bun.com/docs/bundler/executables#sqlite). To enable this, specify the `embed` property on the import, then use `bun build --compile` to build your app.
...
## [Bun makes JavaScript simpler](https://bun.com/blog/bun-v1.1#bun-makes-javascript-simpler)
...
### [Syntax-highlighted errors](https://bun.com/blog/bun-v1.1#syntax-highlighted-errors)
...
### [Simplified stack traces](https://bun.com/blog/bun-v1.1#simplified-stack-traces)
...
### [`bun --eval`](https://bun.com/blog/bun-v1.1#bun-eval)
...
### [`bun --print`](https://bun.com/blog/bun-v1.1#bun-print)
...
### [`bun --env-file`](https://bun.com/blog/bun-v1.1#bun-env-file)
...
## [Behaviour changes](https://bun.com/blog/bun-v1.1#behaviour-changes)
...
### [Longer network timeouts](https://bun.com/blog/bun-v1.1#longer-network-timeouts)
...
### [`Bun.write()` creates the parent directory](https://bun.com/blog/bun-v1.1#bun-write-creates-the-parent-directory)
...
### [Conditional exports does not include `worker`](https://bun.com/blog/bun-v1.1#conditional-exports-does-not-include-worker)
...
### [`NODE_ENV` is `undefined` by default](https://bun.com/blog/bun-v1.1#node-env-is-undefined-by-default)
...
### [`bun install [package]@latest`](https://bun.com/blog/bun-v1.1#bun-install-package-latest)
...
### [`Bun.$` rejects with non-zero exit code](https://bun.com/blog/bun-v1.1#bun-rejects-with-non-zero-exit-code)
...
### [`import.meta.resolve()`](https://bun.com/blog/bun-v1.1#import-meta-resolve)
...
## [A thousand bug fixes](https://bun.com/blog/bun-v1.1#a-thousand-bug-fixes)

Since Bun 1.0, we've fixed over a thousand bugs.

If you ran into an error using Bun 1.0, we'd encourage you to try again with Bun 1.1. And if there's still something we haven't fixed, please feel free to create a [new issue](https://bun.com/issues) or bump an existing one.
...
### [Notable fixes](https://bun.com/blog/bun-v1.1#notable-fixes)
...
## [Performance improvements](https://bun.com/blog/bun-v1.1#performance-improvements)
...
* `Bun.write()` and `Bun.file().text()` are [3x faster](https://bun.com/blog/bun-v1.0.16#bun-write-and-bun-file-text-gets-3x-faster-under-concurrent-load) under concurrent load.
* `bunx esbuild` is [50x faster](https://bun.com/blog/bun-v1.0.17#bunx-esbuild-starts-50x-faster-than-npx-esbuild) than `npx esbuild`.
* `fs.cp()` and `fs.copyFile()` are [50% faster](https://bun.com/blog/bun-v1.0.34#50-faster-cross-mount-fs-cp-fs-copyfile-on-linux) on Linux across filesystems.
* `Bun.peek()` is [90x faster](https://bun.com/blog/bun-v1.0.19#bun-peek-gets-90x-faster) with a new implementation.
* `expect().toEqual()` is [100x faster](https://bun.com/blog/bun-v1.0.19#expect-map1-toequal-map2-gets-100x-faster) using `Map` and `Set` objects.
* `setTimeout()` and `setInterval()` are [4x faster](https://bun.com/blog/bun-v1.0.19#settimeout-setinterval-get-4x-higher-throughput) on Linux.
* `Bun.spawnSync()` is [50% faster](https://bun.com/blog/bun-v1.0.19#optimized-bun-spawnsync-for-large-input-on-linux) at buffering stdout on Linux.
* `node:http` is [14% faster](https://bun.com/blog/bun-v1.0.10#node-http-gets-14-faster) using a hello world benchmark.
* `fs.readdir()` is [40x faster](https://bun.com/blog/bun-v1.0.15#recursive-in-fs-readdir-is-40x-faster-than-node-js) than Node.js using the `recursive` option.
* `bun:sqlite` uses [4x less](https://bun.com/blog/bun-v1.0.21#bun-sqlite-uses-less-memory) memory.
* `fs.readlink()` uses [2x less](https://bun.com/blog/bun-v1.0.20#fs-readlink-uses-up-to-2x-less-memory) memory.
* `fs.stat()` uses [2x less](https://bun.com/blog/bun-v1.0.20#fs-stat-uses-up-to-2x-less-memory) memory.
* `FormData` uses [less memory](https://bun.com/blog/bun-v1.0.21#copy-on-write-file-uploads-on-linux) with copy-on-write file upload on Linux

## [Getting started](https://bun.com/blog/bun-v1.1#getting-started)
...
### [Install Bun](https://bun.com/blog/bun-v1.1#install-bun)
...
### [Upgrade Bun](https://bun.com/blog/bun-v1.1#upgrade-bun)

```
bun upgrade
```

## [We're hiring](https://bun.com/blog/bun-v1.1#we-re-hiring)
...
## [Thank you to 364 contributors!](https://bun.com/blog/bun-v1.1#thank-you-to-364-contributors)
...
[#### Bun v1.1.1](https://bun.com/blog/bun-v1.1.1)