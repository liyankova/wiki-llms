...
## [​](https://bun.com/docs/cli/test#run-tests) Run tests
...
## [​](https://bun.com/docs/cli/test#ci/cd-integration) CI/CD integration

`bun test` supports a variety of CI/CD integrations.

### [​](https://bun.com/docs/cli/test#github-actions) GitHub Actions
...
#### [​](https://bun.com/docs/cli/test#how-to-install-bun-in-a-github-actions-workflow) How to install `bun` in a GitHub Actions workflow
...
### [​](https://bun.com/docs/cli/test#junit-xml-reports-gitlab,-etc) JUnit XML reports (GitLab, etc.)
...
## [​](https://bun.com/docs/cli/test#timeouts) Timeouts
...
## [​](https://bun.com/docs/cli/test#concurrent-test-execution) Concurrent test execution
...
### [​](https://bun.com/docs/cli/test#concurrent-flag) `--concurrent` flag
...
### [​](https://bun.com/docs/cli/test#max-concurrency-flag) `--max-concurrency` flag
...
### [​](https://bun.com/docs/cli/test#test-concurrent) `test.concurrent`
...
### [​](https://bun.com/docs/cli/test#test-serial) `test.serial`
...
## [​](https://bun.com/docs/cli/test#rerun-tests) Rerun tests
...
## [​](https://bun.com/docs/cli/test#randomize-test-execution-order) Randomize test execution order
...
### [​](https://bun.com/docs/cli/test#reproducible-random-order-with-seed) Reproducible random order with `--seed`
...
## [​](https://bun.com/docs/cli/test#bail-out-with-bail) Bail out with `--bail`
...
## [​](https://bun.com/docs/cli/test#watch-mode) Watch mode
...
## [​](https://bun.com/docs/cli/test#lifecycle-hooks) Lifecycle hooks
...
## [​](https://bun.com/docs/cli/test#mocks) Mocks
...
## [​](https://bun.com/docs/cli/test#snapshot-testing) Snapshot testing
...
## [​](https://bun.com/docs/cli/test#ui-&-dom-testing) UI & DOM testing
...
## [​](https://bun.com/docs/cli/test#performance) Performance
...
## [​](https://bun.com/docs/cli/test#ai-agent-integration) AI Agent Integration
...
### [​](https://bun.com/docs/cli/test#environment-variables) Environment Variables
...
### [​](https://bun.com/docs/cli/test#behavior) Behavior
...
# [​](https://bun.com/docs/cli/test#cli-usage) CLI Usage
...
### [​](https://bun.com/docs/cli/test#execution-control) Execution Control

[​](https://bun.com/docs/cli/test#param-timeout)
...
[​](https://bun.com/docs/cli/test#param-rerun-each)
...
[​](https://bun.com/docs/cli/test#param-concurrent)
...
[​](https://bun.com/docs/cli/test#param-randomize)
...
[​](https://bun.com/docs/cli/test#param-seed)
...
[​](https://bun.com/docs/cli/test#param-bail)
...
[​](https://bun.com/docs/cli/test#param-max-concurrency)
...
### [​](https://bun.com/docs/cli/test#test-filtering) Test Filtering

[​](https://bun.com/docs/cli/test#param-todo)
...
[​](https://bun.com/docs/cli/test#param-test-name-pattern)
...
### [​](https://bun.com/docs/cli/test#reporting) Reporting

[​](https://bun.com/docs/cli/test#param-reporter)
...
[​](https://bun.com/docs/cli/test#param-reporter-outfile)
...
[​](https://bun.com/docs/cli/test#param-dots)
...
### [​](https://bun.com/docs/cli/test#coverage) Coverage

[​](https://bun.com/docs/cli/test#param-coverage)
...
[​](https://bun.com/docs/cli/test#param-coverage-reporter)
...
[​](https://bun.com/docs/cli/test#param-coverage-dir)
...
### [​](https://bun.com/docs/cli/test#snapshots) Snapshots

[​](https://bun.com/docs/cli/test#param-update-snapshots)
...
## [​](https://bun.com/docs/cli/test#examples) Examples
