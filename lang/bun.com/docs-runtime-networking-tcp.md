---
url: https://bun.com/docs/runtime/networking/tcp
title: TCP - Bun
...
## [​](https://bun.com/docs/runtime/networking/tcp#start-a-server-bun-listen) Start a server (`Bun.listen()`)
...
## [​](https://bun.com/docs/runtime/networking/tcp#create-a-connection-bun-connect) Create a connection (`Bun.connect()`)
...
## [​](https://bun.com/docs/runtime/networking/tcp#hot-reloading) Hot reloading
...
## [​](https://bun.com/docs/runtime/networking/tcp#buffering) Buffering
...
[Suggest edits](https://github.com/oven-sh/bun/edit/main/docs/runtime/networking/tcp.mdx)[Raise issue](https://github.com/oven-sh/bun/issues/new?title=Issue on docs&body=Path: /runtime/networking/tcp)
