---
url: https://bun.com/docs/guides/util/hash-a-password
title: Hash a password - Bun
...
See [Docs > API > Hashing](https://bun.com/docs/runtime/hashing#bun-password) for complete documentation.
