---
url: https://bun.com/docs/guides/test/run-tests
title: Run your tests with the Bun test runner - Bun
source_domain: bun.com
---

# Run your tests with the Bun test runner - Bun
...
[Suggest edits](https://github.com/oven-sh/bun/edit/main/docs/guides/test/run-tests.mdx)[Raise issue](https://github.com/oven-sh/bun/issues/new?title=Issue on docs&body=Path: /guides/test/run-tests)
