---
url: https://bun.com/docs/runtime/streams
title: Streams - Bun
...
## [​](https://bun.com/docs/runtime/streams#direct-readablestream) Direct `ReadableStream`
...
## [​](https://bun.com/docs/runtime/streams#async-generator-streams) Async generator streams
...
## [​](https://bun.com/docs/runtime/streams#bun-arraybuffersink) `Bun.ArrayBufferSink`
...
## [​](https://bun.com/docs/runtime/streams#reference) Reference
...
[Suggest edits](https://github.com/oven-sh/bun/edit/main/docs/runtime/streams.mdx)[Raise issue](https://github.com/oven-sh/bun/issues/new?title=Issue on docs&body=Path: /runtime/streams)
