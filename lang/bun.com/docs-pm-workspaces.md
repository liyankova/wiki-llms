...
`!**/excluded/**`). See [here](https://bun.com/docs/runtime/glob#supported-glob-patterns) for a comprehensive list of supported syntax.
...
* **Run scripts in multiple packages.** You can use the [`--filter` flag](https://bun.com/docs/pm/filter) to easily run `package.json` scripts in multiple packages in your workspace, , or `--workspaces` to run scripts across all workspaces.

## [​](https://bun.com/docs/pm/workspaces#share-versions-with-catalogs) Share versions with Catalogs
...
[Catalogs](https://bun.com/docs/pm/catalogs) for details.
...
[Suggest edits](https://github.com/oven-sh/bun/edit/main/docs/pm/workspaces.mdx)[Raise issue](https://github.com/oven-sh/bun/issues/new?title=Issue on docs&body=Path: /pm/workspaces)
