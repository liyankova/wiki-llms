---
url: https://bun.com/docs/runtime/semver
title: Semver - Bun
...
## [​](https://bun.com/docs/runtime/semver#bun-semver-satisfies-version:-string,-range:-string-:-boolean) `Bun.semver.satisfies(version: string, range: string): boolean`
...
## [​](https://bun.com/docs/runtime/semver#bun-semver-order-versiona:-string,-versionb:-string-:-0-|-1-|-1) `Bun.semver.order(versionA: string, versionB: string): 0 | 1 | -1`
...
[Suggest edits](https://github.com/oven-sh/bun/edit/main/docs/runtime/semver.mdx)[Raise issue](https://github.com/oven-sh/bun/issues/new?title=Issue on docs&body=Path: /runtime/semver)
