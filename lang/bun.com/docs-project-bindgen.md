---
url: https://bun.com/docs/project/bindgen
title: Bindgen - Bun
...
## [​](https://bun.com/docs/project/bindgen#creating-js-functions-in-zig) Creating JS Functions in Zig
...
![https://mintcdn.com/bun-1dd33a4e/Hq64iapoQXHbYMEN/icons/typescript.svg?fit=max&auto=format&n=Hq64iapoQXHbYMEN&q=85&s=c6cceedec8f82d2cc803d7c6ec82b240](https://mintcdn.com/bun-1dd33a4e/Hq64iapoQXHbYMEN/icons/typescript.svg?fit=max&auto=format&n=Hq64iapoQXHbYMEN&q=85&s=c6cceedec8f82d2cc803d7c6ec82b240)src/bun.js/math.bind.ts
...
## [​](https://bun.com/docs/project/bindgen#strings) Strings
...
## [​](https://bun.com/docs/project/bindgen#function-variants) Function Variants
...
## [​](https://bun.com/docs/project/bindgen#t-dictionary) `t.dictionary`
...
## [​](https://bun.com/docs/project/bindgen#enumerations) Enumerations
...
### [​](https://bun.com/docs/project/bindgen#deriving-enums-from-zig-code) Deriving enums from Zig code

TODO: zigEnum

## [​](https://bun.com/docs/project/bindgen#t-oneof) `t.oneOf`

A `oneOf` is a union between two or more types. It is represented by `union(enum)` in Zig.
TODO:

## [​](https://bun.com/docs/project/bindgen#attributes) Attributes
...
### [​](https://bun.com/docs/project/bindgen#integer-attributes) Integer Attributes
...
## [​](https://bun.com/docs/project/bindgen#callbacks) Callbacks

TODO

## [​](https://bun.com/docs/project/bindgen#classes) Classes

TODO

Was this page helpful?

[Suggest edits](https://github.com/oven-sh/bun/edit/main/docs/project/bindgen.mdx)[Raise issue](https://github.com/oven-sh/bun/issues/new?title=Issue on docs&body=Path: /project/bindgen)
