---
url: https://bun.com/docs/runtime/transpiler
...
## [​](https://bun.com/docs/runtime/transpiler#transformsync) `.transformSync()`
...
## [​](https://bun.com/docs/runtime/transpiler#transform) `.transform()`
...
## [​](https://bun.com/docs/runtime/transpiler#scan) `.scan()`
...
## [​](https://bun.com/docs/runtime/transpiler#scanimports) `.scanImports()`
...
## [​](https://bun.com/docs/runtime/transpiler#reference) Reference
...
[Suggest edits](https://github.com/oven-sh/bun/edit/main/docs/runtime/transpiler.mdx)[Raise issue](https://github.com/oven-sh/bun/issues/new?title=Issue on docs&body=Path: /runtime/transpiler)
