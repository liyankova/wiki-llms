...
## [​](https://bun.com/docs/bundler/loaders#built-in-loaders) Built-in loaders

### [​](https://bun.com/docs/bundler/loaders#js) `js`
...
### [​](https://bun.com/docs/bundler/loaders#jsx) `jsx`
...
### [​](https://bun.com/docs/bundler/loaders#ts) `ts`
...
### [​](https://bun.com/docs/bundler/loaders#tsx) `tsx`
...
### [​](https://bun.com/docs/bundler/loaders#json) `json`
...
### [​](https://bun.com/docs/bundler/loaders#jsonc) `jsonc`
...
### [​](https://bun.com/docs/bundler/loaders#toml) `toml`
...
### [​](https://bun.com/docs/bundler/loaders#yaml) `yaml`
...
### [​](https://bun.com/docs/bundler/loaders#text) `text`
...
### [​](https://bun.com/docs/bundler/loaders#napi) `napi`
...
### [​](https://bun.com/docs/bundler/loaders#sqlite) `sqlite`
...
### [​](https://bun.com/docs/bundler/loaders#html) `html`
...
### [​](https://bun.com/docs/bundler/loaders#css) `css`
...
### [​](https://bun.com/docs/bundler/loaders#sh) `sh`
...
### [​](https://bun.com/docs/bundler/loaders#file) `file`
...
The location and file name of the copied file is determined by the value of `naming.asset`.This loader is copied into the `outdir` as-is. The name of the copied file is determined using the value of `naming.asset`.

Was this page helpful?

[Suggest edits](https://github.com/oven-sh/bun/edit/main/docs/bundler/loaders.mdx)[Raise issue](https://github.com/oven-sh/bun/issues/new?title=Issue on docs&body=Path: /bundler/loaders)
