---
url: https://bun.com/docs/bundler/fullstack
title: Fullstack dev server - Bun
...
## [​](https://bun.com/docs/bundler/fullstack#html-routes) HTML Routes

### [​](https://bun.com/docs/bundler/fullstack#html-imports-as-routes) HTML Imports as Routes
...
### [​](https://bun.com/docs/bundler/fullstack#html-processing-example) HTML Processing Example
...
## [​](https://bun.com/docs/bundler/fullstack#react-integration) React Integration
...
## [​](https://bun.com/docs/bundler/fullstack#development-mode) Development Mode

When building locally, enable development mode by setting `development: true` in `Bun.serve()`.

![https://mintcdn.com/bun-1dd33a4e/Hq64iapoQXHbYMEN/icons/typescript.svg?fit=max&auto=format&n=Hq64iapoQXHbYMEN&q=85&s=c6cceedec8f82d2cc803d7c6ec82b240](https://mintcdn.com/bun-1dd33a4e/Hq64iapoQXHbYMEN/icons/typescript.svg?fit=max&auto=format&n=Hq64iapoQXHbYMEN&q=85&s=c6cceedec8f82d2cc803d7c6ec82b240)src/backend.ts
...
### [​](https://bun.com/docs/bundler/fullstack#development-mode-features) Development Mode Features
...
### [​](https://bun.com/docs/bundler/fullstack#advanced-development-configuration) Advanced Development Configuration
...
### [​](https://bun.com/docs/bundler/fullstack#development-vs-production) Development vs Production
...
## [​](https://bun.com/docs/bundler/fullstack#production-mode) Production Mode
...
### [​](https://bun.com/docs/bundler/fullstack#ahead-of-time-bundling-recommended) Ahead of Time Bundling (Recommended)
...
### [​](https://bun.com/docs/bundler/fullstack#runtime-bundling) Runtime Bundling
...
## [​](https://bun.com/docs/bundler/fullstack#api-routes) API Routes

### [​](https://bun.com/docs/bundler/fullstack#http-method-handlers) HTTP Method Handlers
...
### [​](https://bun.com/docs/bundler/fullstack#dynamic-routes) Dynamic Routes
...
### [​](https://bun.com/docs/bundler/fullstack#request-handling) Request Handling
...
## [​](https://bun.com/docs/bundler/fullstack#plugins) Plugins
...
### [​](https://bun.com/docs/bundler/fullstack#tailwindcss-plugin) TailwindCSS Plugin
...
### [​](https://bun.com/docs/bundler/fullstack#custom-plugins) Custom Plugins
...
![https://mintcdn.com/bun-1dd33a4e/Hq64iapoQXHbYMEN/icons/typescript.svg?fit=max&auto=format&n=Hq64iapoQXHbYMEN&q=85&s=c6cceedec8f82d2cc803d7c6ec82b240](https://mintcdn.com/bun-1dd33a4e/Hq64iapoQXHbYMEN/icons/typescript.svg?fit=max&auto=format&n=Hq64iapoQXHbYMEN&q=85&s=c6cceedec8f82d2cc803d7c6ec82b240)my-plugin-implementation.ts
...
## [​](https://bun.com/docs/bundler/fullstack#inline-environment-variables) Inline Environment Variables
...
## [​](https://bun.com/docs/bundler/fullstack#how-it-works) How It Works
...
### [​](https://bun.com/docs/bundler/fullstack#processing-pipeline) Processing Pipeline
...
## [​](https://bun.com/docs/bundler/fullstack#complete-example) Complete Example
...
## [​](https://bun.com/docs/bundler/fullstack#best-practices) Best Practices

### [​](https://bun.com/docs/bundler/fullstack#project-structure) Project Structure
...
### [​](https://bun.com/docs/bundler/fullstack#environment-based-configuration) Environment-Based Configuration

![https://mintcdn.com/bun-1dd33a4e/Hq64iapoQXHbYMEN/icons/typescript.svg?fit=max&auto=format&n=Hq64iapoQXHbYMEN&q=85&s=c6cceedec8f82d2cc803d7c6ec82b240](https://mintcdn.com/bun-1dd33a4e/Hq64iapoQXHbYMEN/icons/typescript.svg?fit=max&auto=format&n=Hq64iapoQXHbYMEN&q=85&s=c6cceedec8f82d2cc803d7c6ec82b240)server/config.ts
...
### [​](https://bun.com/docs/bundler/fullstack#error-handling) Error Handling

![https://mintcdn.com/bun-1dd33a4e/Hq64iapoQXHbYMEN/icons/typescript.svg?fit=max&auto=format&n=Hq64iapoQXHbYMEN&q=85&s=c6cceedec8f82d2cc803d7c6ec82b240](https://mintcdn.com/bun-1dd33a4e/Hq64iapoQXHbYMEN/icons/typescript.svg?fit=max&auto=format&n=Hq64iapoQXHbYMEN&q=85&s=c6cceedec8f82d2cc803d7c6ec82b240)server/middleware.ts
...
### [​](https://bun.com/docs/bundler/fullstack#api-response-helpers) API Response Helpers

![https://mintcdn.com/bun-1dd33a4e/Hq64iapoQXHbYMEN/icons/typescript.svg?fit=max&auto=format&n=Hq64iapoQXHbYMEN&q=85&s=c6cceedec8f82d2cc803d7c6ec82b240](https://mintcdn.com/bun-1dd33a4e/Hq64iapoQXHbYMEN/icons/typescript.svg?fit=max&auto=format&n=Hq64iapoQXHbYMEN&q=85&s=c6cceedec8f82d2cc803d7c6ec82b240)server/utils.ts
...
### [​](https://bun.com/docs/bundler/fullstack#type-safety) Type Safety

![https://mintcdn.com/bun-1dd33a4e/Hq64iapoQXHbYMEN/icons/typescript.svg?fit=max&auto=format&n=Hq64iapoQXHbYMEN&q=85&s=c6cceedec8f82d2cc803d7c6ec82b240](https://mintcdn.com/bun-1dd33a4e/Hq64iapoQXHbYMEN/icons/typescript.svg?fit=max&auto=format&n=Hq64iapoQXHbYMEN&q=85&s=c6cceedec8f82d2cc803d7c6ec82b240)types/api.ts
...
## [​](https://bun.com/docs/bundler/fullstack#deployment) Deployment

### [​](https://bun.com/docs/bundler/fullstack#production-build) Production Build
...
### [​](https://bun.com/docs/bundler/fullstack#docker-deployment) Docker Deployment
...
### [​](https://bun.com/docs/bundler/fullstack#environment-variables) Environment Variables
...
## [​](https://bun.com/docs/bundler/fullstack#migration-from-other-frameworks) Migration from Other Frameworks

### [​](https://bun.com/docs/bundler/fullstack#from-express-+-webpack) From Express + Webpack
...
### [​](https://bun.com/docs/bundler/fullstack#from-next-js-api-routes) From Next.js API Routes
...
## [​](https://bun.com/docs/bundler/fullstack#limitations-and-future-plans) Limitations and Future Plans

### [​](https://bun.com/docs/bundler/fullstack#current-limitations) Current Limitations
...
### [​](https://bun.com/docs/bundler/fullstack#planned-features) Planned Features
...
[Suggest edits](https://github.com/oven-sh/bun/edit/main/docs/bundler/fullstack.mdx)[Raise issue](https://github.com/oven-sh/bun/issues/new?title=Issue on docs&body=Path: /bundler/fullstack)
