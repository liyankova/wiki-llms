...
## [​](https://bun.com/docs/runtime/workers#creating-a-worker) Creating a `Worker`
...
### [​](https://bun.com/docs/runtime/workers#from-the-main-thread) From the main thread
...
### [​](https://bun.com/docs/runtime/workers#worker-thread) Worker thread
...
### [​](https://bun.com/docs/runtime/workers#preload-load-modules-before-the-worker-starts) `preload` - load modules before the worker starts
...
### [​](https://bun.com/docs/runtime/workers#blob:-urls) `blob:` URLs
...
### [​](https://bun.com/docs/runtime/workers#"open") `"open"`
...
## [​](https://bun.com/docs/runtime/workers#messages-with-postmessage) Messages with `postMessage`
...
### [​](https://bun.com/docs/runtime/workers#performance-optimizations) Performance optimizations
...
## [​](https://bun.com/docs/runtime/workers#terminating-a-worker) Terminating a worker
...
### [​](https://bun.com/docs/runtime/workers#process-exit) `process.exit()`
...
### [​](https://bun.com/docs/runtime/workers#"close") `"close"`
...
## [​](https://bun.com/docs/runtime/workers#managing-lifetime) Managing lifetime
...
### [​](https://bun.com/docs/runtime/workers#worker-unref) `worker.unref()`
...
### [​](https://bun.com/docs/runtime/workers#worker-ref) `worker.ref()`
...
## [​](https://bun.com/docs/runtime/workers#memory-usage-with-smol) Memory usage with `smol`
...
## [​](https://bun.com/docs/runtime/workers#environment-data) Environment Data
...
## [​](https://bun.com/docs/runtime/workers#worker-events) Worker Events
...
## [​](https://bun.com/docs/runtime/workers#bun-ismainthread) `Bun.isMainThread`
...
[Suggest edits](https://github.com/oven-sh/bun/edit/main/docs/runtime/workers.mdx)[Raise issue](https://github.com/oven-sh/bun/issues/new?title=Issue on docs&body=Path: /runtime/workers)
