---
url: https://bun.com/docs/guides/runtime/codesign-macos-executable
title: Codesign a single-file JavaScript executable on macOS - Bun
source_domain: bun.com
---

# Codesign a single-file JavaScript executable on macOS - Bun
...
[Suggest edits](https://github.com/oven-sh/bun/edit/main/docs/guides/runtime/codesign-macos-executable.mdx)[Raise issue](https://github.com/oven-sh/bun/issues/new?title=Issue on docs&body=Path: /guides/runtime/codesign-macos-executable)
