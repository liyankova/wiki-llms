...
## [​](https://bun.com/docs/cli/install#basic-usage) Basic Usage
...
## [​](https://bun.com/docs/cli/install#logging) Logging
...
## [​](https://bun.com/docs/cli/install#lifecycle-scripts) Lifecycle scripts
...
## [​](https://bun.com/docs/cli/install#workspaces) Workspaces
...
## [​](https://bun.com/docs/cli/install#installing-dependencies-for-specific-packages) Installing dependencies for specific packages
...
## [​](https://bun.com/docs/cli/install#overrides-and-resolutions) Overrides and resolutions
...
## [​](https://bun.com/docs/cli/install#global-packages) Global packages
...
## [​](https://bun.com/docs/cli/install#production-mode) Production mode
...
## [​](https://bun.com/docs/cli/install#omitting-dependencies) Omitting dependencies
...
## [​](https://bun.com/docs/cli/install#dry-run) Dry run
...
## [​](https://bun.com/docs/cli/install#non-npm-dependencies) Non-npm dependencies
...
## [​](https://bun.com/docs/cli/install#installation-strategies) Installation strategies

Bun supports two package installation strategies that determine how dependencies are organized in `node_modules`:

### [​](https://bun.com/docs/cli/install#hoisted-installs) Hoisted installs
...
### [​](https://bun.com/docs/cli/install#isolated-installs) Isolated installs
...
### [​](https://bun.com/docs/cli/install#default-strategy) Default strategy
...
## [​](https://bun.com/docs/cli/install#minimum-release-age) Minimum release age
...
## [​](https://bun.com/docs/cli/install#configuration) Configuration

### [​](https://bun.com/docs/cli/install#configuring-bun-install-with-bunfig-toml) Configuring `bun install` with `bunfig.toml`
...
### [​](https://bun.com/docs/cli/install#configuring-with-environment-variables) Configuring with environment variables
...
## [​](https://bun.com/docs/cli/install#ci/cd) CI/CD
...
## [​](https://bun.com/docs/cli/install#platform-specific-dependencies) Platform-specific dependencies?

bun stores normalized `cpu` and `os` values from npm in the lockfile, along with the resolved packages. It skips downloading, extracting, and installing packages disabled for the current target at runtime. This means the lockfile won’t change between platforms/architectures even if the packages ultimately installed do change.

### [​](https://bun.com/docs/cli/install#cpu-and-os-flags) `--cpu` and `--os` flags
...
## [​](https://bun.com/docs/cli/install#peer-dependencies) Peer dependencies?
...
## [​](https://bun.com/docs/cli/install#lockfile) Lockfile
...
## [​](https://bun.com/docs/cli/install#cache) Cache
...
## [​](https://bun.com/docs/cli/install#platform-specific-backends) Platform-specific backends
...
## [​](https://bun.com/docs/cli/install#npm-registry-metadata) npm registry metadata

Bun uses a binary format for caching NPM registry responses. This loads much faster than JSON and tends to be smaller on disk.
You will see these files in `~/.bun/install/cache/*.npm`. The filename pattern is `${hash(packageName)}.npm`. It’s a hash so that extra directories don’t need to be created for scoped packages.
Bun’s usage of `Cache-Control` ignores `Age`. This improves performance, but means bun may be about 5 minutes out of date to receive the latest package version metadata from npm.

## [​](https://bun.com/docs/cli/install#pnpm-migration) pnpm migration
...
### [​](https://bun.com/docs/cli/install#lockfile-migration) Lockfile Migration
...
### [​](https://bun.com/docs/cli/install#workspace-configuration) Workspace Configuration
...
### [​](https://bun.com/docs/cli/install#catalog-dependencies) Catalog Dependencies
...
### [​](https://bun.com/docs/cli/install#configuration-migration) Configuration Migration
...
### [​](https://bun.com/docs/cli/install#requirements) Requirements
...
## [​](https://bun.com/docs/cli/install#cli-usage) CLI Usage
...
### [​](https://bun.com/docs/cli/install#general-configuration) General Configuration

[​](https://bun.com/docs/cli/install#param-config)
...
[​](https://bun.com/docs/cli/install#param-cwd)
...
### [​](https://bun.com/docs/cli/install#dependency-scope-&-management) Dependency Scope & Management

[​](https://bun.com/docs/cli/install#param-production)
...
[​](https://bun.com/docs/cli/install#param-no-save)
...
[​](https://bun.com/docs/cli/install#param-save)
...
[​](https://bun.com/docs/cli/install#param-omit)
...
[​](https://bun.com/docs/cli/install#param-only-missing)
...
### [​](https://bun.com/docs/cli/install#dependency-type-&-versioning) Dependency Type & Versioning

[​](https://bun.com/docs/cli/install#param-dev)
...
[​](https://bun.com/docs/cli/install#param-optional)
...
[​](https://bun.com/docs/cli/install#param-peer)
...
[​](https://bun.com/docs/cli/install#param-exact)
...
### [​](https://bun.com/docs/cli/install#lockfile-control) Lockfile Control

[​](https://bun.com/docs/cli/install#param-yarn)
...
[​](https://bun.com/docs/cli/install#param-frozen-lockfile)
...
[​](https://bun.com/docs/cli/install#param-save-text-lockfile)
...
[​](https://bun.com/docs/cli/install#param-lockfile-only)
...
### [​](https://bun.com/docs/cli/install#network-&-registry-settings) Network & Registry Settings

[​](https://bun.com/docs/cli/install#param-ca)
...
[​](https://bun.com/docs/cli/install#param-cafile)
...
[​](https://bun.com/docs/cli/install#param-registry)
...
### [​](https://bun.com/docs/cli/install#installation-process-control) Installation Process Control

[​](https://bun.com/docs/cli/install#param-dry-run)
...
[​](https://bun.com/docs/cli/install#param-force)
...
[​](https://bun.com/docs/cli/install#param-global)
...
[​](https://bun.com/docs/cli/install#param-backend)
...
[​](https://bun.com/docs/cli/install#param-filter)
...
[​](https://bun.com/docs/cli/install#param-analyze)
...
### [​](https://bun.com/docs/cli/install#caching-options) Caching Options

[​](https://bun.com/docs/cli/install#param-cache-dir)
...
[​](https://bun.com/docs/cli/install#param-no-cache)
...
### [​](https://bun.com/docs/cli/install#output-&-logging) Output & Logging

[​](https://bun.com/docs/cli/install#param-silent)
...
[​](https://bun.com/docs/cli/install#param-verbose)
...
[​](https://bun.com/docs/cli/install#param-no-progress)
...
[​](https://bun.com/docs/cli/install#param-no-summary)
...
### [​](https://bun.com/docs/cli/install#security-&-integrity) Security & Integrity

[​](https://bun.com/docs/cli/install#param-no-verify)
...
[​](https://bun.com/docs/cli/install#param-trust)
...
### [​](https://bun.com/docs/cli/install#concurrency-&-performance) Concurrency & Performance

[​](https://bun.com/docs/cli/install#param-concurrent-scripts)
...
[​](https://bun.com/docs/cli/install#param-network-concurrency)
...
### [​](https://bun.com/docs/cli/install#lifecycle-script-management) Lifecycle Script Management

[​](https://bun.com/docs/cli/install#param-ignore-scripts)
...
### [​](https://bun.com/docs/cli/install#help-information) Help Information

[​](https://bun.com/docs/cli/install#param-help)
