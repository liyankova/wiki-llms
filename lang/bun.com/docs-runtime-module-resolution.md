---
url: https://bun.com/docs/runtime/module-resolution
...
## [​](https://bun.com/docs/runtime/module-resolution#syntax) Syntax
...
## [​](https://bun.com/docs/runtime/module-resolution#module-systems) Module systems
...
### [​](https://bun.com/docs/runtime/module-resolution#using-require) Using `require()`
...
### [​](https://bun.com/docs/runtime/module-resolution#using-import) Using `import`
...
### [​](https://bun.com/docs/runtime/module-resolution#using-import-and-require-together) Using `import` and `require()` together
...
### [​](https://bun.com/docs/runtime/module-resolution#top-level-await) Top level await
...
## [​](https://bun.com/docs/runtime/module-resolution#importing-packages) Importing packages
...
### [​](https://bun.com/docs/runtime/module-resolution#node-path) NODE\_PATH
...
### [​](https://bun.com/docs/runtime/module-resolution#custom-conditions) Custom conditions
...
## [​](https://bun.com/docs/runtime/module-resolution#path-re-mapping) Path re-mapping
...
## [​](https://bun.com/docs/runtime/module-resolution#import-meta) `import.meta`
...
[Suggest edits](https://github.com/oven-sh/bun/edit/main/docs/runtime/module-resolution.mdx)[Raise issue](https://github.com/oven-sh/bun/issues/new?title=Issue on docs&body=Path: /runtime/module-resolution)
