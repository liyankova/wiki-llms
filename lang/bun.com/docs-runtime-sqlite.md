...
## [​](https://bun.com/docs/runtime/sqlite#database) Database
...
### [​](https://bun.com/docs/runtime/sqlite#strict-mode) Strict mode
...
### [​](https://bun.com/docs/runtime/sqlite#load-via-es-module-import) Load via ES module import
...
### [​](https://bun.com/docs/runtime/sqlite#close-throwonerror:-boolean-=-false) `.close(throwOnError: boolean = false)`
...
### [​](https://bun.com/docs/runtime/sqlite#using-statement) `using` statement
...
### [​](https://bun.com/docs/runtime/sqlite#serialize) `.serialize()`
...
### [​](https://bun.com/docs/runtime/sqlite#query) `.query()`
...
## [​](https://bun.com/docs/runtime/sqlite#wal-mode) WAL mode
...
## [​](https://bun.com/docs/runtime/sqlite#statements) Statements
...
### [​](https://bun.com/docs/runtime/sqlite#binding-values) Binding values
...
#### [​](https://bun.com/docs/runtime/sqlite#strict:-true-lets-you-bind-values-without-prefixes) `strict: true` lets you bind values without prefixes
...
### [​](https://bun.com/docs/runtime/sqlite#all) `.all()`
...
### [​](https://bun.com/docs/runtime/sqlite#get) `.get()`
...
### [​](https://bun.com/docs/runtime/sqlite#run) `.run()`
...
### [​](https://bun.com/docs/runtime/sqlite#as-class-map-query-results-to-a-class) `.as(Class)` - Map query results to a class
...
### [​](https://bun.com/docs/runtime/sqlite#iterate-@@iterator) `.iterate()` (`@@iterator`)
...
### [​](https://bun.com/docs/runtime/sqlite#values) `.values()`
...
### [​](https://bun.com/docs/runtime/sqlite#finalize) `.finalize()`
...
### [​](https://bun.com/docs/runtime/sqlite#tostring) `.toString()`
...
## [​](https://bun.com/docs/runtime/sqlite#parameters) Parameters
...
## [​](https://bun.com/docs/runtime/sqlite#integers) Integers
...
### [​](https://bun.com/docs/runtime/sqlite#safeintegers:-true) `safeIntegers: true`
...
### [​](https://bun.com/docs/runtime/sqlite#safeintegers:-false-default) `safeIntegers: false` (default)
...
## [​](https://bun.com/docs/runtime/sqlite#transactions) Transactions
...
### [​](https://bun.com/docs/runtime/sqlite#loadextension) `.loadExtension()`
...
### [​](https://bun.com/docs/runtime/sqlite#filecontrol-cmd:-number,-value:-any) `.fileControl(cmd: number, value: any)`
...
## [​](https://bun.com/docs/runtime/sqlite#reference) Reference
...
### [​](https://bun.com/docs/runtime/sqlite#datatypes) Datatypes
