---
url: https://bun.com/docs/runtime/file-types
...
Bun uses the file extension to determine which built-in *loader* should be used to parse the file. Every loader has a name, such as `js`, `tsx`, or `json`. These names are used when building [plugins](https://bun.com/docs/bundler/plugins) that extend Bun with custom loaders.
...
## [​](https://bun.com/docs/runtime/file-types#built-in-loaders) Built-in loaders

### [​](https://bun.com/docs/runtime/file-types#js) `js`
...
### [​](https://bun.com/docs/runtime/file-types#jsx) `jsx`
...
### [​](https://bun.com/docs/runtime/file-types#ts) `ts`
...
### [​](https://bun.com/docs/runtime/file-types#jsonc) `jsonc`
...
### [​](https://bun.com/docs/runtime/file-types#toml) `toml`
...
### [​](https://bun.com/docs/runtime/file-types#yaml) `yaml`
...
### [​](https://bun.com/docs/runtime/file-types#text) `text`
...
### [​](https://bun.com/docs/runtime/file-types#napi) `napi`
...
In the bundler, `.node` files are handled using the [`file`](https://bun.com/docs/runtime/file-types#file) loader.

### [​](https://bun.com/docs/runtime/file-types#sqlite) `sqlite`

**SQLite loader**. `with { "type": "sqlite" }` import attribute
In the runtime and bundler, SQLite databases can be directly imported. This will load the database using [`bun:sqlite`](https://bun.com/docs/runtime/sqlite).
...
### [​](https://bun.com/docs/runtime/file-types#html) `html`
...
**HTML Loader Behavior in Different Contexts**The `html` loader behaves differently depending on how it’s used:
...
### [​](https://bun.com/docs/runtime/file-types#css) `css`

**CSS loader**. Default for `.css`.
CSS files can be directly imported. This is primarily useful for [full-stack applications](https://bun.com/docs/bundler/html-static) where CSS is bundled alongside HTML.
...
### [​](https://bun.com/docs/runtime/file-types#sh-loader) `sh` loader
...
### [​](https://bun.com/docs/runtime/file-types#file) `file`
...
[Suggest edits](https://github.com/oven-sh/bun/edit/main/docs/runtime/file-types.mdx)[Raise issue](https://github.com/oven-sh/bun/issues/new?title=Issue on docs&body=Path: /runtime/file-types)
