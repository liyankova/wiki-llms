---
url: https://bun.com/docs/runtime/redis
title: Redis - Bun
...
![https://mintcdn.com/bun-1dd33a4e/Hq64iapoQXHbYMEN/icons/typescript.svg?fit=max&auto=format&n=Hq64iapoQXHbYMEN&q=85&s=c6cceedec8f82d2cc803d7c6ec82b240](https://mintcdn.com/bun-1dd33a4e/Hq64iapoQXHbYMEN/icons/typescript.svg?fit=max&auto=format&n=Hq64iapoQXHbYMEN&q=85&s=c6cceedec8f82d2cc803d7c6ec82b240)redis.ts
...
## [​](https://bun.com/docs/runtime/redis#getting-started) Getting Started
...
### [​](https://bun.com/docs/runtime/redis#connection-lifecycle) Connection Lifecycle
...
## [​](https://bun.com/docs/runtime/redis#basic-operations) Basic Operations

### [​](https://bun.com/docs/runtime/redis#string-operations) String Operations
...
### [​](https://bun.com/docs/runtime/redis#numeric-operations) Numeric Operations
...
### [​](https://bun.com/docs/runtime/redis#hash-operations) Hash Operations
...
### [​](https://bun.com/docs/runtime/redis#set-operations) Set Operations
...
## [​](https://bun.com/docs/runtime/redis#pub/sub) Pub/Sub
...
### [​](https://bun.com/docs/runtime/redis#basic-usage) Basic Usage

To get started publishing messages, you can set up a publisher in
`publisher.ts`:

![https://mintcdn.com/bun-1dd33a4e/Hq64iapoQXHbYMEN/icons/typescript.svg?fit=max&auto=format&n=Hq64iapoQXHbYMEN&q=85&s=c6cceedec8f82d2cc803d7c6ec82b240](https://mintcdn.com/bun-1dd33a4e/Hq64iapoQXHbYMEN/icons/typescript.svg?fit=max&auto=format&n=Hq64iapoQXHbYMEN&q=85&s=c6cceedec8f82d2cc803d7c6ec82b240)publisher.ts
...
![https://mintcdn.com/bun-1dd33a4e/Hq64iapoQXHbYMEN/icons/typescript.svg?fit=max&auto=format&n=Hq64iapoQXHbYMEN&q=85&s=c6cceedec8f82d2cc803d7c6ec82b240](https://mintcdn.com/bun-1dd33a4e/Hq64iapoQXHbYMEN/icons/typescript.svg?fit=max&auto=format&n=Hq64iapoQXHbYMEN&q=85&s=c6cceedec8f82d2cc803d7c6ec82b240)subscriber.ts
...
### [​](https://bun.com/docs/runtime/redis#publishing) Publishing
...
### [​](https://bun.com/docs/runtime/redis#subscriptions) Subscriptions
...
## [​](https://bun.com/docs/runtime/redis#advanced-usage) Advanced Usage

### [​](https://bun.com/docs/runtime/redis#command-execution-and-pipelining) Command Execution and Pipelining
...
### [​](https://bun.com/docs/runtime/redis#raw-commands) Raw Commands
...
### [​](https://bun.com/docs/runtime/redis#connection-events) Connection Events
...
### [​](https://bun.com/docs/runtime/redis#connection-status-and-monitoring) Connection Status and Monitoring
...
### [​](https://bun.com/docs/runtime/redis#type-conversion) Type Conversion
...
## [​](https://bun.com/docs/runtime/redis#connection-options) Connection Options
...
### [​](https://bun.com/docs/runtime/redis#reconnection-behavior) Reconnection Behavior
...
## [​](https://bun.com/docs/runtime/redis#supported-url-formats) Supported URL Formats
...
## [​](https://bun.com/docs/runtime/redis#error-handling) Error Handling
...
## [​](https://bun.com/docs/runtime/redis#example-use-cases) Example Use Cases

### [​](https://bun.com/docs/runtime/redis#caching) Caching
...
### [​](https://bun.com/docs/runtime/redis#rate-limiting) Rate Limiting
...
### [​](https://bun.com/docs/runtime/redis#session-storage) Session Storage
...
## [​](https://bun.com/docs/runtime/redis#implementation-notes) Implementation Notes
...
## [​](https://bun.com/docs/runtime/redis#limitations-and-future-plans) Limitations and Future Plans
...
[Suggest edits](https://github.com/oven-sh/bun/edit/main/docs/runtime/redis.mdx)[Raise issue](https://github.com/oven-sh/bun/issues/new?title=Issue on docs&body=Path: /runtime/redis)
