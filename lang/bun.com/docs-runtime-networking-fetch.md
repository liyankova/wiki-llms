---
url: https://bun.com/docs/runtime/networking/fetch
title: Fetch - Bun
...
## [​](https://bun.com/docs/runtime/networking/fetch#sending-an-http-request) Sending an HTTP request
...
### [​](https://bun.com/docs/runtime/networking/fetch#sending-a-post-request) Sending a POST request
...
### [​](https://bun.com/docs/runtime/networking/fetch#proxying-requests) Proxying requests
...
### [​](https://bun.com/docs/runtime/networking/fetch#custom-headers) Custom headers
...
### [​](https://bun.com/docs/runtime/networking/fetch#response-bodies) Response bodies
...
#### [​](https://bun.com/docs/runtime/networking/fetch#streaming-response-bodies) Streaming response bodies
...
### [​](https://bun.com/docs/runtime/networking/fetch#streaming-request-bodies) Streaming request bodies
...
### [​](https://bun.com/docs/runtime/networking/fetch#fetching-a-url-with-a-timeout) Fetching a URL with a timeout
...
#### [​](https://bun.com/docs/runtime/networking/fetch#canceling-a-request) Canceling a request
...
### [​](https://bun.com/docs/runtime/networking/fetch#unix-domain-sockets) Unix domain sockets
...
### [​](https://bun.com/docs/runtime/networking/fetch#tls) TLS
...
#### [​](https://bun.com/docs/runtime/networking/fetch#custom-tls-validation) Custom TLS Validation
...
#### [​](https://bun.com/docs/runtime/networking/fetch#disable-tls-validation) Disable TLS validation
...
### [​](https://bun.com/docs/runtime/networking/fetch#request-options) Request options
...
#### [​](https://bun.com/docs/runtime/networking/fetch#s3-urls-s3://) S3 URLs - `s3://`
...
You can read more about Bun’s S3 support in the [S3](https://bun.com/docs/runtime/s3) documentation.

#### [​](https://bun.com/docs/runtime/networking/fetch#file-urls-file://) File URLs - `file://`
...
#### [​](https://bun.com/docs/runtime/networking/fetch#data-urls-data:) Data URLs - `data:`
...
#### [​](https://bun.com/docs/runtime/networking/fetch#blob-urls-blob:) Blob URLs - `blob:`
...
### [​](https://bun.com/docs/runtime/networking/fetch#error-handling) Error handling
...
### [​](https://bun.com/docs/runtime/networking/fetch#content-type-handling) Content-Type handling
...
## [​](https://bun.com/docs/runtime/networking/fetch#debugging) Debugging
...
## [​](https://bun.com/docs/runtime/networking/fetch#performance) Performance
...
### [​](https://bun.com/docs/runtime/networking/fetch#dns-prefetching) DNS prefetching
...
#### [​](https://bun.com/docs/runtime/networking/fetch#dns-caching) DNS caching
...
To learn more about DNS caching in Bun, see the [DNS caching](https://bun.com/docs/runtime/networking/dns) documentation.

### [​](https://bun.com/docs/runtime/networking/fetch#preconnect-to-a-host) Preconnect to a host
...
#### [​](https://bun.com/docs/runtime/networking/fetch#preconnect-at-startup) Preconnect at startup
...
### [​](https://bun.com/docs/runtime/networking/fetch#connection-pooling-&-http-keep-alive) Connection pooling & HTTP keep-alive
...
#### [​](https://bun.com/docs/runtime/networking/fetch#simultaneous-connection-limit) Simultaneous connection limit
...
### [​](https://bun.com/docs/runtime/networking/fetch#response-buffering) Response buffering
...
### [​](https://bun.com/docs/runtime/networking/fetch#implementation-details) Implementation details
...
[Suggest edits](https://github.com/oven-sh/bun/edit/main/docs/runtime/networking/fetch.mdx)[Raise issue](https://github.com/oven-sh/bun/issues/new?title=Issue on docs&body=Path: /runtime/networking/fetch)
