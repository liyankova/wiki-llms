---
url: https://bun.com/docs/bundler/html-static
title: HTML & static sites - Bun
source_domain: bun.com
---

# HTML & static sites - Bun
...
## [​](https://bun.com/docs/bundler/html-static#single-page-apps-spa) Single Page Apps (SPA)
...
## [​](https://bun.com/docs/bundler/html-static#multi-page-apps-mpa) Multi-page apps (MPA)
...
### [​](https://bun.com/docs/bundler/html-static#glob-patterns) Glob patterns
...
### [​](https://bun.com/docs/bundler/html-static#path-normalization) Path normalization
...
## [​](https://bun.com/docs/bundler/html-static#javascript,-typescript,-and-jsx) JavaScript, TypeScript, and JSX
...
### [​](https://bun.com/docs/bundler/html-static#es-modules-&-commonjs) ES Modules & CommonJS
...
## [​](https://bun.com/docs/bundler/html-static#css) CSS
...
### [​](https://bun.com/docs/bundler/html-static#referencing-local-assets-in-css) Referencing local assets in CSS
...
### [​](https://bun.com/docs/bundler/html-static#importing-css-in-javascript) Importing CSS in JavaScript
...
## [​](https://bun.com/docs/bundler/html-static#plugins) Plugins

The dev server supports plugins.

### [​](https://bun.com/docs/bundler/html-static#tailwind-css) Tailwind CSS
...
## [​](https://bun.com/docs/bundler/html-static#inline-environment-variables) Inline environment variables
...
### [​](https://bun.com/docs/bundler/html-static#dev-server-runtime) Dev server (runtime)
...
### [​](https://bun.com/docs/bundler/html-static#build-for-production) Build for production
...
### [​](https://bun.com/docs/bundler/html-static#example) Example
...
## [​](https://bun.com/docs/bundler/html-static#echo-console-logs-from-browser-to-terminal) Echo console logs from browser to terminal
...
## [​](https://bun.com/docs/bundler/html-static#edit-files-in-the-browser) Edit files in the browser
...
## [​](https://bun.com/docs/bundler/html-static#keyboard-shortcuts) Keyboard Shortcuts
...
## [​](https://bun.com/docs/bundler/html-static#build-for-production-2) Build for Production
...
### [​](https://bun.com/docs/bundler/html-static#watch-mode) Watch Mode
...
## [​](https://bun.com/docs/bundler/html-static#plugin-api) Plugin API
...
## [​](https://bun.com/docs/bundler/html-static#what-gets-processed) What Gets Processed?
...
## [​](https://bun.com/docs/bundler/html-static#how-this-works) How this works

This is a small wrapper around Bun’s support for HTML imports in JavaScript.

## [​](https://bun.com/docs/bundler/html-static#adding-a-backend-to-your-frontend) Adding a backend to your frontend
...
[Suggest edits](https://github.com/oven-sh/bun/edit/main/docs/bundler/html-static.mdx)[Raise issue](https://github.com/oven-sh/bun/issues/new?title=Issue on docs&body=Path: /bundler/html-static)
