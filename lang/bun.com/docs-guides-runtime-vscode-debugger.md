---
url: https://bun.com/docs/guides/runtime/vscode-debugger
title: Debugging Bun with the VS Code extension - Bun
source_domain: bun.com
---

# Debugging Bun with the VS Code extension - Bun

VSCode extension support is currently buggy. We recommend the [Web Debugger](https://bun.com/docs/guides/runtime/web-debugger) for now.
