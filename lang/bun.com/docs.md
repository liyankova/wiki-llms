...
A fast JavaScript runtime designed as a drop-in replacement for Node.js](https://bun.com/docs/runtime)[## Bun Package Manager

Install packages up to 30x faster than npm with a global cache and workspaces](https://bun.com/docs/pm/cli/install)[## Bun Test Runner

Jest-compatible, TypeScript-first tests with snapshots, DOM, and watch mode](https://bun.com/docs/test)[## Bun Bundler

Bundle TypeScript, JSX, React & CSS for both browsers and servers](https://bun.com/docs/bundler)

---

## [​](https://bun.com/docs#get-started) Get Started

Bun ships as a single, dependency-free binary and includes a runtime, package manager, test runner, and bundler. New to Bun?

[## Install Bun

Supported platforms and all install methods.](https://bun.com/docs/installation)[## Quickstart

Hello world in minutes with Bun.serve.](https://bun.com/docs/quickstart)

---

## [​](https://bun.com/docs#what’s-inside) What’s Inside
...
## [​](https://bun.com/docs#what-is-bun) What is Bun?
...
## [​](https://bun.com/docs#what-is-a-runtime) What is a runtime?
...
### [​](https://bun.com/docs#browsers) Browsers
...
### [​](https://bun.com/docs#node-js) Node.js
...
## [​](https://bun.com/docs#design-goals) Design goals
...
* **Node.js compatibility**. In addition to supporting Node-style module resolution, Bun aims for full compatibility with built-in Node.js globals (`process`, `Buffer`) and modules (`path`, `fs`, `http`, etc.) *This is an ongoing effort that is not complete.* Refer to the [compatibility page](https://bun.com/docs/runtime/nodejs-compat) for the current status.
