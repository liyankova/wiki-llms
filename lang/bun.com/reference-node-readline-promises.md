---
url: https://bun.com/reference/node/readline/promises
title: Node.js readline/promises module | API Reference | Bun
source_domain: bun.com
---

# Node.js readline/promises module | API Reference | Bun

Node.js module

# [readline/promises](https://bun.com/reference/node/readline/promises)
...
* ### class [Interface](https://bun.com/reference/node/readline/promises/Interface)
  ...
  + readonly [cursor](https://bun.com/reference/node/readline/promises/Interface/cursor): number
  ...
  + readonly [line](https://bun.com/reference/node/readline/promises/Interface/line): string
    ...
    **If not using a TTY stream for input, use the `'line'` event.**
    ...
    ```
  + readonly [terminal](https://bun.com/reference/node/readline/promises/Interface/terminal): boolean
  + static [captureRejections](https://bun.com/reference/node/readline/promises/Interface/captureRejections): boolean

    Value: [boolean](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#Boolean_type)

    Change the default `captureRejections` option on all new `EventEmitter` objects.
  + readonly static [captureRejectionSymbol](https://bun.com/reference/node/readline/promises/Interface/captureRejectionSymbol): typeof [captureRejectionSymbol](https://bun.com/reference/node/events/default/captureRejectionSymbol)

    Value: `Symbol.for('nodejs.rejection')`

    See how to write a custom `rejection handler`.
  + static [defaultMaxListeners](https://bun.com/reference/node/readline/promises/Interface/defaultMaxListeners): number
  ...
  + readonly static [errorMonitor](https://bun.com/reference/node/readline/promises/Interface/errorMonitor): typeof [errorMonitor](https://bun.com/reference/node/events/default/errorMonitor)

    This symbol shall be used to install a listener for only monitoring `'error'` events. Listeners installed using this symbol are called before the regular `'error'` listeners are called.

    Installing a listener using this symbol does not change the behavior once an `'error'` event is emitted. Therefore, the process will still crash if no regular `'error'` listener is installed.
  + [[Symbol.asyncIterator]](https://bun.com/reference/node/readline/promises/Interface/[asyncIterator])(): AsyncIterator<string>;
  + [[events.captureRejectionSymbol]](https://bun.com/reference/node/readline/promises/Interface/[captureRejectionSymbol])<K>(
  ...
  + [[Symbol.dispose]](https://bun.com/reference/node/readline/promises/Interface/[dispose])(): void;

    Alias for `rl.close()`.
  + [addListener](https://bun.com/reference/node/readline/promises/Interface/addListener)(
    ...
    7. SIGTSTP
    8. history
  + [close](https://bun.com/reference/node/readline/promises/Interface/close)(): void;
  ...
  + [emit](https://bun.com/reference/node/readline/promises/Interface/emit)(
  ...
  + [eventNames](https://bun.com/reference/node/readline/promises/Interface/eventNames)(): string | symbol[];
    ...
    ```
  + [getCursorPos](https://bun.com/reference/node/readline/promises/Interface/getCursorPos)(): [CursorPos](https://bun.com/reference/node/readline/CursorPos);

    Returns the real position of the cursor in relation to the input prompt + string. Long input (wrapping) strings, as well as multiple line prompts are included in the calculations.
  + [getMaxListeners](https://bun.com/reference/node/readline/promises/Interface/getMaxListeners)(): number;

    Returns the current max listener value for the `EventEmitter` which is either set by `emitter.setMaxListeners(n)` or defaults to EventEmitter.defaultMaxListeners.
  + [getPrompt](https://bun.com/reference/node/readline/promises/Interface/getPrompt)(): string;
  ...
  + [listenerCount](https://bun.com/reference/node/readline/promises/Interface/listenerCount)<K>(
  ...
  + [listeners](https://bun.com/reference/node/readline/promises/Interface/listeners)<K>(
    ...
    // Prints: [ [Function] ]
    ```
  + [off](https://bun.com/reference/node/readline/promises/Interface/off)<K>(
  ...
  + [on](https://bun.com/reference/node/readline/promises/Interface/on)(
  ...
  + [once](https://bun.com/reference/node/readline/promises/Interface/once)(
  ...
  + [pause](https://bun.com/reference/node/readline/promises/Interface/pause)(): this;

    The `rl.pause()` method pauses the `input` stream, allowing it to be resumed later if necessary.

    Calling `rl.pause()` does not immediately pause other events (including `'line'`) from being emitted by the `Interface` instance.
  + [prependListener](https://bun.com/reference/node/readline/promises/Interface/prependListener)(
  ...
  + [prependOnceListener](https://bun.com/reference/node/readline/promises/Interface/prependOnceListener)(
  ...
  + [prompt](https://bun.com/reference/node/readline/promises/Interface/prompt)(
  ...
  + [question](https://bun.com/reference/node/readline/promises/Interface/question)(
    ...
    A promise that is fulfilled with the user's input in response to the `query`.
  + [rawListeners](https://bun.com/reference/node/readline/promises/Interface/rawListeners)<K>(
    ...
    emitter.emit('log');
    ```
  + [removeAllListeners](https://bun.com/reference/node/readline/promises/Interface/removeAllListeners)(
    ...
    Returns a reference to the `EventEmitter`, so that calls can be chained.
  + [removeListener](https://bun.com/reference/node/readline/promises/Interface/removeListener)<K>(
    ...
    Returns a reference to the `EventEmitter`, so that calls can be chained.
  + [resume](https://bun.com/reference/node/readline/promises/Interface/resume)(): this;

    The `rl.resume()` method resumes the `input` stream if it has been paused.
  + [setMaxListeners](https://bun.com/reference/node/readline/promises/Interface/setMaxListeners)(
    ...
    Returns a reference to the `EventEmitter`, so that calls can be chained.
  + [setPrompt](https://bun.com/reference/node/readline/promises/Interface/setPrompt)(
  ...
  + [write](https://bun.com/reference/node/readline/promises/Interface/write)(
    ...
    The `rl.write()` method will write the data to the `readline` `Interface`'s `input` *as if it were provided by the user*.
  + static [addAbortListener](https://bun.com/reference/node/readline/promises/Interface/addAbortListener)(
  ...
  + static [getEventListeners](https://bun.com/reference/node/readline/promises/Interface/getEventListeners)(
    ...
    ```
  + static [getMaxListeners](https://bun.com/reference/node/readline/promises/Interface/getMaxListeners)(
    ...
    ```
  + static [on](https://bun.com/reference/node/readline/promises/Interface/on)(
    ...
    An `AsyncIterator` that iterates `eventName` events emitted by the `emitter`
  + static [once](https://bun.com/reference/node/readline/promises/Interface/once)(
    ...
    ee.emit('foo'); // Prints: Waiting for the event was canceled!
    ```
  + static [setMaxListeners](https://bun.com/reference/node/readline/promises/Interface/setMaxListeners)(
...
* ### class [Readline](https://bun.com/reference/node/readline/promises/Readline)

  + [clearLine](https://bun.com/reference/node/readline/promises/Readline/clearLine)(
    ...
    this
  + [clearScreenDown](https://bun.com/reference/node/readline/promises/Readline/clearScreenDown)(): this;
    ...
    this
  + [commit](https://bun.com/reference/node/readline/promises/Readline/commit)(): Promise<void>;

    The `rl.commit()` method sends all the pending actions to the associated `stream` and clears the internal list of pending actions.
  + [cursorTo](https://bun.com/reference/node/readline/promises/Readline/cursorTo)(
    ...
    this
  + [moveCursor](https://bun.com/reference/node/readline/promises/Readline/moveCursor)(
    ...
    this
  + [rollback](https://bun.com/reference/node/readline/promises/Readline/rollback)(): this;
    ...
    this
* function [createInterface](https://bun.com/reference/node/readline/promises/createInterface)(

  input: ReadableStream,

  output?: WritableStream,

  completer?: [Completer](https://bun.com/reference/node/readline/promises/Completer),

  terminal?: boolean

  ): [Interface](https://bun.com/reference/node/readline/promises/Interface);
  ...
  options: [ReadLineOptions](https://bun.com/reference/node/readline/promises/ReadLineOptions)
...
* ### interface [ReadLineOptions](https://bun.com/reference/node/readline/promises/ReadLineOptions)

  + [completer](https://bun.com/reference/node/readline/promises/ReadLineOptions/completer)?: [Completer](https://bun.com/reference/node/readline/promises/Completer)

    An optional function used for Tab autocompletion.
  + [crlfDelay](https://bun.com/reference/node/readline/promises/ReadLineOptions/crlfDelay)?: number
    ...
    line delimiter).
  + [escapeCodeTimeout](https://bun.com/reference/node/readline/promises/ReadLineOptions/escapeCodeTimeout)?: number
  ...
  + [history](https://bun.com/reference/node/readline/promises/ReadLineOptions/history)?: string[]
  ...
  + [historySize](https://bun.com/reference/node/readline/promises/ReadLineOptions/historySize)?: number
  ...
  + [input](https://bun.com/reference/node/readline/promises/ReadLineOptions/input): ReadableStream

    The [`Readable`](https://nodejs.org/docs/latest-v24.x/api/stream.html#readable-streams) stream to listen to
  + [output](https://bun.com/reference/node/readline/promises/ReadLineOptions/output)?: WritableStream

    The [`Writable`](https://nodejs.org/docs/latest-v24.x/api/stream.html#writable-streams) stream to write readline data to.
  + [prompt](https://bun.com/reference/node/readline/promises/ReadLineOptions/prompt)?: string

    The prompt string to use.
  + [removeHistoryDuplicates](https://bun.com/reference/node/readline/promises/ReadLineOptions/removeHistoryDuplicates)?: boolean
  ...
  + [signal](https://bun.com/reference/node/readline/promises/ReadLineOptions/signal)?: [AbortSignal](https://bun.com/reference/globals/AbortSignal)

    Allows closing the interface using an AbortSignal. Aborting the signal will internally call `close` on the interface.
  + [tabSize](https://bun.com/reference/node/readline/promises/ReadLineOptions/tabSize)?: number

    The number of spaces a tab is equal to (minimum 1).
  + [terminal](https://bun.com/reference/node/readline/promises/ReadLineOptions/terminal)?: boolean
...
* type [Completer](https://bun.com/reference/node/readline/promises/Completer) = (line: string) => [CompleterResult](https://bun.com/reference/node/readline/CompleterResult) | Promise<[CompleterResult](https://bun.com/reference/node/readline/CompleterResult)>