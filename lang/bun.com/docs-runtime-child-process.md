...
## [​](https://bun.com/docs/runtime/child-process#spawn-a-process-bun-spawn) Spawn a process (`Bun.spawn()`)
...
## [​](https://bun.com/docs/runtime/child-process#input-stream) Input stream
...
## [​](https://bun.com/docs/runtime/child-process#output-streams) Output streams
...
## [​](https://bun.com/docs/runtime/child-process#exit-handling) Exit handling
...
## [​](https://bun.com/docs/runtime/child-process#resource-usage) Resource usage
...
## [​](https://bun.com/docs/runtime/child-process#using-abortsignal) Using AbortSignal
...
## [​](https://bun.com/docs/runtime/child-process#using-timeout-and-killsignal) Using timeout and killSignal
...
## [​](https://bun.com/docs/runtime/child-process#using-maxbuffer) Using maxBuffer
...
## [​](https://bun.com/docs/runtime/child-process#inter-process-communication-ipc) Inter-process communication (IPC)

Bun supports direct inter-process communication channel between two `bun` processes. To receive messages from a spawned Bun subprocess, specify an `ipc` handler.

![https://mintcdn.com/bun-1dd33a4e/Hq64iapoQXHbYMEN/icons/typescript.svg?fit=max&auto=format&n=Hq64iapoQXHbYMEN&q=85&s=c6cceedec8f82d2cc803d7c6ec82b240](https://mintcdn.com/bun-1dd33a4e/Hq64iapoQXHbYMEN/icons/typescript.svg?fit=max&auto=format&n=Hq64iapoQXHbYMEN&q=85&s=c6cceedec8f82d2cc803d7c6ec82b240)parent.ts
...
### [​](https://bun.com/docs/runtime/child-process#ipc-between-bun-&-node-js) IPC between Bun & Node.js
...
## [​](https://bun.com/docs/runtime/child-process#blocking-api-bun-spawnsync) Blocking API (`Bun.spawnSync()`)
...
## [​](https://bun.com/docs/runtime/child-process#benchmarks) Benchmarks
...
## [​](https://bun.com/docs/runtime/child-process#reference) Reference
...
[Suggest edits](https://github.com/oven-sh/bun/edit/main/docs/runtime/child-process.mdx)[Raise issue](https://github.com/oven-sh/bun/issues/new?title=Issue on docs&body=Path: /runtime/child-process)
