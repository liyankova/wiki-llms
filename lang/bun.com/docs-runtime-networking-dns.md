---
url: https://bun.com/docs/runtime/networking/dns
title: DNS - Bun
...
## [​](https://bun.com/docs/runtime/networking/dns#dns-caching-in-bun) DNS caching in Bun
...
### [​](https://bun.com/docs/runtime/networking/dns#when-should-i-prefetch-a-dns-entry) When should I prefetch a DNS entry?
...
### [​](https://bun.com/docs/runtime/networking/dns#dns-prefetch) `dns.prefetch`
...
### [​](https://bun.com/docs/runtime/networking/dns#dns-getcachestats) `dns.getCacheStats()`
...
### [​](https://bun.com/docs/runtime/networking/dns#configuring-dns-cache-ttl) Configuring DNS cache TTL
...
#### [​](https://bun.com/docs/runtime/networking/dns#why-is-30-seconds-the-default) Why is 30 seconds the default?
...
[Suggest edits](https://github.com/oven-sh/bun/edit/main/docs/runtime/networking/dns.mdx)[Raise issue](https://github.com/oven-sh/bun/issues/new?title=Issue on docs&body=Path: /runtime/networking/dns)
