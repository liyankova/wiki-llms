---
url: https://bun.com/docs/runtime/plugins
title: Plugins - Bun
...
## [​](https://bun.com/docs/runtime/plugins#lifecycle-hooks) Lifecycle hooks
...
* [`onBeforeParse()`](https://bun.com/docs/runtime/plugins#onbeforeparse): Run zero-copy native addons in the parser thread before a file is parsed.

### [​](https://bun.com/docs/runtime/plugins#reference) Reference

A rough overview of the types (please refer to Bun’s `bun.d.ts` for the full type definitions):

![https://mintcdn.com/bun-1dd33a4e/Hq64iapoQXHbYMEN/icons/typescript.svg?fit=max&auto=format&n=Hq64iapoQXHbYMEN&q=85&s=c6cceedec8f82d2cc803d7c6ec82b240](https://mintcdn.com/bun-1dd33a4e/Hq64iapoQXHbYMEN/icons/typescript.svg?fit=max&auto=format&n=Hq64iapoQXHbYMEN&q=85&s=c6cceedec8f82d2cc803d7c6ec82b240)Plugin Types
...
## [​](https://bun.com/docs/runtime/plugins#usage) Usage

A plugin is defined as simple JavaScript object containing a `name` property and a `setup` function.

![https://mintcdn.com/bun-1dd33a4e/Hq64iapoQXHbYMEN/icons/typescript.svg?fit=max&auto=format&n=Hq64iapoQXHbYMEN&q=85&s=c6cceedec8f82d2cc803d7c6ec82b240](https://mintcdn.com/bun-1dd33a4e/Hq64iapoQXHbYMEN/icons/typescript.svg?fit=max&auto=format&n=Hq64iapoQXHbYMEN&q=85&s=c6cceedec8f82d2cc803d7c6ec82b240)myPlugin.ts
...
## [​](https://bun.com/docs/runtime/plugins#plugin-lifecycle) Plugin lifecycle

### [​](https://bun.com/docs/runtime/plugins#namespaces) Namespaces
...
### [​](https://bun.com/docs/runtime/plugins#onstart) `onStart`
...
### [​](https://bun.com/docs/runtime/plugins#onresolve) `onResolve`
...
### [​](https://bun.com/docs/runtime/plugins#onload) `onLoad`
...
#### [​](https://bun.com/docs/runtime/plugins#defer) `.defer()`
...
## [​](https://bun.com/docs/runtime/plugins#native-plugins) Native plugins
...
Native plugins are written as [NAPI](https://bun.com/docs/runtime/node-api) modules and can be run on multiple threads. This allows native plugins to run much faster than JavaScript plugins.
...
* [`onBeforeParse()`](https://bun.com/docs/runtime/plugins#onbeforeparse): Called on any thread before a file is parsed by Bun’s bundler.
...
### [​](https://bun.com/docs/runtime/plugins#creating-a-native-plugin-in-rust) Creating a native plugin in Rust
...
![https://mintcdn.com/bun-1dd33a4e/Hq64iapoQXHbYMEN/icons/rust.svg?fit=max&auto=format&n=Hq64iapoQXHbYMEN&q=85&s=a19fdd19ab10419707f1ba90fa0a2cde](https://mintcdn.com/bun-1dd33a4e/Hq64iapoQXHbYMEN/icons/rust.svg?fit=max&auto=format&n=Hq64iapoQXHbYMEN&q=85&s=a19fdd19ab10419707f1ba90fa0a2cde)lib.rs
...
### [​](https://bun.com/docs/runtime/plugins#onbeforeparse) `onBeforeParse`
...
[Suggest edits](https://github.com/oven-sh/bun/edit/main/docs/runtime/plugins.mdx)[Raise issue](https://github.com/oven-sh/bun/issues/new?title=Issue on docs&body=Path: /runtime/plugins)
