...
## [When to use macros](https://bun.com/blog/bun-macros#when-to-use-macros)
...
### [Embed latest git commit hash](https://bun.com/blog/bun-macros#embed-latest-git-commit-hash)
...
### [Make `fetch()` requests at bundle-time](https://bun.com/blog/bun-macros#make-fetch-requests-at-bundle-time)
...
## [How it works](https://bun.com/blog/bun-macros#how-it-works)
...
### [Execution order](https://bun.com/blog/bun-macros#execution-order)
...
### [Dead code elimination](https://bun.com/blog/bun-macros#dead-code-elimination)
...
## [Security considerations](https://bun.com/blog/bun-macros#security-considerations)
...
### [*Macros are disabled in node\_modules*](https://bun.com/blog/bun-macros#macros-are-disabled-in-node-modules)
...
## [Limitations](https://bun.com/blog/bun-macros#limitations)

Some things to know.

### [*The result of the macro must be serializable!*](https://bun.com/blog/bun-macros#the-result-of-the-macro-must-be-serializable)
...
### [*The input arguments must be statically analyzable.*](https://bun.com/blog/bun-macros#the-input-arguments-must-be-statically-analyzable)
