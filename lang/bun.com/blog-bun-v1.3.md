...
[Jarred](https://twitter.com/jarredsumner), [Lydia](https://github.com/lydiahallie), [Ciro](https://github.com/cirospaciari), [Dylan](https://github.com/dylan-conway), [Aidan](https://github.com/pfgithub), [Alistair](https://github.com/alii), [Taylor](https://github.com/taylordotfish), [Marko](https://github.com/markovejnovic), [Michael](https://github.com/riskymh), [Zack](https://github.com/zackradisic) · October 10, 2025
...
## [Full‑stack JavaScript runtime](https://bun.com/blog/bun-v1.3#full-stack-javascript-runtime)
...
### [Frontend Development](https://bun.com/blog/bun-v1.3#frontend-development)
...
### [Hot Reloading](https://bun.com/blog/bun-v1.3#hot-reloading)
...
### [Production Builds](https://bun.com/blog/bun-v1.3#production-builds)
...
### [Getting Started](https://bun.com/blog/bun-v1.3#getting-started)
...
### [Full-stack Development](https://bun.com/blog/bun-v1.3#full-stack-development)
...
### [Routing](https://bun.com/blog/bun-v1.3#routing)
...
### [Compile full-stack apps to a standalone executable](https://bun.com/blog/bun-v1.3#compile-full-stack-apps-to-a-standalone-executable)
...
### [Bun.SQL - MySQL, MariaDB, and SQLite support](https://bun.com/blog/bun-v1.3#bun-sql-mysql-mariadb-and-sqlite-support)
...
### [PostgreSQL enhancements](https://bun.com/blog/bun-v1.3#postgresql-enhancements)
...
* **DATABASE\_URL options precedence** - Handled correctly

### [SQLite enhancements](https://bun.com/blog/bun-v1.3#sqlite-enhancements)
...
### [Built-in Redis Client](https://bun.com/blog/bun-v1.3#built-in-redis-client)

[![Redis Benchmark, showing more than 7.9X the performance of
ioredis](https://bun.com/images/bun-redis-perf-1.3.png)](https://bun.com/images/bun-redis-perf-1.3.png)
...
### [WebSocket Improvements](https://bun.com/blog/bun-v1.3#websocket-improvements)
...
### [S3 improvements](https://bun.com/blog/bun-v1.3#s3-improvements)
...
## [Bundler & Build](https://bun.com/blog/bun-v1.3#bundler-build)

Bun's bundler adds programmatic compilation, cross-platform builds, and smarter minification in 1.3.

### [Create executables with the Bun.build() API](https://bun.com/blog/bun-v1.3#create-executables-with-the-bun-build-api)
...
### [Code signing support](https://bun.com/blog/bun-v1.3#code-signing-support)
...
### [Cross-compile executables](https://bun.com/blog/bun-v1.3#cross-compile-executables)
...
### [Windows executable metadata](https://bun.com/blog/bun-v1.3#windows-executable-metadata)
...
### [Minification improvements](https://bun.com/blog/bun-v1.3#minification-improvements)
...
### [JSX configuration](https://bun.com/blog/bun-v1.3#jsx-configuration)
...
### [Other bundler improvements](https://bun.com/blog/bun-v1.3#other-bundler-improvements)
...
## [Package Management](https://bun.com/blog/bun-v1.3#package-management)
...
### [Catalogs synchronize dependency versions](https://bun.com/blog/bun-v1.3#catalogs-synchronize-dependency-versions)
...
### [Isolated installs are now the default for workspaces](https://bun.com/blog/bun-v1.3#isolated-installs-are-now-the-default-for-workspaces)
...
### [pnpm.lock & yarn.lock migration support](https://bun.com/blog/bun-v1.3#pnpm-lock-yarn-lock-migration-support)
...
### [Security Scanner API](https://bun.com/blog/bun-v1.3#security-scanner-api)
...
### [Minimum release age](https://bun.com/blog/bun-v1.3#minimum-release-age)
...
### [Platform-specific dependencies](https://bun.com/blog/bun-v1.3#platform-specific-dependencies)
...
### [Workspace configuration](https://bun.com/blog/bun-v1.3#workspace-configuration)
...
### [New commands](https://bun.com/blog/bun-v1.3#new-commands)
...
### [Other package manager improvements](https://bun.com/blog/bun-v1.3#other-package-manager-improvements)
...
## [Testing and Debugging Improvements](https://bun.com/blog/bun-v1.3#testing-and-debugging-improvements)

Bun's test runner gets more powerful with VS Code integration, concurrent tests, type testing, and better output.

### [Async Stack Traces](https://bun.com/blog/bun-v1.3#async-stack-traces)
...
### [VS Code Test Explorer integration](https://bun.com/blog/bun-v1.3#vs-code-test-explorer-integration)
...
### [Concurrent testing with bun:test](https://bun.com/blog/bun-v1.3#concurrent-testing-with-bun-test)
...
### [`test.serial` to make specific tests sequential](https://bun.com/blog/bun-v1.3#test-serial-to-make-specific-tests-sequential)
...
### [Randomize test order with `--randomize`](https://bun.com/blog/bun-v1.3#randomize-test-order-with-randomize)
...
### [Chain qualifiers](https://bun.com/blog/bun-v1.3#chain-qualifiers)
...
### [Test execution order improvements](https://bun.com/blog/bun-v1.3#test-execution-order-improvements)
...
### [Concurrent test limitations](https://bun.com/blog/bun-v1.3#concurrent-test-limitations)
...
### [Stricter `bun test` in CI environments](https://bun.com/blog/bun-v1.3#stricter-bun-test-in-ci-environments)
...
### [Mark tests as expected to fail](https://bun.com/blog/bun-v1.3#mark-tests-as-expected-to-fail)
...
### [Type testing with `expectTypeOf()`](https://bun.com/blog/bun-v1.3#type-testing-with-expecttypeof)
...
### [New matchers](https://bun.com/blog/bun-v1.3#new-matchers)
...
### [Indented inline snapshots](https://bun.com/blog/bun-v1.3#indented-inline-snapshots)
...
### [Other testing improvements](https://bun.com/blog/bun-v1.3#other-testing-improvements)
...
## [APIs & Standards](https://bun.com/blog/bun-v1.3#apis-standards)
...
### [YAML Support](https://bun.com/blog/bun-v1.3#yaml-support)
...
### [Cookies](https://bun.com/blog/bun-v1.3#cookies)
...
### [Consume a ReadableStream with convenience methods](https://bun.com/blog/bun-v1.3#consume-a-readablestream-with-convenience-methods)
...
### [WebAssembly streaming](https://bun.com/blog/bun-v1.3#webassembly-streaming)
...
### [Zstandard compression](https://bun.com/blog/bun-v1.3#zstandard-compression)
...
### [DisposableStack and AsyncDisposableStack](https://bun.com/blog/bun-v1.3#disposablestack-and-asyncdisposablestack)
...
## [Security Enhancements](https://bun.com/blog/bun-v1.3#security-enhancements)

### [Bun.secrets for Encrypted Credential Storage](https://bun.com/blog/bun-v1.3#bun-secrets-for-encrypted-credential-storage)
...
### [CSRF Protection](https://bun.com/blog/bun-v1.3#csrf-protection)
...
### [Crypto performance improvements](https://bun.com/blog/bun-v1.3#crypto-performance-improvements)
...
## [Node.js compatibility](https://bun.com/blog/bun-v1.3#node-js-compatibility)
...
### [Worker enhancements](https://bun.com/blog/bun-v1.3#worker-enhancements)
...
### [`node:test` support](https://bun.com/blog/bun-v1.3#node-test-support)
...
### [`node:vm` improvements](https://bun.com/blog/bun-v1.3#node-vm-improvements)
...
### [`require.extensions`](https://bun.com/blog/bun-v1.3#require-extensions)
...
### [Disable Native Addons](https://bun.com/blog/bun-v1.3#disable-native-addons)
...
### [Other Node.js compatibility improvements](https://bun.com/blog/bun-v1.3#other-node-js-compatibility-improvements)
...
* ERR\_TLS\_INVALID\_PROTOCOL\_VERSION and ERR\_TLS\_PROTOCOL\_VERSION\_CONFLICT errors
...
* `--preserve-symlinks` flag and NODE\_PRESERVE\_SYMLINKS=1
...
## [Developer experience](https://bun.com/blog/bun-v1.3#developer-experience)

Bun 1.3 includes several improvements to make daily development easier and more productive.

### [Better TypeScript defaults](https://bun.com/blog/bun-v1.3#better-typescript-defaults)
...
### [Console depth control](https://bun.com/blog/bun-v1.3#console-depth-control)
...
### [Smarter TypeScript types](https://bun.com/blog/bun-v1.3#smarter-typescript-types)
...
### [`BUN_OPTIONS`](https://bun.com/blog/bun-v1.3#bun-options)
...
### [Custom User-Agent](https://bun.com/blog/bun-v1.3#custom-user-agent)
...
### [Preload Scripts and SQL Optimization](https://bun.com/blog/bun-v1.3#preload-scripts-and-sql-optimization)
...
### [Standalone Executable Control](https://bun.com/blog/bun-v1.3#standalone-executable-control)
...
### [Run binaries from packages with different names](https://bun.com/blog/bun-v1.3#run-binaries-from-packages-with-different-names)
...
## [Utilities](https://bun.com/blog/bun-v1.3#utilities)

Bun 1.3 ships utility functions for common tasks.

### [`Bun.stripANSI()`](https://bun.com/blog/bun-v1.3#bun-stripansi)
...
[![benchmark](https://bun.com/bun-strip-ansi.png)](https://bun.com/bun-strip-ansi.png)
...
### [`Bun.hash.rapidhash`](https://bun.com/blog/bun-v1.3#bun-hash-rapidhash)
...
### [`postMessage` gets up to 500x faster](https://bun.com/blog/bun-v1.3#postmessage-gets-up-to-500x-faster)
...
[![postMessage benchmark showing more than 500X for postMessage in Bun 1.3](https://bun.com/bun-postmessage.png)](https://bun.com/bun-postmessage.png)
...
## [Processes & Shell](https://bun.com/blog/bun-v1.3#processes-shell)

Bun 1.3 improves process spawning and shell scripting.

### [Timeout option](https://bun.com/blog/bun-v1.3#timeout-option)
...
### [Limit process output with `maxBuffer`](https://bun.com/blog/bun-v1.3#limit-process-output-with-maxbuffer)
...
### [Enhanced Socket Information](https://bun.com/blog/bun-v1.3#enhanced-socket-information)
...
### [Other process improvements](https://bun.com/blog/bun-v1.3#other-process-improvements)
...
## [Performance improvements](https://bun.com/blog/bun-v1.3#performance-improvements)
...
* **NAPI: node-sdl 100x faster**: Fixed napi\_create\_double encoding
...
## [Bug Fixes](https://bun.com/blog/bun-v1.3#bug-fixes)
...
* Fixed DuckDB native module crashes from null-returning modules in napi\_register\_module\_v1
...
* React JSX runtime correctly loads react-jsx vs react-jsxdev based on NODE\_ENV
...
* Fixed Node-API compatibility: each module now gets its own napi\_env, preventing conflicts when loading multiple modules
...
* Fixed N-API string conversion edge cases in napi*get\_value\_string*\_ and napi*create\_string*\_ functions
...
* Fixed node:crypto.createCipheriv throwing INVALID\_ARG\_VALUE with empty options object (now infers authTagLength)
...
* Fixed queueMicrotask error handling to throw ERR\_INVALID\_ARG\_TYPE for invalid arguments
...
* Fixed worker\_threads stability issues (multiple bug fixes)
...
* Fixed ERR\_EVENT\_RECURSION not being thrown when expected
...
* Fixed crash when calling napi\_delete\_async\_work multiple times on same work handle
...
* Fixed Bun.S3 HTTP-only S3\_ENDPOINT loading from environment variables
...
* Fixed child\_process.spawnSync RangeError with process.stderr/stdout in stdio option
...
* Fixed N-API napi\_strict\_equals using Object.is instead of === operator
* Fixed N-API napi\_call\_function crash when recv argument is null pointer
* Fixed napi\_create\_array\_with\_length handling of negative/oversized lengths
* Fixed child\_process stdin/stdout/stderr/stdio properties not enumerable
...
* Fixed N-API assertion failure when napi\_reference\_unref called during garbage collection
* Fixed new Buffer.isAscii() using wrong implementation (was using isUtf8)
* Fixed async\_hooks noisy warning when using React/Next.js
...
* Fixed assertion failure with BUN\_INSPECT\_CONNECT\_TO and .env file loading
...
* BUN\_CONFIG\_VERBOSE\_FETCH=curl now prints request body for application/x-www-form-urlencoded
* Crash with large number of command-line arguments when accessing process.argv fixed
* Fixed NODE\_NO\_WARNINGS environment variable to be respected
...
* Custom matchers from jest-dom now work (this.utils.RECEIVED\_COLOR, this.utils.EXPECTED\_COLOR)
...
* SQL client must be called as tagged template literal (throws ERR\_POSTGRES\_NOT\_TAGGED\_CALL if called as function)
...
* Fixed DATABASE\_URL options precedence in Bun.SQL connection string parsing
...
* Fixed ERR\_SSL\_NO\_CIPHER\_MATCH with unsupported/invalid cipher suites in TLS
* Fixed Bun.serve() incorrectly rejecting tls array with single configuration object
* Fixed certificate verification error spelling: UNKKNOW\_CERTIFICATE\_VERIFICATION\_ERROR → UNKNOWN\_CERTIFICATE\_VERIFICATION\_ERROR
...
* Fixed ERR\_HTTP\_SOCKET\_ASSIGNED in Next.js
...
* Fixed ERR\_STREAM\_ALREADY\_FINISHED error when cancelling HTTP requests (e.g., page refresh in next dev)
...
* Fixed bun run --filter ignoring NO\_COLOR on Windows
...
* install.sh now prioritizes ~/.bash\_profile over ~/.bashrc for PATH updates
...
## [Breaking changes](https://bun.com/blog/bun-v1.3#breaking-changes)
