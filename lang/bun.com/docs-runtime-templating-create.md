---
url: https://bun.com/docs/runtime/templating/create
...
If you’re looking to create a brand new empty project, use [`bun init`](https://bun.com/docs/runtime/templating/init).

## [​](https://bun.com/docs/runtime/templating/create#from-a-react-component) From a React component
...
[](https://mintcdn.com/bun-1dd33a4e/q61zoUYDXrVRu-tH/images/bun-create-shadcn.mp4?fit=max&auto=format&n=q61zoUYDXrVRu-tH&q=85&s=92fcea5a9d403b155e943508fbb40a21)
...
#### [​](https://bun.com/docs/runtime/templating/create#how-this-works) How this works
...
### [​](https://bun.com/docs/runtime/templating/create#using-tailwindcss-with-bun) Using TailwindCSS with Bun
...
### [​](https://bun.com/docs/runtime/templating/create#using-shadcn/ui-with-bun) Using `shadcn/ui` with Bun
...
## [​](https://bun.com/docs/runtime/templating/create#from-npm) From `npm`
...
Assuming you don’t have a [local template](https://bun.com/docs/runtime/templating/create#from-a-local-template) with the same name, this command will download and execute the `create-<template>` package from npm. The following two commands will behave identically:
...
## [​](https://bun.com/docs/runtime/templating/create#from-github) From GitHub
...
## [​](https://bun.com/docs/runtime/templating/create#from-a-local-template) From a local template
...
#### [​](https://bun.com/docs/runtime/templating/create#setup-logic) Setup logic
...
## [​](https://bun.com/docs/runtime/templating/create#reference) Reference

### [​](https://bun.com/docs/runtime/templating/create#cli-flags) CLI flags
...
### [​](https://bun.com/docs/runtime/templating/create#environment-variables) Environment variables
