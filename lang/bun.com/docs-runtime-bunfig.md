---
url: https://bun.com/docs/runtime/bunfig
...
## [​](https://bun.com/docs/runtime/bunfig#global-vs-local) Global vs. local
...
## [​](https://bun.com/docs/runtime/bunfig#runtime) Runtime

Bun’s runtime behavior is configured using top-level fields in the `bunfig.toml` file.

### [​](https://bun.com/docs/runtime/bunfig#preload) `preload`
...
### [​](https://bun.com/docs/runtime/bunfig#jsx) `jsx`
...
### [​](https://bun.com/docs/runtime/bunfig#smol) `smol`
...
### [​](https://bun.com/docs/runtime/bunfig#loglevel) `logLevel`
...
### [​](https://bun.com/docs/runtime/bunfig#define) `define`
...
### [​](https://bun.com/docs/runtime/bunfig#loader) `loader`
...
### [​](https://bun.com/docs/runtime/bunfig#telemetry) `telemetry`
...
### [​](https://bun.com/docs/runtime/bunfig#console) `console`

Configure console output behavior.

#### [​](https://bun.com/docs/runtime/bunfig#console-depth) `console.depth`
...
## [​](https://bun.com/docs/runtime/bunfig#test-runner) Test runner
...
### [​](https://bun.com/docs/runtime/bunfig#test-root) `test.root`
...
### [​](https://bun.com/docs/runtime/bunfig#test-preload) `test.preload`
...
### [​](https://bun.com/docs/runtime/bunfig#test-smol) `test.smol`
...
### [​](https://bun.com/docs/runtime/bunfig#test-coverage) `test.coverage`
...
### [​](https://bun.com/docs/runtime/bunfig#test-coveragethreshold) `test.coverageThreshold`
...
### [​](https://bun.com/docs/runtime/bunfig#test-coverageskiptestfiles) `test.coverageSkipTestFiles`
...
### [​](https://bun.com/docs/runtime/bunfig#test-coveragepathignorepatterns) `test.coveragePathIgnorePatterns`
...
### [​](https://bun.com/docs/runtime/bunfig#test-coveragereporter) `test.coverageReporter`
...
### [​](https://bun.com/docs/runtime/bunfig#test-coveragedir) `test.coverageDir`
...
### [​](https://bun.com/docs/runtime/bunfig#test-randomize) `test.randomize`
...
### [​](https://bun.com/docs/runtime/bunfig#test-seed) `test.seed`
...
### [​](https://bun.com/docs/runtime/bunfig#test-reruneach) `test.rerunEach`
...
### [​](https://bun.com/docs/runtime/bunfig#test-concurrenttestglob) `test.concurrentTestGlob`
...
### [​](https://bun.com/docs/runtime/bunfig#test-onlyfailures) `test.onlyFailures`
...
### [​](https://bun.com/docs/runtime/bunfig#test-reporter) `test.reporter`

Configure the test reporter settings.

#### [​](https://bun.com/docs/runtime/bunfig#test-reporter-dots) `test.reporter.dots`
...
#### [​](https://bun.com/docs/runtime/bunfig#test-reporter-junit) `test.reporter.junit`
...
## [​](https://bun.com/docs/runtime/bunfig#package-manager) Package manager
...
### [​](https://bun.com/docs/runtime/bunfig#install-optional) `install.optional`
...
### [​](https://bun.com/docs/runtime/bunfig#install-dev) `install.dev`
...
### [​](https://bun.com/docs/runtime/bunfig#install-peer) `install.peer`
...
### [​](https://bun.com/docs/runtime/bunfig#install-production) `install.production`
...
### [​](https://bun.com/docs/runtime/bunfig#install-exact) `install.exact`
...
### [​](https://bun.com/docs/runtime/bunfig#install-savetextlockfile) `install.saveTextLockfile`
...
### [​](https://bun.com/docs/runtime/bunfig#install-auto) `install.auto`
...
### [​](https://bun.com/docs/runtime/bunfig#install-frozenlockfile) `install.frozenLockfile`
...
### [​](https://bun.com/docs/runtime/bunfig#install-dryrun) `install.dryRun`
...
### [​](https://bun.com/docs/runtime/bunfig#install-globaldir) `install.globalDir`
...
### [​](https://bun.com/docs/runtime/bunfig#install-globalbindir) `install.globalBinDir`
...
### [​](https://bun.com/docs/runtime/bunfig#install-registry) `install.registry`
...
### [​](https://bun.com/docs/runtime/bunfig#install-linkworkspacepackages) `install.linkWorkspacePackages`
...
### [​](https://bun.com/docs/runtime/bunfig#install-scopes) `install.scopes`
...
### [​](https://bun.com/docs/runtime/bunfig#install-ca-and-install-cafile) `install.ca` and `install.cafile`
...
### [​](https://bun.com/docs/runtime/bunfig#install-cache) `install.cache`
...
### [​](https://bun.com/docs/runtime/bunfig#install-lockfile) `install.lockfile`
...
### [​](https://bun.com/docs/runtime/bunfig#install-linker) `install.linker`
...
For complete documentation refer to [Package manager > Isolated installs](https://bun.com/docs/pm/isolated-installs).
...
### [​](https://bun.com/docs/runtime/bunfig#install-security-scanner) `install.security.scanner`
...
### [​](https://bun.com/docs/runtime/bunfig#install-minimumreleaseage) `install.minimumReleaseAge`
...
## [​](https://bun.com/docs/runtime/bunfig#bun-run) `bun run`
...
### [​](https://bun.com/docs/runtime/bunfig#run-shell-use-the-system-shell-or-bun’s-shell) `run.shell` - use the system shell or Bun’s shell
...
### [​](https://bun.com/docs/runtime/bunfig#run-bun-auto-alias-node-to-bun) `run.bun` - auto alias `node` to `bun`
...
### [​](https://bun.com/docs/runtime/bunfig#run-silent-suppress-reporting-the-command-being-run) `run.silent` - suppress reporting the command being run
...
[Suggest edits](https://github.com/oven-sh/bun/edit/main/docs/runtime/bunfig.mdx)[Raise issue](https://github.com/oven-sh/bun/issues/new?title=Issue on docs&body=Path: /runtime/bunfig)
