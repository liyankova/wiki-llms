---
url: https://bun.com/docs/test/mocks
title: Mocks - Bun
...
## [​](https://bun.com/docs/test/mocks#basic-function-mocks) Basic Function Mocks
...
### [​](https://bun.com/docs/test/mocks#jest-compatibility) Jest Compatibility
...
## [​](https://bun.com/docs/test/mocks#mock-function-properties) Mock Function Properties
...
### [​](https://bun.com/docs/test/mocks#available-properties-and-methods) Available Properties and Methods
...
### [​](https://bun.com/docs/test/mocks#practical-examples) Practical Examples

#### [​](https://bun.com/docs/test/mocks#basic-mock-usage) Basic Mock Usage
...
#### [​](https://bun.com/docs/test/mocks#dynamic-mock-implementations) Dynamic Mock Implementations
...
#### [​](https://bun.com/docs/test/mocks#async-mocks) Async Mocks
...
## [​](https://bun.com/docs/test/mocks#spies-with-spyon) Spies with spyOn()
...
### [​](https://bun.com/docs/test/mocks#advanced-spy-usage) Advanced Spy Usage
...
## [​](https://bun.com/docs/test/mocks#module-mocks-with-mock-module) Module Mocks with mock.module()
...
### [​](https://bun.com/docs/test/mocks#overriding-already-imported-modules) Overriding Already Imported Modules
...
### [​](https://bun.com/docs/test/mocks#hoisting-&-preloading) Hoisting & Preloading
...
![https://mintcdn.com/bun-1dd33a4e/Hq64iapoQXHbYMEN/icons/typescript.svg?fit=max&auto=format&n=Hq64iapoQXHbYMEN&q=85&s=c6cceedec8f82d2cc803d7c6ec82b240](https://mintcdn.com/bun-1dd33a4e/Hq64iapoQXHbYMEN/icons/typescript.svg?fit=max&auto=format&n=Hq64iapoQXHbYMEN&q=85&s=c6cceedec8f82d2cc803d7c6ec82b240)my-preload.ts
...
### [​](https://bun.com/docs/test/mocks#module-mock-best-practices) Module Mock Best Practices

#### [​](https://bun.com/docs/test/mocks#when-to-use-preload) When to Use Preload
...
#### [​](https://bun.com/docs/test/mocks#practical-module-mock-examples) Practical Module Mock Examples

![https://mintcdn.com/bun-1dd33a4e/Hq64iapoQXHbYMEN/icons/typescript.svg?fit=max&auto=format&n=Hq64iapoQXHbYMEN&q=85&s=c6cceedec8f82d2cc803d7c6ec82b240](https://mintcdn.com/bun-1dd33a4e/Hq64iapoQXHbYMEN/icons/typescript.svg?fit=max&auto=format&n=Hq64iapoQXHbYMEN&q=85&s=c6cceedec8f82d2cc803d7c6ec82b240)api-client.test.ts
...
#### [​](https://bun.com/docs/test/mocks#mocking-external-dependencies) Mocking External Dependencies

![https://mintcdn.com/bun-1dd33a4e/Hq64iapoQXHbYMEN/icons/typescript.svg?fit=max&auto=format&n=Hq64iapoQXHbYMEN&q=85&s=c6cceedec8f82d2cc803d7c6ec82b240](https://mintcdn.com/bun-1dd33a4e/Hq64iapoQXHbYMEN/icons/typescript.svg?fit=max&auto=format&n=Hq64iapoQXHbYMEN&q=85&s=c6cceedec8f82d2cc803d7c6ec82b240)database.test.ts
...
## [​](https://bun.com/docs/test/mocks#global-mock-functions) Global Mock Functions

### [​](https://bun.com/docs/test/mocks#clear-all-mocks) Clear All Mocks
...
### [​](https://bun.com/docs/test/mocks#restore-all-mocks) Restore All Mocks
...
## [​](https://bun.com/docs/test/mocks#vitest-compatibility) Vitest Compatibility
...
## [​](https://bun.com/docs/test/mocks#implementation-details) Implementation Details

Understanding how `mock.module()` works helps you use it more effectively:

### [​](https://bun.com/docs/test/mocks#cache-interaction) Cache Interaction

Module mocks interact with both ESM and CommonJS module caches.

### [​](https://bun.com/docs/test/mocks#lazy-evaluation) Lazy Evaluation

The mock factory callback is only evaluated when the module is actually imported or required.

### [​](https://bun.com/docs/test/mocks#path-resolution) Path Resolution
...
### [​](https://bun.com/docs/test/mocks#import-timing-effects) Import Timing Effects
...
### [​](https://bun.com/docs/test/mocks#live-bindings) Live Bindings

Mocked ESM modules maintain live bindings, so changing the mock will update all existing imports.

## [​](https://bun.com/docs/test/mocks#advanced-patterns) Advanced Patterns

### [​](https://bun.com/docs/test/mocks#factory-functions) Factory Functions
...
### [​](https://bun.com/docs/test/mocks#conditional-mocking) Conditional Mocking
...
### [​](https://bun.com/docs/test/mocks#mock-cleanup-patterns) Mock Cleanup Patterns
...
## [​](https://bun.com/docs/test/mocks#best-practices) Best Practices

### [​](https://bun.com/docs/test/mocks#keep-mocks-simple) Keep Mocks Simple
...
### [​](https://bun.com/docs/test/mocks#use-type-safe-mocks) Use Type-Safe Mocks
...
### [​](https://bun.com/docs/test/mocks#test-mock-behavior) Test Mock Behavior
...
## [​](https://bun.com/docs/test/mocks#notes) Notes

### [​](https://bun.com/docs/test/mocks#auto-mocking) Auto-mocking
...
### [​](https://bun.com/docs/test/mocks#esm-vs-commonjs) ESM vs CommonJS
...
[Suggest edits](https://github.com/oven-sh/bun/edit/main/docs/test/mocks.mdx)[Raise issue](https://github.com/oven-sh/bun/issues/new?title=Issue on docs&body=Path: /test/mocks)
