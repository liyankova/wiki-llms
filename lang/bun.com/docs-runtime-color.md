...
### [​](https://bun.com/docs/runtime/color#flexible-input) Flexible input
...
### [​](https://bun.com/docs/runtime/color#format-colors-as-css) Format colors as CSS
...
### [​](https://bun.com/docs/runtime/color#format-colors-as-ansi-for-terminals) Format colors as ANSI (for terminals)
...
#### [​](https://bun.com/docs/runtime/color#24-bit-ansi-colors-ansi-16m) 24-bit ANSI colors (`ansi-16m`)
...
#### [​](https://bun.com/docs/runtime/color#256-ansi-colors-ansi-256) 256 ANSI colors (`ansi-256`)
...
#### [​](https://bun.com/docs/runtime/color#16-ansi-colors-ansi-16) 16 ANSI colors (`ansi-16`)
...
### [​](https://bun.com/docs/runtime/color#format-colors-as-numbers) Format colors as numbers
...
### [​](https://bun.com/docs/runtime/color#get-the-red,-green,-blue,-and-alpha-channels) Get the red, green, blue, and alpha channels

You can use the `"{rgba}"`, `"{rgb}"`, `"[rgba]"` and `"[rgb]"` formats to get the red, green, blue, and alpha channels as objects or arrays.

#### [​](https://bun.com/docs/runtime/color#{rgba}-object) `{rgba}` object
...
#### [​](https://bun.com/docs/runtime/color#[rgba]-array) `[rgba]` array
...
### [​](https://bun.com/docs/runtime/color#format-colors-as-hex-strings) Format colors as hex strings
...
### [​](https://bun.com/docs/runtime/color#bundle-time-client-side-color-formatting) Bundle-time client-side color formatting
...
[Suggest edits](https://github.com/oven-sh/bun/edit/main/docs/runtime/color.mdx)[Raise issue](https://github.com/oven-sh/bun/issues/new?title=Issue on docs&body=Path: /runtime/color)
