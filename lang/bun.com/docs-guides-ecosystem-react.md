---
url: https://bun.com/docs/guides/ecosystem/react
title: Build a React app with Bun - Bun
source_domain: bun.com
---

# Build a React app with Bun - Bun
...
### [​](https://bun.com/docs/guides/ecosystem/react#hot-reloading) Hot Reloading

Run `bun dev` to start the app in development mode. This will start the API server and the React app with hot reloading.

### [​](https://bun.com/docs/guides/ecosystem/react#full-stack-app) Full-Stack App

Run `bun start` to start the API server and frontend together in one process.

### [​](https://bun.com/docs/guides/ecosystem/react#static-site) Static Site
...
[Suggest edits](https://github.com/oven-sh/bun/edit/main/docs/guides/ecosystem/react.mdx)[Raise issue](https://github.com/oven-sh/bun/issues/new?title=Issue on docs&body=Path: /guides/ecosystem/react)
