---
url: https://bun.com/docs/runtime/hashing
title: Hashing - Bun
...
## [​](https://bun.com/docs/runtime/hashing#bun-password) `Bun.password`
...
### [​](https://bun.com/docs/runtime/hashing#salt) Salt

When you use `Bun.password.hash`, a salt is automatically generated and included in the hash.

### [​](https://bun.com/docs/runtime/hashing#bcrypt-modular-crypt-format) bcrypt - Modular Crypt Format
...
### [​](https://bun.com/docs/runtime/hashing#argon2-phc-format) argon2 - PHC format
...
## [​](https://bun.com/docs/runtime/hashing#bun-hash) `Bun.hash`
...
## [​](https://bun.com/docs/runtime/hashing#bun-cryptohasher) `Bun.CryptoHasher`
...
### [​](https://bun.com/docs/runtime/hashing#hmac-in-bun-cryptohasher) HMAC in `Bun.CryptoHasher`
...
[Suggest edits](https://github.com/oven-sh/bun/edit/main/docs/runtime/hashing.mdx)[Raise issue](https://github.com/oven-sh/bun/issues/new?title=Issue on docs&body=Path: /runtime/hashing)
