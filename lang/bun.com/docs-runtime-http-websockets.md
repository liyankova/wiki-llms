---
url: https://bun.com/docs/runtime/http/websockets
...
## [​](https://bun.com/docs/runtime/http/websockets#start-a-websocket-server) Start a WebSocket server
...
### [​](https://bun.com/docs/runtime/http/websockets#sending-messages) Sending messages
...
### [​](https://bun.com/docs/runtime/http/websockets#headers) Headers
...
### [​](https://bun.com/docs/runtime/http/websockets#contextual-data) Contextual data
...
### [​](https://bun.com/docs/runtime/http/websockets#pub/sub) Pub/Sub
...
### [​](https://bun.com/docs/runtime/http/websockets#compression) Compression
...
For fine-grained control over compression characteristics, refer to the [Reference](https://bun.com/docs/runtime/http/websockets#reference).

### [​](https://bun.com/docs/runtime/http/websockets#backpressure) Backpressure
...
### [​](https://bun.com/docs/runtime/http/websockets#timeouts-and-limits) Timeouts and limits
...
## [​](https://bun.com/docs/runtime/http/websockets#connect-to-a-websocket-server) Connect to a `Websocket` server
...
## [​](https://bun.com/docs/runtime/http/websockets#reference) Reference
...
[Suggest edits](https://github.com/oven-sh/bun/edit/main/docs/runtime/http/websockets.mdx)[Raise issue](https://github.com/oven-sh/bun/issues/new?title=Issue on docs&body=Path: /runtime/http/websockets)
