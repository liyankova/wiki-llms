---
url: https://bun.com/docs/runtime/http/routing
title: Routing - Bun
...
You can add routes to `Bun.serve()` by using the `routes` property (for static paths, parameters, and wildcards) or by handling unmatched requests with the [`fetch`](https://bun.com/docs/runtime/http/routing#fetch) method.
...
## [​](https://bun.com/docs/runtime/http/routing#basic-setup) Basic Setup
...
## [​](https://bun.com/docs/runtime/http/routing#asynchronous-routes) Asynchronous Routes

### [​](https://bun.com/docs/runtime/http/routing#async/await) Async/await
...
### [​](https://bun.com/docs/runtime/http/routing#promise) Promise
...
## [​](https://bun.com/docs/runtime/http/routing#route-precedence) Route precedence
...
## [​](https://bun.com/docs/runtime/http/routing#type-safe-route-parameters) Type-safe route parameters
...
### [​](https://bun.com/docs/runtime/http/routing#static-responses) Static responses
...
### [​](https://bun.com/docs/runtime/http/routing#file-responses-vs-static-responses) File Responses vs Static Responses
...
## [​](https://bun.com/docs/runtime/http/routing#streaming-files) Streaming files
...
## [​](https://bun.com/docs/runtime/http/routing#fetch-request-handler) `fetch` request handler
...
[Suggest edits](https://github.com/oven-sh/bun/edit/main/docs/runtime/http/routing.mdx)[Raise issue](https://github.com/oven-sh/bun/issues/new?title=Issue on docs&body=Path: /runtime/http/routing)
