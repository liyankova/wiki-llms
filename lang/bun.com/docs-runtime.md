...
## [​](https://bun.com/docs/runtime#run-a-file) Run a file
...
### [​](https://bun.com/docs/runtime#watch) `--watch`
...
## [​](https://bun.com/docs/runtime#run-a-package-json-script) Run a `package.json` script
...
### [​](https://bun.com/docs/runtime#bun) `--bun`
...
### [​](https://bun.com/docs/runtime#filtering) Filtering
...
## [​](https://bun.com/docs/runtime#bun-run-to-pipe-code-from-stdin) `bun run -` to pipe code from stdin
...
## [​](https://bun.com/docs/runtime#bun-run-console-depth) `bun run --console-depth`
...
## [​](https://bun.com/docs/runtime#bun-run-smol) `bun run --smol`
...
## [​](https://bun.com/docs/runtime#resolution-order) Resolution order
...
# [​](https://bun.com/docs/runtime#cli-usage) CLI Usage
...
### [​](https://bun.com/docs/runtime#general-execution-options) General Execution Options

[​](https://bun.com/docs/runtime#param-silent)
...
[​](https://bun.com/docs/runtime#param-if-present)
...
[​](https://bun.com/docs/runtime#param-eval)
...
[​](https://bun.com/docs/runtime#param-print)
...
[​](https://bun.com/docs/runtime#param-help)
...
### [​](https://bun.com/docs/runtime#workspace-management) Workspace Management

[​](https://bun.com/docs/runtime#param-elide-lines)
...
[​](https://bun.com/docs/runtime#param-filter)
...
[​](https://bun.com/docs/runtime#param-workspaces)
...
### [​](https://bun.com/docs/runtime#runtime-&-process-control) Runtime & Process Control

[​](https://bun.com/docs/runtime#param-bun)
...
[​](https://bun.com/docs/runtime#param-shell)
...
[​](https://bun.com/docs/runtime#param-smol)
...
[​](https://bun.com/docs/runtime#param-expose-gc)
...
[​](https://bun.com/docs/runtime#param-no-deprecation)
...
[​](https://bun.com/docs/runtime#param-throw-deprecation)
...
[​](https://bun.com/docs/runtime#param-title)
...
[​](https://bun.com/docs/runtime#param-zero-fill-buffers)
...
[​](https://bun.com/docs/runtime#param-no-addons)
...
[​](https://bun.com/docs/runtime#param-unhandled-rejections)
...
[​](https://bun.com/docs/runtime#param-console-depth)
...
### [​](https://bun.com/docs/runtime#development-workflow) Development Workflow

[​](https://bun.com/docs/runtime#param-watch)
...
[​](https://bun.com/docs/runtime#param-hot)
...
[​](https://bun.com/docs/runtime#param-no-clear-screen)
...
### [​](https://bun.com/docs/runtime#debugging) Debugging

[​](https://bun.com/docs/runtime#param-inspect)
...
[​](https://bun.com/docs/runtime#param-inspect-wait)
...
[​](https://bun.com/docs/runtime#param-inspect-brk)
...
### [​](https://bun.com/docs/runtime#dependency-&-module-resolution) Dependency & Module Resolution

[​](https://bun.com/docs/runtime#param-preload)
...
[​](https://bun.com/docs/runtime#param-require)
...
[​](https://bun.com/docs/runtime#param-import)
...
[​](https://bun.com/docs/runtime#param-no-install)
...
[​](https://bun.com/docs/runtime#param-install)
...
[​](https://bun.com/docs/runtime#param-i)
...
[​](https://bun.com/docs/runtime#param-prefer-offline)
...
[​](https://bun.com/docs/runtime#param-prefer-latest)
...
[​](https://bun.com/docs/runtime#param-conditions)
...
[​](https://bun.com/docs/runtime#param-main-fields)
...
[​](https://bun.com/docs/runtime#param-preserve-symlinks)
...
[​](https://bun.com/docs/runtime#param-preserve-symlinks-main)
...
[​](https://bun.com/docs/runtime#param-extension-order)
...
### [​](https://bun.com/docs/runtime#transpilation-&-language-features) Transpilation & Language Features

[​](https://bun.com/docs/runtime#param-tsconfig-override)
...
[​](https://bun.com/docs/runtime#param-define)
...
[​](https://bun.com/docs/runtime#param-drop)
...
[​](https://bun.com/docs/runtime#param-loader)
...
[​](https://bun.com/docs/runtime#param-no-macros)
...
[​](https://bun.com/docs/runtime#param-jsx-factory)
...
[​](https://bun.com/docs/runtime#param-jsx-fragment)
...
[​](https://bun.com/docs/runtime#param-jsx-import-source)
...
[​](https://bun.com/docs/runtime#param-jsx-runtime)
...
[​](https://bun.com/docs/runtime#param-jsx-side-effects)
...
[​](https://bun.com/docs/runtime#param-ignore-dce-annotations)
...
### [​](https://bun.com/docs/runtime#networking-&-security) Networking & Security

[​](https://bun.com/docs/runtime#param-port)
...
[​](https://bun.com/docs/runtime#param-fetch-preconnect)
...
[​](https://bun.com/docs/runtime#param-max-http-header-size)
...
[​](https://bun.com/docs/runtime#param-dns-result-order)
...
[​](https://bun.com/docs/runtime#param-use-system-ca)
...
[​](https://bun.com/docs/runtime#param-use-openssl-ca)
...
[​](https://bun.com/docs/runtime#param-use-bundled-ca)
...
[​](https://bun.com/docs/runtime#param-redis-preconnect)
...
[​](https://bun.com/docs/runtime#param-sql-preconnect)
...
[​](https://bun.com/docs/runtime#param-user-agent)
...
### [​](https://bun.com/docs/runtime#global-configuration-&-context) Global Configuration & Context

[​](https://bun.com/docs/runtime#param-env-file)
...
[​](https://bun.com/docs/runtime#param-cwd)
...
## [​](https://bun.com/docs/runtime#examples) Examples
