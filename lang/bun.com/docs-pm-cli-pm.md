---
url: https://bun.com/docs/pm/cli/pm
title: bun pm - Bun
...
## [​](https://bun.com/docs/pm/cli/pm#pack) pack
...
## [​](https://bun.com/docs/pm/cli/pm#examples) Examples
...
## [​](https://bun.com/docs/pm/cli/pm#options) Options
...
## [​](https://bun.com/docs/pm/cli/pm#output-modes) Output Modes
...
## [​](https://bun.com/docs/pm/cli/pm#bin) bin
...
## [​](https://bun.com/docs/pm/cli/pm#ls) ls
...
## [​](https://bun.com/docs/pm/cli/pm#whoami) whoami
...
## [​](https://bun.com/docs/pm/cli/pm#hash) hash
...
## [​](https://bun.com/docs/pm/cli/pm#cache) cache
...
## [​](https://bun.com/docs/pm/cli/pm#migrate) migrate
...
## [​](https://bun.com/docs/pm/cli/pm#untrusted) untrusted
...
## [​](https://bun.com/docs/pm/cli/pm#trust) trust
...
## [​](https://bun.com/docs/pm/cli/pm#default-trusted) default-trusted
...
## [​](https://bun.com/docs/pm/cli/pm#version) version
...
## [​](https://bun.com/docs/pm/cli/pm#pkg) pkg
...
[Suggest edits](https://github.com/oven-sh/bun/edit/main/docs/pm/cli/pm.mdx)[Raise issue](https://github.com/oven-sh/bun/issues/new?title=Issue on docs&body=Path: /pm/cli/pm)
