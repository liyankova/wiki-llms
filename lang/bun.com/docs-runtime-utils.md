...
## [​](https://bun.com/docs/runtime/utils#bun-version) `Bun.version`
...
## [​](https://bun.com/docs/runtime/utils#bun-revision) `Bun.revision`
...
## [​](https://bun.com/docs/runtime/utils#bun-env) `Bun.env`

An alias for `process.env`.

## [​](https://bun.com/docs/runtime/utils#bun-main) `Bun.main`
...
## [​](https://bun.com/docs/runtime/utils#bun-sleep) `Bun.sleep()`
...
## [​](https://bun.com/docs/runtime/utils#bun-sleepsync) `Bun.sleepSync()`
...
## [​](https://bun.com/docs/runtime/utils#bun-which) `Bun.which()`
...
## [​](https://bun.com/docs/runtime/utils#bun-randomuuidv7) `Bun.randomUUIDv7()`
...
## [​](https://bun.com/docs/runtime/utils#bun-peek) `Bun.peek()`
...
## [​](https://bun.com/docs/runtime/utils#bun-openineditor) `Bun.openInEditor()`
...
## [​](https://bun.com/docs/runtime/utils#bun-deepequals) `Bun.deepEquals()`
...
## [​](https://bun.com/docs/runtime/utils#bun-escapehtml) `Bun.escapeHTML()`
...
## [​](https://bun.com/docs/runtime/utils#bun-stringwidth) `Bun.stringWidth()`
...
## [​](https://bun.com/docs/runtime/utils#bun-fileurltopath) `Bun.fileURLToPath()`
...
## [​](https://bun.com/docs/runtime/utils#bun-pathtofileurl) `Bun.pathToFileURL()`
...
## [​](https://bun.com/docs/runtime/utils#bun-gzipsync) `Bun.gzipSync()`
...
## [​](https://bun.com/docs/runtime/utils#bun-gunzipsync) `Bun.gunzipSync()`
...
## [​](https://bun.com/docs/runtime/utils#bun-deflatesync) `Bun.deflateSync()`
...
The second argument supports the same set of configuration options as [`Bun.gzipSync`](https://bun.com/docs/runtime/utils#bun-gzipsync).

---

## [​](https://bun.com/docs/runtime/utils#bun-inflatesync) `Bun.inflateSync()`
...
## [​](https://bun.com/docs/runtime/utils#bun-zstdcompress-/-bun-zstdcompresssync) `Bun.zstdCompress()` / `Bun.zstdCompressSync()`
...
## [​](https://bun.com/docs/runtime/utils#bun-zstddecompress-/-bun-zstddecompresssync) `Bun.zstdDecompress()` / `Bun.zstdDecompressSync()`
...
## [​](https://bun.com/docs/runtime/utils#bun-inspect) `Bun.inspect()`
...
### [​](https://bun.com/docs/runtime/utils#bun-inspect-custom) `Bun.inspect.custom`
...
### [​](https://bun.com/docs/runtime/utils#bun-inspect-table-tabulardata,-properties,-options) `Bun.inspect.table(tabularData, properties, options)`
...
## [​](https://bun.com/docs/runtime/utils#bun-nanoseconds) `Bun.nanoseconds()`
...
## [​](https://bun.com/docs/runtime/utils#bun-readablestreamto) `Bun.readableStreamTo*()`
...
## [​](https://bun.com/docs/runtime/utils#bun-resolvesync) `Bun.resolveSync()`
...
## [​](https://bun.com/docs/runtime/utils#bun-stripansi) `Bun.stripANSI()`
...
## [​](https://bun.com/docs/runtime/utils#serialize-&-deserialize-in-bun:jsc) `serialize` & `deserialize` in `bun:jsc`
...
## [​](https://bun.com/docs/runtime/utils#estimateshallowmemoryusageof-in-bun:jsc) `estimateShallowMemoryUsageOf` in `bun:jsc`
...
[Suggest edits](https://github.com/oven-sh/bun/edit/main/docs/runtime/utils.mdx)[Raise issue](https://github.com/oven-sh/bun/issues/new?title=Issue on docs&body=Path: /runtime/utils)
