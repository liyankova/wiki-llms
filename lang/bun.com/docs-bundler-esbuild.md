...
## [​](https://bun.com/docs/bundler/esbuild#performance) Performance
...
## [​](https://bun.com/docs/bundler/esbuild#cli-api) CLI API
...
## [​](https://bun.com/docs/bundler/esbuild#javascript-api) JavaScript API
...
## [​](https://bun.com/docs/bundler/esbuild#plugin-api) Plugin API
...
### [​](https://bun.com/docs/bundler/esbuild#onresolve) onResolve
...
### [​](https://bun.com/docs/bundler/esbuild#onload) onLoad
...
[Suggest edits](https://github.com/oven-sh/bun/edit/main/docs/bundler/esbuild.mdx)[Raise issue](https://github.com/oven-sh/bun/issues/new?title=Issue on docs&body=Path: /bundler/esbuild)
