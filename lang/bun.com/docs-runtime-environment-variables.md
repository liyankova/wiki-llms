---
url: https://bun.com/docs/runtime/environment-variables
...
## [​](https://bun.com/docs/runtime/environment-variables#setting-environment-variables) Setting environment variables
...
## [​](https://bun.com/docs/runtime/environment-variables#manually-specifying-env-files) Manually specifying `.env` files
...
## [​](https://bun.com/docs/runtime/environment-variables#disabling-automatic-env-loading) Disabling automatic `.env` loading
...
## [​](https://bun.com/docs/runtime/environment-variables#quotation-marks) Quotation marks
...
### [​](https://bun.com/docs/runtime/environment-variables#expansion) Expansion
...
### [​](https://bun.com/docs/runtime/environment-variables#dotenv) `dotenv`

Generally speaking, you won’t need `dotenv` or `dotenv-expand` anymore, because Bun reads `.env` files automatically.

## [​](https://bun.com/docs/runtime/environment-variables#reading-environment-variables) Reading environment variables
...
## [​](https://bun.com/docs/runtime/environment-variables#typescript) TypeScript
...
## [​](https://bun.com/docs/runtime/environment-variables#configuring-bun) Configuring Bun
...
## [​](https://bun.com/docs/runtime/environment-variables#runtime-transpiler-caching) Runtime transpiler caching
...
### [​](https://bun.com/docs/runtime/environment-variables#disable-the-runtime-transpiler-cache) Disable the runtime transpiler cache
...
### [​](https://bun.com/docs/runtime/environment-variables#what-does-it-cache) What does it cache?
