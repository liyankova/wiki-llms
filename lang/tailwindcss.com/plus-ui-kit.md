---
url: https://tailwindcss.com/plus/ui-kit?ref=footer
...
[Documentation](https://catalyst.tailwindui.com/docs)[Get UI kit](https://tailwindcss.com/plus/ui-kit?ref=footer#pricing)

![](https://tailwindcss.com/plus-assets/img/heroes/ui-kit-col-1.png)![](https://tailwindcss.com/plus-assets/img/heroes/ui-kit-col-1-dark.png)![](https://tailwindcss.com/plus-assets/img/heroes/ui-kit-col-2.png)![](https://tailwindcss.com/plus-assets/img/heroes/ui-kit-col-2-dark.png)![](https://tailwindcss.com/plus-assets/img/heroes/ui-kit-col-3.png)![](https://tailwindcss.com/plus-assets/img/heroes/ui-kit-col-3-dark.png)
...
![](https://tailwindcss.com/plus-assets/img/templates/catalyst/screenshot.png)![](https://tailwindcss.com/plus-assets/img/templates/catalyst/screenshot-dark.png)
...
* [![](https://tailwindcss.com/plus-assets/img/templates/catalyst/components/button.png)![](https://tailwindcss.com/plus-assets/img/templates/catalyst/components/button-dark.png)

  Button](https://catalyst.tailwindui.com/docs/button)
* [![](https://tailwindcss.com/plus-assets/img/templates/catalyst/components/input.png)![](https://tailwindcss.com/plus-assets/img/templates/catalyst/components/input-dark.png)

  Input](https://catalyst.tailwindui.com/docs/input)
* [![](https://tailwindcss.com/plus-assets/img/templates/catalyst/components/table.png)![](https://tailwindcss.com/plus-assets/img/templates/catalyst/components/table-dark.png)

  Table](https://catalyst.tailwindui.com/docs/table)
* [![](https://tailwindcss.com/plus-assets/img/templates/catalyst/components/sidebar.png)![](https://tailwindcss.com/plus-assets/img/templates/catalyst/components/sidebar-dark.png)

  Sidebar](https://catalyst.tailwindui.com/docs/sidebar)
* [![](https://tailwindcss.com/plus-assets/img/templates/catalyst/components/checkbox.png)![](https://tailwindcss.com/plus-assets/img/templates/catalyst/components/checkbox-dark.png)

  Checkbox](https://catalyst.tailwindui.com/docs/checkbox)
* [![](https://tailwindcss.com/plus-assets/img/templates/catalyst/components/combobox.png)![](https://tailwindcss.com/plus-assets/img/templates/catalyst/components/combobox-dark.png)

  Combobox](https://catalyst.tailwindui.com/docs/combobox)
* [![](https://tailwindcss.com/plus-assets/img/templates/catalyst/components/radio.png)![](https://tailwindcss.com/plus-assets/img/templates/catalyst/components/radio-dark.png)

  Radio groups](https://catalyst.tailwindui.com/docs/radio)
* [![](https://tailwindcss.com/plus-assets/img/templates/catalyst/components/switch.png)![](https://tailwindcss.com/plus-assets/img/templates/catalyst/components/switch-dark.png)

  Switch](https://catalyst.tailwindui.com/docs/switch)
* [![](https://tailwindcss.com/plus-assets/img/templates/catalyst/components/description-list.png)![](https://tailwindcss.com/plus-assets/img/templates/catalyst/components/description-list-dark.png)

  Description list](https://catalyst.tailwindui.com/docs/description-list)
* [![](https://tailwindcss.com/plus-assets/img/templates/catalyst/components/badge.png)![](https://tailwindcss.com/plus-assets/img/templates/catalyst/components/badge-dark.png)

  Badge](https://catalyst.tailwindui.com/docs/badge)
* [![](https://tailwindcss.com/plus-assets/img/templates/catalyst/components/listbox.png)![](https://tailwindcss.com/plus-assets/img/templates/catalyst/components/listbox-dark.png)

  Listbox](https://catalyst.tailwindui.com/docs/listbox)
* [![](https://tailwindcss.com/plus-assets/img/templates/catalyst/components/pagination.png)![](https://tailwindcss.com/plus-assets/img/templates/catalyst/components/pagination-dark.png)

  Pagination](https://catalyst.tailwindui.com/docs/pagination)
* [![](https://tailwindcss.com/plus-assets/img/templates/catalyst/components/dropdown.png)![](https://tailwindcss.com/plus-assets/img/templates/catalyst/components/dropdown-dark.png)

  Dropdown](https://catalyst.tailwindui.com/docs/dropdown)
* [![](https://tailwindcss.com/plus-assets/img/templates/catalyst/components/alert.png)![](https://tailwindcss.com/plus-assets/img/templates/catalyst/components/alert-dark.png)

  Alert](https://catalyst.tailwindui.com/docs/alert)
* [![](https://tailwindcss.com/plus-assets/img/templates/catalyst/components/navbar.png)![](https://tailwindcss.com/plus-assets/img/templates/catalyst/components/navbar-dark.png)

  Navbar](https://catalyst.tailwindui.com/docs/navbar)
* [![](https://tailwindcss.com/plus-assets/img/templates/catalyst/components/avatar.png)![](https://tailwindcss.com/plus-assets/img/templates/catalyst/components/avatar-dark.png)

  Avatar](https://catalyst.tailwindui.com/docs/avatar)
* [![](https://tailwindcss.com/plus-assets/img/templates/catalyst/components/divider.png)![](https://tailwindcss.com/plus-assets/img/templates/catalyst/components/divider-dark.png)

  Divider](https://catalyst.tailwindui.com/docs/divider)
* [![](https://tailwindcss.com/plus-assets/img/templates/catalyst/components/textarea.png)![](https://tailwindcss.com/plus-assets/img/templates/catalyst/components/textarea-dark.png)

  Textarea](https://catalyst.tailwindui.com/docs/textarea)
* [![](https://tailwindcss.com/plus-assets/img/templates/catalyst/components/heading.png)![](https://tailwindcss.com/plus-assets/img/templates/catalyst/components/heading-dark.png)

  Heading](https://catalyst.tailwindui.com/docs/heading)
* [![](https://tailwindcss.com/plus-assets/img/templates/catalyst/components/text.png)![](https://tailwindcss.com/plus-assets/img/templates/catalyst/components/text-dark.png)

  Text](https://catalyst.tailwindui.com/docs/text)
* [![](https://tailwindcss.com/plus-assets/img/templates/catalyst/components/fieldset.png)![](https://tailwindcss.com/plus-assets/img/templates/catalyst/components/fieldset-dark.png)

  Fieldset](https://catalyst.tailwindui.com/docs/fieldset)
* [![](https://tailwindcss.com/plus-assets/img/templates/catalyst/components/dialog.png)![](https://tailwindcss.com/plus-assets/img/templates/catalyst/components/dialog-dark.png)

  Dialog](https://catalyst.tailwindui.com/docs/dialog)
* [![](https://tailwindcss.com/plus-assets/img/templates/catalyst/components/sidebar-layout.png)![](https://tailwindcss.com/plus-assets/img/templates/catalyst/components/sidebar-layout-dark.png)

  Sidebar layout](https://catalyst.tailwindui.com/docs/sidebar-layout)
* [![](https://tailwindcss.com/plus-assets/img/templates/catalyst/components/stacked-layout.png)![](https://tailwindcss.com/plus-assets/img/templates/catalyst/components/stacked-layout-dark.png)

  Stacked layout](https://catalyst.tailwindui.com/docs/stacked-layout)
* [![](https://tailwindcss.com/plus-assets/img/templates/catalyst/components/auth-layout.png)![](https://tailwindcss.com/plus-assets/img/templates/catalyst/components/auth-layout-dark.png)

  Auth layout](https://catalyst.tailwindui.com/docs/auth-layout)
...
If you're unhappy with your purchase for any reason, email us at [support@tailwindcss.com](mailto:support@tailwindcss.com) within 30 days and we'll refund you in full, no questions asked.