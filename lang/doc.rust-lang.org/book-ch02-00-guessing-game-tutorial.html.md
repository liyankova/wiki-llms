...
you can see everything in it [in the standard library documentation](https://doc.rust-lang.org/std/prelude/index.html).
...
### [Storing Values with Variables](https://doc.rust-lang.org/book/ch02-00-guessing-game-tutorial.html#storing-values-with-variables)
...
the [“Variables and Mutability”](https://doc.rust-lang.org/book/ch03-01-variables-and-mutability.html#variables-and-mutability)
...
[`String`](https://doc.rust-lang.org/std/string/struct.String.html) is a string type provided by the standard
...
[`std::io::Stdin`](https://doc.rust-lang.org/std/io/struct.Stdin.html), which is a type that represents a
handle to the standard input for your terminal.

Next, the line `.read_line(&mut guess)` calls the [`read_line`](https://doc.rust-lang.org/std/io/struct.Stdin.html#method.read_line) method on the standard input handle to get input from the user.
...
### [Handling Potential Failure with `Result`](https://doc.rust-lang.org/book/ch02-00-guessing-game-tutorial.html#handling-potential-failure-with-result)
...
we pass to it, but it also returns a `Result` value. [`Result`](https://doc.rust-lang.org/std/result/enum.Result.html) is an [*enumeration*](https://doc.rust-lang.org/book/ch06-00-enums.html), often called an *enum*,
which is a type that can be in one of multiple possible states. We call each
possible state a *variant*.

[Chapter 6](https://doc.rust-lang.org/book/ch06-00-enums.html) will cover enums in more detail. The purpose
...
them. An instance of `Result` has an [`expect` method](https://doc.rust-lang.org/std/result/enum.Result.html#method.expect)
...
9](https://doc.rust-lang.org/book/ch09-02-recoverable-errors-with-result.html).
...
library. However, the Rust team does provide a [`rand` crate](https://crates.io/crates/rand) with
said functionality.
...
[Listing 2-2](https://doc.rust-lang.org/book/ch02-00-guessing-game-tutorial.html#listing-2-2): The output from running `cargo build` after adding the rand crate as a dependency
...
time you run `cargo build`, so we now have this in the *guessing\_game*
directory.
...
[Listing 2-3](https://doc.rust-lang.org/book/ch02-00-guessing-game-tutorial.html#listing-2-3): Adding code to generate a random number
...
[Listing 2-4](https://doc.rust-lang.org/book/ch02-00-guessing-game-tutorial.html#listing-2-4): Handling the possible return values of comparing two numbers
...
[`match`](https://doc.rust-lang.org/book/ch06-02-match.html) expression to decide what to do next based on
...
[Chapter 3](https://doc.rust-lang.org/book/ch03-01-variables-and-mutability.html#shadowing), but for now, know that this feature is
...
The [`parse` method on strings](https://doc.rust-lang.org/std/primitive.str.html#method.parse) converts a string to
...
other number types in [Chapter 3](https://doc.rust-lang.org/book/ch03-02-data-types.html#integer-types).
...
`Result`”](https://doc.rust-lang.org/book/ch02-00-guessing-game-tutorial.html#handling-potential-failure-with-result)). We’ll treat
...
Secret Number”](https://doc.rust-lang.org/book/ch02-00-guessing-game-tutorial.html#comparing-the-guess-to-the-secret-number): if
...
[Listing 2-5](https://doc.rust-lang.org/book/ch02-00-guessing-game-tutorial.html#listing-2-5): Ignoring a non-number guess and asking for another guess instead of crashing the program
...
[Listing 2-6](https://doc.rust-lang.org/book/ch02-00-guessing-game-tutorial.html#listing-2-6): Complete guessing game code
