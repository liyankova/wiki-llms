...
[Listing 5-8](https://doc.rust-lang.org/book/ch05-02-example-structs.html#listing-5-8): Calculating the area of a rectangle specified by separate width and height variables
...
[Listing 5-9](https://doc.rust-lang.org/book/ch05-02-example-structs.html#listing-5-9): Specifying the width and height of the rectangle with a tuple
...
[Listing 5-10](https://doc.rust-lang.org/book/ch05-02-example-structs.html#listing-5-10): Defining a `Rectangle` struct
...
[Listing 5-11](https://doc.rust-lang.org/book/ch05-02-example-structs.html#listing-5-11): Attempting to print a `Rectangle` instance
...
[Listing 5-12](https://doc.rust-lang.org/book/ch05-02-example-structs.html#listing-5-12): Adding the attribute to derive the `Debug` trait and printing the `Rectangle` instance using debug formatting
...
section in Chapter 12](https://doc.rust-lang.org/book/ch12-06-writing-to-stderr-instead-of-stdout.html).
