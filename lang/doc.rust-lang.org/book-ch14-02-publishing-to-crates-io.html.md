...
[Listing 14-1](https://doc.rust-lang.org/book/ch14-02-publishing-to-crates-io.html#listing-14-1): A documentation comment for a function
...
[Listing 14-2](https://doc.rust-lang.org/book/ch14-02-publishing-to-crates-io.html#listing-14-2): Documentation for the `my_crate` crate as a whole
...
[Listing 14-3](https://doc.rust-lang.org/book/ch14-02-publishing-to-crates-io.html#listing-14-3): An `art` library with items organized into `kinds` and `utils` modules
...
[Listing 14-4](https://doc.rust-lang.org/book/ch14-02-publishing-to-crates-io.html#listing-14-4): A crate using the `art` crate’s items with its internal structure exported
...
[Listing 14-5](https://doc.rust-lang.org/book/ch14-02-publishing-to-crates-io.html#listing-14-5): Adding `pub use` statements to re-export items
...
[Listing 14-6](https://doc.rust-lang.org/book/ch14-02-publishing-to-crates-io.html#listing-14-6): A program using the re-exported items from the `art` crate
...
The [Linux Foundation’s Software Package Data Exchange (SPDX)](https://spdx.org/licenses/) lists the
