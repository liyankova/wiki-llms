...
# [Profiles](https://doc.rust-lang.org/cargo/reference/profiles.html#profiles)
...
Profile settings can be changed in [`Cargo.toml`](https://doc.rust-lang.org/cargo/reference/manifest.html) with the
...
Additionally, profiles can be overridden from a [config](https://doc.rust-lang.org/cargo/reference/config.html) definition.
Specifying a profile in a config file or environment variable will override
the settings from `Cargo.toml`.

## [Profile settings](https://doc.rust-lang.org/cargo/reference/profiles.html#profile-settings)
...
You may wish to also configure the [`split-debuginfo`](https://doc.rust-lang.org/cargo/reference/profiles.html#split-debuginfo) option
...
The `split-debuginfo` setting controls the [`-C split-debuginfo` flag](https://doc.rust-lang.org/rustc/codegen-options/index.html#split-debuginfo) which
...
[compiler accepts](https://doc.rust-lang.org/rustc/codegen-options/index.html#split-debuginfo). The default value for this option
is `unpacked` on macOS for profiles that have debug information otherwise
enabled. Otherwise the default for this option is [documented with rustc](https://doc.rust-lang.org/rustc/codegen-options/index.html#split-debuginfo) and is platform-specific. Some options are only
available on the [nightly channel](https://doc.rust-lang.org/book/appendix-07-nightly-rust.html). The Cargo default may change in the future
...
The `strip` option controls the [`-C strip` flag](https://doc.rust-lang.org/rustc/codegen-options/index.html#strip), which directs rustc to
...
The `lto` setting controls `rustc`’s [`-C lto`](https://doc.rust-lang.org/rustc/codegen-options/index.html#lto), [`-C linker-plugin-lto`](https://doc.rust-lang.org/rustc/codegen-options/index.html#linker-plugin-lto), and
[`-C embed-bitcode`](https://doc.rust-lang.org/rustc/codegen-options/index.html#embed-bitcode) options, which control LLVM’s [link time optimizations](https://llvm.org/docs/LinkTimeOptimization.html).
...
* `"thin"`: Performs [“thin” LTO](http://blog.llvm.org/2016/06/thinlto-scalable-and-incremental-lto.html). This is similar to “fat”, but takes
...
See the [linker-plugin-lto chapter](https://doc.rust-lang.org/rustc/linker-plugin-lto.html) if you are interested in cross-language LTO.
...
default for build commands like [`cargo build`](https://doc.rust-lang.org/cargo/commands/cargo-build.html), and is used for `cargo install --debug`.
...
is the default for [`cargo install`](https://doc.rust-lang.org/cargo/commands/cargo-install.html).
...
### [test](https://doc.rust-lang.org/cargo/reference/profiles.html#test)

The `test` profile is the default profile used by [`cargo test`](https://doc.rust-lang.org/cargo/commands/cargo-test.html).
The `test` profile inherits the settings from the [`dev`](https://doc.rust-lang.org/cargo/reference/profiles.html#dev) profile.

### [bench](https://doc.rust-lang.org/cargo/reference/profiles.html#bench)

The `bench` profile is the default profile used by [`cargo bench`](https://doc.rust-lang.org/cargo/commands/cargo-bench.html).
The `bench` profile inherits the settings from the [`release`](https://doc.rust-lang.org/cargo/reference/profiles.html#release) profile.

### [Build Dependencies](https://doc.rust-lang.org/cargo/reference/profiles.html#build-dependencies)
...
described in [Profile selection](https://doc.rust-lang.org/cargo/reference/profiles.html#profile-selection).
...
release build with [LTO](https://doc.rust-lang.org/cargo/reference/profiles.html#lto) optimizations, you can specify something like
...
as the profile in the [`target` directory](https://doc.rust-lang.org/cargo/reference/build-cache.html). As in the example above, the
output would go into the `target/release-lto` directory.

## [Profile selection](https://doc.rust-lang.org/cargo/reference/profiles.html#profile-selection)

The profile used depends on the command, the command-line flags like
`--release` or `--profile`, and the package (in the case of
[overrides](https://doc.rust-lang.org/cargo/reference/profiles.html#overrides)). The default profile if none is specified is:

| Command | Default Profile |
| --- | --- |
| [`cargo run`](https://doc.rust-lang.org/cargo/commands/cargo-run.html), [`cargo build`](https://doc.rust-lang.org/cargo/commands/cargo-build.html), [`cargo check`](https://doc.rust-lang.org/cargo/commands/cargo-check.html), [`cargo rustc`](https://doc.rust-lang.org/cargo/commands/cargo-rustc.html) | [`dev` profile](https://doc.rust-lang.org/cargo/reference/profiles.html#dev) |
| [`cargo test`](https://doc.rust-lang.org/cargo/commands/cargo-test.html) | [`test` profile](https://doc.rust-lang.org/cargo/reference/profiles.html#test) |
| [`cargo bench`](https://doc.rust-lang.org/cargo/commands/cargo-bench.html) | [`bench` profile](https://doc.rust-lang.org/cargo/reference/profiles.html#bench) |
| [`cargo install`](https://doc.rust-lang.org/cargo/commands/cargo-install.html) | [`release` profile](https://doc.rust-lang.org/cargo/reference/profiles.html#release) |
...
including [library](https://doc.rust-lang.org/cargo/reference/cargo-targets.html#library),
[binary](https://doc.rust-lang.org/cargo/reference/cargo-targets.html#binaries),
[example](https://doc.rust-lang.org/cargo/reference/cargo-targets.html#examples),
[test](https://doc.rust-lang.org/cargo/reference/cargo-targets.html#tests),
and [benchmark](https://doc.rust-lang.org/cargo/reference/cargo-targets.html#benchmarks).

The profile for specific packages can be specified with
[overrides](https://doc.rust-lang.org/cargo/reference/profiles.html#overrides), described below.
...
### [Overrides and generics](https://doc.rust-lang.org/cargo/reference/profiles.html#overrides-and-generics)
...
For example, [nalgebra](https://crates.io/crates/nalgebra) is a library which defines vectors and matrices making
