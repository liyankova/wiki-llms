...
## [Futures and the Async Syntax](https://doc.rust-lang.org/book/ch17-01-futures-and-syntax.html#futures-and-the-async-syntax)
...
## [Our First Async Program](https://doc.rust-lang.org/book/ch17-01-futures-and-syntax.html#our-first-async-program)
...
code](https://github.com/rust-lang/book/tree/main/packages/trpl). You’ll be able to see what crate each
...
### [Defining the page\_title Function](https://doc.rust-lang.org/book/ch17-01-futures-and-syntax.html#defining-the-page_title-function)
...
[Listing 17-1](https://doc.rust-lang.org/book/ch17-01-futures-and-syntax.html#listing-17-1): Defining an async function to get the title element from an HTML page
...
spawn](https://doc.rust-lang.org/book/ch16-01-threads.html#creating-a-new-thread-with-spawn), where the closure we passed to another
...
[Listing 17-2](https://doc.rust-lang.org/book/ch17-01-futures-and-syntax.html#listing-17-2): Chaining with the `await` keyword
...
* It uses the `impl Trait` syntax we discussed back in Chapter 10 in the
  [“Traits as Parameters”](https://doc.rust-lang.org/book/ch10-02-traits.html#traits-as-parameters) section.
...
## [Determining a Single Page’s Title](https://doc.rust-lang.org/book/ch17-01-futures-and-syntax.html#determining-a-single-pages-title)
...
[Accepting Command Line Arguments](https://doc.rust-lang.org/book/ch12-01-accepting-command-line-arguments.html) section. Then we
...
[Listing 17-3](https://doc.rust-lang.org/book/ch17-01-futures-and-syntax.html#listing-17-3): Calling the `page_title` function from `main` with a user-supplied argument
...
[Listing 17-4](https://doc.rust-lang.org/book/ch17-01-futures-and-syntax.html#listing-17-4): Awaiting an async block with `trpl::run`
...
### [Racing Our Two URLs Against Each Other](https://doc.rust-lang.org/book/ch17-01-futures-and-syntax.html#racing-our-two-urls-against-each-other)
...
[Listing 17-5](https://doc.rust-lang.org/book/ch17-01-futures-and-syntax.html#listing-17-5):
