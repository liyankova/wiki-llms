...
[collection](https://doc.rust-lang.org/book/ch08-00-common-collections.html). A slice is a kind
...
[“Storing UTF-8 Encoded Text with Strings”](https://doc.rust-lang.org/book/ch08-02-strings.html#storing-utf-8-encoded-text-with-strings) section
of Chapter 8.
...
[Listing 4-7](https://doc.rust-lang.org/book/ch04-03-slices.html#listing-4-7): The `first_word` function that returns a byte index value into the `String` parameter
...
6](https://doc.rust-lang.org/book/ch06-02-match.html#patterns-that-bind-to-values). In the `for` loop, we specify a pattern that has `i`
...
[Listing 4-8](https://doc.rust-lang.org/book/ch04-03-slices.html#listing-4-8): Storing the result from calling the `first_word` function and then changing the `String` contents
...
[Listing 4-9](https://doc.rust-lang.org/book/ch04-03-slices.html#listing-4-9): Improving the `first_word` function by using a string slice for the type of the `s` parameter
...
Methods”](https://doc.rust-lang.org/book/ch15-02-deref.html#implicit-deref-coercions-with-functions-and-methods) section of Chapter 15.
