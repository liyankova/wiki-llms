...
title: Extensible Concurrency with the Send and Sync Traits - The Rust Programming Language
source_domain: doc.rust-lang.org
---

# Extensible Concurrency with the Send and Sync Traits - The Rust Programming Language

## [Extensible Concurrency with the `Send` and `Sync` Traits](https://doc.rust-lang.org/book/ch16-04-extensible-concurrency-sync-and-send.html#extensible-concurrency-with-the-send-and-sync-traits)
...
Threads”](https://doc.rust-lang.org/book/ch16-03-shared-state.html#sharing-a-mutext-between-multiple-threads).
...
Rustonomicon”](https://doc.rust-lang.org/nomicon/index.html) has more information about these guarantees and how to
uphold them.
