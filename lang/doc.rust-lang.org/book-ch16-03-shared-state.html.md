...
#### [The API of `Mutex<T>`](https://doc.rust-lang.org/book/ch16-03-shared-state.html#the-api-of-mutext)
...
[Listing 16-12](https://doc.rust-lang.org/book/ch16-03-shared-state.html#listing-16-12): Exploring the API of `Mutex<T>` in a single-threaded context for simplicity
...
#### [Sharing a `Mutex<T>` Between Multiple Threads](https://doc.rust-lang.org/book/ch16-03-shared-state.html#sharing-a-mutext-between-multiple-threads)
...
[Listing 16-13](https://doc.rust-lang.org/book/ch16-03-shared-state.html#listing-16-13): Ten threads, each incrementing a counter guarded by a `Mutex<T>`
...
[Listing 16-14](https://doc.rust-lang.org/book/ch16-03-shared-state.html#listing-16-14): Attempting to use `Rc<T>` to allow multiple threads to own the `Mutex<T>`
...
#### [Atomic Reference Counting with `Arc<T>`](https://doc.rust-lang.org/book/ch16-03-shared-state.html#atomic-reference-counting-with-arct)

Fortunately, `Arc<T>` *is* a type like `Rc<T>` that is safe to use in
concurrent situations. The *a* stands for *atomic*, meaning it’s an *atomically
reference-counted* type. Atomics are an additional kind of concurrency
primitive that we won’t cover in detail here: see the standard library
documentation for [`std::sync::atomic`](https://doc.rust-lang.org/std/sync/atomic/index.html) for more
...
[Listing 16-15](https://doc.rust-lang.org/book/ch16-03-shared-state.html#listing-16-15): Using an `Arc<T>` to wrap the `Mutex<T>` to be able to share ownership across multiple threads
...
standard library](https://doc.rust-lang.org/std/sync/atomic/index.html). These types provide safe, concurrent,
