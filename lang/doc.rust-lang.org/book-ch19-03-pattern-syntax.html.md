...
## [Pattern Syntax](https://doc.rust-lang.org/book/ch19-03-pattern-syntax.html#pattern-syntax)
...
### [Matching Literals](https://doc.rust-lang.org/book/ch19-03-pattern-syntax.html#matching-literals)
...
### [Matching Named Variables](https://doc.rust-lang.org/book/ch19-03-pattern-syntax.html#matching-named-variables)
...
[Listing 19-11](https://doc.rust-lang.org/book/ch19-03-pattern-syntax.html#listing-19-11): A `match` expression with an arm that introduces a new variable which shadows an existing variable `y`
...
Guards”](https://doc.rust-lang.org/book/ch19-03-pattern-syntax.html#extra-conditionals-with-match-guards).

### [Multiple Patterns](https://doc.rust-lang.org/book/ch19-03-pattern-syntax.html#multiple-patterns)
...
### [Matching Ranges of Values with `..=`](https://doc.rust-lang.org/book/ch19-03-pattern-syntax.html#matching-ranges-of-values-with-)
...
### [Destructuring to Break Apart Values](https://doc.rust-lang.org/book/ch19-03-pattern-syntax.html#destructuring-to-break-apart-values)

We can also use patterns to destructure structs, enums, and tuples to use
different parts of these values. Let’s walk through each value.

#### [Destructuring Structs](https://doc.rust-lang.org/book/ch19-03-pattern-syntax.html#destructuring-structs)
...
[Listing 19-12](https://doc.rust-lang.org/book/ch19-03-pattern-syntax.html#listing-19-12): Destructuring a struct’s fields into separate variables
...
[Listing 19-13](https://doc.rust-lang.org/book/ch19-03-pattern-syntax.html#listing-19-13): Destructuring struct fields using struct field shorthand
...
[Listing 19-14](https://doc.rust-lang.org/book/ch19-03-pattern-syntax.html#listing-19-14): Destructuring and matching literal values in one pattern
...
#### [Destructuring Enums](https://doc.rust-lang.org/book/ch19-03-pattern-syntax.html#destructuring-enums)
...
[Listing 19-15](https://doc.rust-lang.org/book/ch19-03-pattern-syntax.html#listing-19-15): Destructuring enum variants that hold different kinds of values
...
#### [Destructuring Nested Structs and Enums](https://doc.rust-lang.org/book/ch19-03-pattern-syntax.html#destructuring-nested-structs-and-enums)
...
[Listing 19-16](https://doc.rust-lang.org/book/ch19-03-pattern-syntax.html#listing-19-16): Matching on nested enums
...
#### [Destructuring Structs and Tuples](https://doc.rust-lang.org/book/ch19-03-pattern-syntax.html#destructuring-structs-and-tuples)
...
### [Ignoring Values in a Pattern](https://doc.rust-lang.org/book/ch19-03-pattern-syntax.html#ignoring-values-in-a-pattern)
...
#### [An Entire Value with `_`](https://doc.rust-lang.org/book/ch19-03-pattern-syntax.html#an-entire-value-with-_)
...
[Listing 19-17](https://doc.rust-lang.org/book/ch19-03-pattern-syntax.html#listing-19-17): Using `_` in a function signature
...
#### [Parts of a Value with a Nested `_`](https://doc.rust-lang.org/book/ch19-03-pattern-syntax.html#parts-of-a-value-with-a-nested-_)
...
[Listing 19-18](https://doc.rust-lang.org/book/ch19-03-pattern-syntax.html#listing-19-18): Using an underscore within patterns that match `Some` variants when we don’t need to use the value inside the `Some`
...
[Listing 19-19](https://doc.rust-lang.org/book/ch19-03-pattern-syntax.html#listing-19-19): Ignoring multiple parts of a tuple

This code will print `Some numbers: 2, 8, 32`, and the values `4` and `16` will
be ignored.

#### [An Unused Variable by Starting Its Name with `_`](https://doc.rust-lang.org/book/ch19-03-pattern-syntax.html#an-unused-variable-by-starting-its-name-with-_)
...
[Listing 19-20](https://doc.rust-lang.org/book/ch19-03-pattern-syntax.html#listing-19-20): Starting a variable name with an underscore to avoid getting unused variable warnings
...
[Listing 19-21](https://doc.rust-lang.org/book/ch19-03-pattern-syntax.html#listing-19-21): An unused variable starting with an underscore still binds the value, which might take ownership of the value.
...
[Listing 19-22](https://doc.rust-lang.org/book/ch19-03-pattern-syntax.html#listing-19-22): Using an underscore does not bind the value.

This code works just fine because we never bind `s` to anything; it isn’t moved.

#### [Remaining Parts of a Value with `..`](https://doc.rust-lang.org/book/ch19-03-pattern-syntax.html#remaining-parts-of-a-value-with-)
...
[Listing 19-23](https://doc.rust-lang.org/book/ch19-03-pattern-syntax.html#listing-19-23): Ignoring all fields of a `Point` except for `x` by using `..`
...
[Listing 19-24](https://doc.rust-lang.org/book/ch19-03-pattern-syntax.html#listing-19-24): Matching only the first and last values in a tuple and ignoring all other values
...
[Listing 19-25](https://doc.rust-lang.org/book/ch19-03-pattern-syntax.html#listing-19-25): An attempt to use `..` in an ambiguous way
...
### [Extra Conditionals with Match Guards](https://doc.rust-lang.org/book/ch19-03-pattern-syntax.html#extra-conditionals-with-match-guards)
...
[Listing 19-26](https://doc.rust-lang.org/book/ch19-03-pattern-syntax.html#listing-19-26): Adding a match guard to a pattern
...
[Listing 19-27](https://doc.rust-lang.org/book/ch19-03-pattern-syntax.html#listing-19-27): Using a match guard to test for equality with an outer variable
...
[Listing 19-28](https://doc.rust-lang.org/book/ch19-03-pattern-syntax.html#listing-19-28): Combining multiple patterns with a match guard
...
[Listing 19-29](https://doc.rust-lang.org/book/ch19-03-pattern-syntax.html#listing-19-29): Using `@` to bind to a value in a pattern while also testing it
...
## [Summary](https://doc.rust-lang.org/book/ch19-03-pattern-syntax.html#summary)
