...
*src/front\_of\_house.rs* file in Listing 7-22.
...
[Listing 7-21](https://doc.rust-lang.org/book/ch07-05-separating-modules-into-different-files.html#listing-7-21): Declaring the `front_of_house` module whose body will be in *src/front\_of\_house.rs*

Next, place the code that was in the curly brackets into a new file named
*src/front\_of\_house.rs*, as shown in Listing 7-22. The compiler knows to look
...
[Listing 7-22](https://doc.rust-lang.org/book/ch07-05-separating-modules-into-different-files.html#listing-7-22): Definitions inside the `front_of_house` module in *src/front\_of\_house.rs*
...
to an Item in the Module Tree”](https://doc.rust-lang.org/book/ch07-03-paths-for-referring-to-an-item-in-the-module-tree.html) section. In other words,
...
named for its ancestors in the module tree, in this case *src/front\_of\_house*.

To start moving `hosting`, we change *src/front\_of\_house.rs* to contain only
...
Then we create a *src/front\_of\_house* directory and a *hosting.rs* file to
