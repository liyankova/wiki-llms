---
url: https://nix.dev/tutorials/first-steps/ad-hoc-shell-environments
title: Ad hoc shell environments — nix.dev  documentation
source_domain: nix.dev
---

# Ad hoc shell environments — nix.dev  documentation

[Skip to main content](https://nix.dev/tutorials/first-steps/ad-hoc-shell-environments#main-content)
...
* [.md](https://nix.dev/_sources/tutorials/first-steps/ad-hoc-shell-environments.md "Download source file")

# Ad hoc shell environments

# Ad hoc shell environments[#](https://nix.dev/tutorials/first-steps/ad-hoc-shell-environments#ad-hoc-shell-environments "Link to this heading")

In a Nix shell environment, you can immediately use any program packaged with Nix, without installing it permanently.

You can also share the command invoking such a shell with others, and it will work on all Linux distributions, WSL, and macOS[[1]](https://nix.dev/tutorials/first-steps/ad-hoc-shell-environments#id4).

## Create a shell environment[#](https://nix.dev/tutorials/first-steps/ad-hoc-shell-environments#create-a-shell-environment "Link to this heading")

Once you [install Nix](https://nix.dev/install-nix#install-nix), you can use it to create new *shell environments* with programs that you want to use.
...
## Running programs once[#](https://nix.dev/tutorials/first-steps/ad-hoc-shell-environments#running-programs-once "Link to this heading")
...
## Search for packages[#](https://nix.dev/tutorials/first-steps/ad-hoc-shell-environments#search-for-packages "Link to this heading")
...
In the search results, each item shows the package name, and the details list the available programs.[[2]](https://nix.dev/tutorials/first-steps/ad-hoc-shell-environments#id5)

## Run any combination of programs[#](https://nix.dev/tutorials/first-steps/ad-hoc-shell-environments#run-any-combination-of-programs "Link to this heading")
...
### Check package versions[#](https://nix.dev/tutorials/first-steps/ad-hoc-shell-environments#check-package-versions "Link to this heading")
...
## Nested shell sessions[#](https://nix.dev/tutorials/first-steps/ad-hoc-shell-environments#nested-shell-sessions "Link to this heading")
...
## Towards reproducibility[#](https://nix.dev/tutorials/first-steps/ad-hoc-shell-environments#towards-reproducibility "Link to this heading")
...
## References[#](https://nix.dev/tutorials/first-steps/ad-hoc-shell-environments#references "Link to this heading")
...
## Next steps[#](https://nix.dev/tutorials/first-steps/ad-hoc-shell-environments#next-steps "Link to this heading")
