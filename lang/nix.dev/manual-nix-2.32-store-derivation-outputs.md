---
url: https://nix.dev/manual/nix/2.32/store/derivation/outputs/
title: Derivation Outputs and Types of Derivations - Nix 2.32.2 Reference Manual
source_domain: nix.dev
---

# Derivation Outputs and Types of Derivations - Nix 2.32.2 Reference Manual

# [Derivation Outputs and Types of Derivations](https://nix.dev/manual/nix/2.32/store/derivation/outputs/#derivation-outputs-and-types-of-derivations)

As stated on the [main pages on derivations](https://nix.dev/manual/nix/2.32/store/derivation/#store-derivation),
a derivation produces [store objects](https://nix.dev/manual/nix/2.32/store/store-object), which are known as the *outputs* of the derivation.
...
## [Output Names](https://nix.dev/manual/nix/2.32/store/derivation/outputs/#outputs)

Output names can be any string which is also a valid [store path](https://nix.dev/manual/nix/2.32/store/store-path) name.
...
The outputs are the derivations are the [store objects](https://nix.dev/manual/nix/2.32/store/store-object) it is obligated to produce.
...
## [Types of output addressing](https://nix.dev/manual/nix/2.32/store/derivation/outputs/#types-of-output-addressing)
...
* whether the output is [content-addressed](https://nix.dev/manual/nix/2.32/store/derivation/outputs/content-address) or [input-addressed](https://nix.dev/manual/nix/2.32/store/derivation/outputs/input-address)
* if the content is content-addressed, how is it content addressed
* if the content is content-addressed, [what is its content address](https://nix.dev/manual/nix/2.32/store/derivation/outputs/content-address#fixed-content-addressing) (and thus what is its [store path])

## [Types of derivations](https://nix.dev/manual/nix/2.32/store/derivation/outputs/#types-of-derivations)
...
* The derivation may be *pure* or *impure*, indicating what read access to the outside world the [builder](https://nix.dev/manual/nix/2.32/store/derivation/#builder) has.
  ...
  + If it is impure, it may be fixed (typical), or it may be floating if the additional [`impure-derivations`](https://nix.dev/manual/nix/2.32/development/experimental-features#xp-feature-impure-derivations) experimental feature is enabled.
