...
title: Introduction - Nix 2.31.3 Reference Manual
source_domain: nix.dev
---

# Introduction - Nix 2.31.3 Reference Manual

# [Introduction](https://nix.dev/manual/nix/rolling/#introduction)
...
## [Multiple versions](https://nix.dev/manual/nix/rolling/#multiple-versions)
...
## [Complete dependencies](https://nix.dev/manual/nix/rolling/#complete-dependencies)
...
## [Multi-user support](https://nix.dev/manual/nix/rolling/#multi-user-support)
...
## [Atomic upgrades and rollbacks](https://nix.dev/manual/nix/rolling/#atomic-upgrades-and-rollbacks)
...
## [Garbage collection](https://nix.dev/manual/nix/rolling/#garbage-collection)
...
## [Functional package language](https://nix.dev/manual/nix/rolling/#functional-package-language)
...
## [Transparent source/binary deployment](https://nix.dev/manual/nix/rolling/#transparent-sourcebinary-deployment)
...
## [Nix Packages collection](https://nix.dev/manual/nix/rolling/#nix-packages-collection)
...
## [Managing build environments](https://nix.dev/manual/nix/rolling/#managing-build-environments)
...
## [Portability](https://nix.dev/manual/nix/rolling/#portability)

Nix runs on Linux and macOS.

## [NixOS](https://nix.dev/manual/nix/rolling/#nixos)
...
## [License](https://nix.dev/manual/nix/rolling/#license)
