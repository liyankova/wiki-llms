...
title: Introduction - Nix 2.32.2 Reference Manual
source_domain: nix.dev
---

# Introduction - Nix 2.32.2 Reference Manual

# [Introduction](https://nix.dev/manual/nix/latest/#introduction)
...
## [Multiple versions](https://nix.dev/manual/nix/latest/#multiple-versions)
...
## [Complete dependencies](https://nix.dev/manual/nix/latest/#complete-dependencies)
...
## [Multi-user support](https://nix.dev/manual/nix/latest/#multi-user-support)
...
## [Atomic upgrades and rollbacks](https://nix.dev/manual/nix/latest/#atomic-upgrades-and-rollbacks)
...
## [Garbage collection](https://nix.dev/manual/nix/latest/#garbage-collection)
...
## [Functional package language](https://nix.dev/manual/nix/latest/#functional-package-language)
...
## [Transparent source/binary deployment](https://nix.dev/manual/nix/latest/#transparent-sourcebinary-deployment)
...
## [Nix Packages collection](https://nix.dev/manual/nix/latest/#nix-packages-collection)
...
## [Managing build environments](https://nix.dev/manual/nix/latest/#managing-build-environments)
...
## [Portability](https://nix.dev/manual/nix/latest/#portability)

Nix runs on Linux and macOS.

## [NixOS](https://nix.dev/manual/nix/latest/#nixos)
...
## [License](https://nix.dev/manual/nix/latest/#license)
