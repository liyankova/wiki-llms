---
url: https://nix.dev/manual/nix/2.32/installation/multi-user
title: Multi-User Mode - Nix 2.32.2 Reference Manual
source_domain: nix.dev
---

# Multi-User Mode - Nix 2.32.2 Reference Manual

# [Multi-User Mode](https://nix.dev/manual/nix/2.32/installation/multi-user#multi-user-mode)
...
## [Setting up the build users](https://nix.dev/manual/nix/2.32/installation/multi-user#setting-up-the-build-users)
...
## [Running the daemon](https://nix.dev/manual/nix/2.32/installation/multi-user#running-the-daemon)

The [Nix daemon](https://nix.dev/manual/nix/2.32/command-ref/nix-daemon) should be started as
follows (as `root`):
...
[`NIX_REMOTE` environment variable](https://nix.dev/manual/nix/2.32/command-ref/env-common) to
...
## [Restricting access](https://nix.dev/manual/nix/2.32/installation/multi-user#restricting-access)
