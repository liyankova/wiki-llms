---
url: https://nix.dev/recommended-reading
title: Further reading — nix.dev  documentation
source_domain: nix.dev
---

# Further reading — nix.dev  documentation

[Skip to main content](https://nix.dev/recommended-reading#main-content)
...
* [.md](https://nix.dev/_sources/recommended-reading.md "Download source file")

# Further reading

# Further reading[#](https://nix.dev/recommended-reading#further-reading "Link to this heading")

## Nix language tutorials[#](https://nix.dev/recommended-reading#nix-language-tutorials "Link to this heading")
...
## Other articles[#](https://nix.dev/recommended-reading#other-articles "Link to this heading")
...
* [NixOS and Flakes - An unofficial book for beginners](https://nixos-and-flakes.thiscute.world) (2023)
  ...
  This tutorial is an introduction to [NixOS](https://nix.dev/reference/glossary#term-NixOS) using the experimental Nix [Flakes](https://nix.dev/concepts/flakes#flakes-definition) functionality.

## Other videos[#](https://nix.dev/recommended-reading#other-videos "Link to this heading")
