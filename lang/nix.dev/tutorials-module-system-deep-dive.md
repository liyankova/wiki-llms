...
title: 2. Module system deep dive — nix.dev  documentation
source_domain: nix.dev
---

# 2. Module system deep dive — nix.dev  documentation

[Skip to main content](https://nix.dev/tutorials/module-system/deep-dive#main-content)
...
* [.md](https://nix.dev/_sources/tutorials/module-system/deep-dive.md "Download source file")

# Module system deep dive

# 2. Module system deep dive[#](https://nix.dev/tutorials/module-system/deep-dive#module-system-deep-dive "Link to this heading")
...
## 2.1. Overview[#](https://nix.dev/tutorials/module-system/deep-dive#overview "Link to this heading")
...
### 2.1.1. What will you learn?[#](https://nix.dev/tutorials/module-system/deep-dive#what-will-you-learn "Link to this heading")
...
### 2.1.2. What do you need?[#](https://nix.dev/tutorials/module-system/deep-dive#what-do-you-need "Link to this heading")

You will use two helper scripts for this exercise.
Download [`map.sh`](https://nix.dev/_downloads/4094b12f51ac6e6660209d82d7bb356e/map.sh) and [`geocode.sh`](https://nix.dev/_downloads/770939e594fe4b5dfabc3064d73281af/geocode.sh) to your working directory.
...
## 2.2. The empty module[#](https://nix.dev/tutorials/module-system/deep-dive#the-empty-module "Link to this heading")

Write the following into a file called `default.nix`:

default.nix[#](https://nix.dev/tutorials/module-system/deep-dive#id2 "Link to this code")
...
## 2.3. Declaring options[#](https://nix.dev/tutorials/module-system/deep-dive#declaring-options "Link to this heading")
...
default.nix[#](https://nix.dev/tutorials/module-system/deep-dive#id3 "Link to this code")
...
default.nix[#](https://nix.dev/tutorials/module-system/deep-dive#id4 "Link to this code")
...
## 2.4. Evaluating modules[#](https://nix.dev/tutorials/module-system/deep-dive#evaluating-modules "Link to this heading")
...
eval.nix[#](https://nix.dev/tutorials/module-system/deep-dive#id5 "Link to this code")
...
## 2.5. Type checking[#](https://nix.dev/tutorials/module-system/deep-dive#type-checking "Link to this heading")
...
default.nix[#](https://nix.dev/tutorials/module-system/deep-dive#id6 "Link to this code")
...
In this case, you will assign a shell command that runs the [`map`](https://nix.dev/_downloads/4094b12f51ac6e6660209d82d7bb356e/map.sh) script in the current directory.
...
default.nix[#](https://nix.dev/tutorials/module-system/deep-dive#id7 "Link to this code")
...
## 2.6. Interlude: reproducible scripts[#](https://nix.dev/tutorials/module-system/deep-dive#interlude-reproducible-scripts "Link to this heading")
...
We can solve this by packaging the raw [`map`](https://nix.dev/_downloads/4094b12f51ac6e6660209d82d7bb356e/map.sh) script with `pkgs.writeShellApplication`.

First, make available a `pkgs` argument in your module evaluation by adding a module that sets `config._module.args`:

eval.nix[#](https://nix.dev/tutorials/module-system/deep-dive#id8 "Link to this code")
...
default.nix[#](https://nix.dev/tutorials/module-system/deep-dive#id9 "Link to this code")
...
## 2.7. Declaring more options[#](https://nix.dev/tutorials/module-system/deep-dive#declaring-more-options "Link to this heading")
...
default.nix[#](https://nix.dev/tutorials/module-system/deep-dive#id10 "Link to this code")
...
## 2.8. Dependencies between options[#](https://nix.dev/tutorials/module-system/deep-dive#dependencies-between-options "Link to this heading")
...
### 2.8.1. Accessing option values[#](https://nix.dev/tutorials/module-system/deep-dive#accessing-option-values "Link to this heading")
...
default.nix[#](https://nix.dev/tutorials/module-system/deep-dive#id11 "Link to this code")
...
default.nix[#](https://nix.dev/tutorials/module-system/deep-dive#id12 "Link to this code")
...
## 2.9. Conditional definitions[#](https://nix.dev/tutorials/module-system/deep-dive#conditional-definitions "Link to this heading")
...
default.nix[#](https://nix.dev/tutorials/module-system/deep-dive#id13 "Link to this code")
...
default.nix[#](https://nix.dev/tutorials/module-system/deep-dive#id14 "Link to this code")
...
## 2.10. Default values[#](https://nix.dev/tutorials/module-system/deep-dive#default-values "Link to this heading")
...
default.nix[#](https://nix.dev/tutorials/module-system/deep-dive#id15 "Link to this code")
...
## 2.11. Wrapping shell commands[#](https://nix.dev/tutorials/module-system/deep-dive#wrapping-shell-commands "Link to this heading")
...
default.nix[#](https://nix.dev/tutorials/module-system/deep-dive#id16 "Link to this code")
...
To implement this behavior, you will use the [`geocode`](https://nix.dev/_downloads/770939e594fe4b5dfabc3064d73281af/geocode.sh) utility, which turns location names into coordinates.
...
default.nix[#](https://nix.dev/tutorials/module-system/deep-dive#id17 "Link to this code")
...
default.nix[#](https://nix.dev/tutorials/module-system/deep-dive#id18 "Link to this code")
...
default.nix[#](https://nix.dev/tutorials/module-system/deep-dive#id19 "Link to this code")
...
## 2.12. Splitting modules[#](https://nix.dev/tutorials/module-system/deep-dive#splitting-modules "Link to this heading")
...
marker.nix[#](https://nix.dev/tutorials/module-system/deep-dive#id20 "Link to this code")
...
default.nix[#](https://nix.dev/tutorials/module-system/deep-dive#id21 "Link to this code")
...
## 2.13. The `submodule` type[#](https://nix.dev/tutorials/module-system/deep-dive#the-submodule-type "Link to this heading")
...
marker.nix[#](https://nix.dev/tutorials/module-system/deep-dive#id22 "Link to this code")
...
## 2.14. Defining options in other modules[#](https://nix.dev/tutorials/module-system/deep-dive#defining-options-in-other-modules "Link to this heading")
...
marker.nix[#](https://nix.dev/tutorials/module-system/deep-dive#id23 "Link to this code")
...
marker.nix[#](https://nix.dev/tutorials/module-system/deep-dive#id24 "Link to this code")
...
## 2.15. Nested submodules[#](https://nix.dev/tutorials/module-system/deep-dive#nested-submodules "Link to this heading")
...
marker.nix[#](https://nix.dev/tutorials/module-system/deep-dive#id25 "Link to this code")
...
marker.nix[#](https://nix.dev/tutorials/module-system/deep-dive#id26 "Link to this code")
...
marker.nix[#](https://nix.dev/tutorials/module-system/deep-dive#id27 "Link to this code")
...
## 2.16. The `strMatching` type[#](https://nix.dev/tutorials/module-system/deep-dive#the-strmatching-type "Link to this heading")
...
marker.nix[#](https://nix.dev/tutorials/module-system/deep-dive#id28 "Link to this code")
...
marker.nix[#](https://nix.dev/tutorials/module-system/deep-dive#id29 "Link to this code")
...
## 2.17. Functions as submodule arguments[#](https://nix.dev/tutorials/module-system/deep-dive#functions-as-submodule-arguments "Link to this heading")
...
marker.nix[#](https://nix.dev/tutorials/module-system/deep-dive#id30 "Link to this code")
...
marker.nix[#](https://nix.dev/tutorials/module-system/deep-dive#id31 "Link to this code")
...
marker.nix[#](https://nix.dev/tutorials/module-system/deep-dive#id32 "Link to this code")
...
## 2.18. The `either` and `enum` types[#](https://nix.dev/tutorials/module-system/deep-dive#the-either-and-enum-types "Link to this heading")
...
marker.nix[#](https://nix.dev/tutorials/module-system/deep-dive#id33 "Link to this code")
...
marker.nix[#](https://nix.dev/tutorials/module-system/deep-dive#id34 "Link to this code")
...
marker.nix[#](https://nix.dev/tutorials/module-system/deep-dive#id35 "Link to this code")
...
marker.nix[#](https://nix.dev/tutorials/module-system/deep-dive#id36 "Link to this code")
...
marker.nix[#](https://nix.dev/tutorials/module-system/deep-dive#id37 "Link to this code")
...
marker.nix[#](https://nix.dev/tutorials/module-system/deep-dive#id38 "Link to this code")
...
## 2.19. The `pathType` submodule[#](https://nix.dev/tutorials/module-system/deep-dive#the-pathtype-submodule "Link to this heading")
...
path.nix[#](https://nix.dev/tutorials/module-system/deep-dive#id39 "Link to this code")
...
marker.nix[#](https://nix.dev/tutorials/module-system/deep-dive#id40 "Link to this code")
...
marker.nix[#](https://nix.dev/tutorials/module-system/deep-dive#id41 "Link to this code")
...
marker.nix[#](https://nix.dev/tutorials/module-system/deep-dive#id42 "Link to this code")
...
marker.nix[#](https://nix.dev/tutorials/module-system/deep-dive#id43 "Link to this code")
...
path.nix[#](https://nix.dev/tutorials/module-system/deep-dive#id44 "Link to this code")
...
## 2.20. The `between` constraint on integer values[#](https://nix.dev/tutorials/module-system/deep-dive#the-between-constraint-on-integer-values "Link to this heading")
...
path.nix[#](https://nix.dev/tutorials/module-system/deep-dive#id45 "Link to this code")
...
path.nix[#](https://nix.dev/tutorials/module-system/deep-dive#id46 "Link to this code")
...
path.nix[#](https://nix.dev/tutorials/module-system/deep-dive#id47 "Link to this code")
...
## 2.21. The `pathStyle` submodule[#](https://nix.dev/tutorials/module-system/deep-dive#the-pathstyle-submodule "Link to this heading")
...
path.nix[#](https://nix.dev/tutorials/module-system/deep-dive#id48 "Link to this code")
...
path.nix[#](https://nix.dev/tutorials/module-system/deep-dive#id49 "Link to this code")
...
## 2.22. Path styling: color[#](https://nix.dev/tutorials/module-system/deep-dive#path-styling-color "Link to this heading")
...
path.nix[#](https://nix.dev/tutorials/module-system/deep-dive#id50 "Link to this code")
...
path.nix[#](https://nix.dev/tutorials/module-system/deep-dive#id51 "Link to this code")
...
path.nix[#](https://nix.dev/tutorials/module-system/deep-dive#id52 "Link to this code")
...
## 2.23. Further styling[#](https://nix.dev/tutorials/module-system/deep-dive#further-styling "Link to this heading")
...
path.nix[#](https://nix.dev/tutorials/module-system/deep-dive#id53 "Link to this code")
...
path.nix[#](https://nix.dev/tutorials/module-system/deep-dive#id54 "Link to this code")
...
## 2.24. Wrapping up[#](https://nix.dev/tutorials/module-system/deep-dive#wrapping-up "Link to this heading")
