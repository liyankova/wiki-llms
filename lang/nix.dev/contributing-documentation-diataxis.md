---
url: https://nix.dev/contributing/documentation/diataxis
title: Documentation framework — nix.dev  documentation
source_domain: nix.dev
---

# Documentation framework — nix.dev  documentation

[Skip to main content](https://nix.dev/contributing/documentation/diataxis#main-content)
...
* [.md](https://nix.dev/_sources/contributing/documentation/diataxis.md "Download source file")

# Documentation framework

# Documentation framework[#](https://nix.dev/contributing/documentation/diataxis#documentation-framework "Link to this heading")
...
* [Tutorials](https://nix.dev/contributing/documentation/diataxis#tutorials)
* [Guides](https://nix.dev/contributing/documentation/diataxis#guides)
* [Reference](https://nix.dev/contributing/documentation/diataxis#reference)
* [Concepts](https://nix.dev/contributing/documentation/diataxis#concepts)

We’ve found that contributors struggle to understand the differences between these categories, and while we *strongly* recommend reading up on the Diátaxis framework, we can summarize them as follows:

## Reference[#](https://nix.dev/contributing/documentation/diataxis#reference "Link to this heading")
...
## Tutorials[#](https://nix.dev/contributing/documentation/diataxis#tutorials "Link to this heading")
...
## Guides[#](https://nix.dev/contributing/documentation/diataxis#guides "Link to this heading")
...
## Concepts[#](https://nix.dev/contributing/documentation/diataxis#concepts "Link to this heading")
...
### Guides vs. Tutorials[#](https://nix.dev/contributing/documentation/diataxis#guides-vs-tutorials "Link to this heading")
