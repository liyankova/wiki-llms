---
url: https://nix.dev/manual/nix/2.32/store/building
...
# [Building](https://nix.dev/manual/nix/2.32/store/building#building)

## [Normalizing derivation inputs](https://nix.dev/manual/nix/2.32/store/building#normalizing-derivation-inputs)

* Each input must be [realised](https://nix.dev/manual/nix/2.32/glossary#gloss-realise) prior to building the derivation in question.
...
## [Builder Execution](https://nix.dev/manual/nix/2.32/store/building#builder-execution)

The [`builder`](https://nix.dev/manual/nix/2.32/store/derivation/#builder) is executed as follows:
...
* In addition, the following variables are set:
  ...
  + `NIX_ATTRS_JSON_FILE` & `NIX_ATTRS_SH_FILE` if `__structuredAttrs`
    ...
    [section about structured attrs](https://nix.dev/manual/nix/2.32/language/advanced-attributes#adv-attr-structuredAttrs).
...
* If an output path already exists, it is removed. Also, locks are
  acquired to prevent multiple [Nix instances](https://nix.dev/manual/nix/2.32/glossary#gloss-nix-instance) from performing the same
...
## [Processing outputs](https://nix.dev/manual/nix/2.32/store/building#processing-outputs)
