---
url: https://nix.dev/contributing/how-to-contribute
title: How to contribute — nix.dev  documentation
source_domain: nix.dev
---

# How to contribute — nix.dev  documentation

[Skip to main content](https://nix.dev/contributing/how-to-contribute#main-content)
...
* [.md](https://nix.dev/_sources/contributing/how-to-contribute.md "Download source file")

# How to contribute

# How to contribute[#](https://nix.dev/contributing/how-to-contribute#how-to-contribute "Link to this heading")
...
This guide shows how you can contribute to [Nix](https://nix.dev/reference/glossary#term-Nix), [Nixpkgs](https://nix.dev/reference/glossary#term-Nixpkgs) or [NixOS](https://nix.dev/reference/glossary#term-NixOS).
It assumes that you’re already somewhat proficient with basic concepts and workflows, which are outlined in the [beginner tutorial series](https://nix.dev/tutorials/#tutorials).
The most important aspects are [the Nix language](https://nix.dev/tutorials/nix-language#reading-nix-language), the various Nixpkgs mechanisms for [constructing derivations to build software](https://nix.dev/tutorials/packaging-existing-software#packaging-tutorial), [the module system](https://nix.dev/tutorials/module-system/#module-system-tutorial), and [NixOS integration tests](https://nix.dev/tutorials/nixos/integration-testing-using-virtual-machines#integration-testing-vms).
...
## Getting started[#](https://nix.dev/contributing/how-to-contribute#getting-started "Link to this heading")

Start by asking informed questions, after reading [reference documentation](https://nix.dev/reference/#reference) and the code relevant to what you care about.
...
If you are new to Nix, consider [contributing documentation](https://nix.dev/contributing/documentation/) first.
...
## Report an issue[#](https://nix.dev/contributing/how-to-contribute#report-an-issue "Link to this heading")
...
* Report issues with [Nix](https://nix.dev/reference/glossary#term-Nix) (including the [Nix reference manual](https://nix.dev/manual/nix/stable)) at [NixOS/nix#issues](https://github.com/NixOS/nix/issues).
* Report issues with [Nixpkgs](https://nix.dev/reference/glossary#term-Nixpkgs) or [NixOS](https://nix.dev/reference/glossary#term-NixOS) (including packages, configuration modules, the [Nixpkgs manual](https://nixos.org/manual/nixpkgs/stable), and the [NixOS manual](https://nixos.org/manual/nixos/stable)) at [NixOS/nixpkgs#issues](https://github.com/NixOS/nixpkgs/issues).
...
## Contribute to Nix[#](https://nix.dev/contributing/how-to-contribute#contribute-to-nix "Link to this heading")

[Nix](https://nix.dev/reference/glossary#term-Nix) is the cornerstone of the ecosystem, and is mostly written in C++.
...
## Contribute to Nixpkgs[#](https://nix.dev/contributing/how-to-contribute#contribute-to-nixpkgs "Link to this heading")
...
[Nixpkgs](https://nix.dev/reference/glossary#term-Nixpkgs) is a large software project with various areas of development.
You can find inspiration for things to improve in the [Nixpkgs issue tracker](https://github.com/NixOS/nixpkgs/issues?q=is%3Aopen+is%3Aissue+-label%3A%226.topic%3A+nixos%22+-label%3A%226.topic%3A+module+system%22+-label%3A%226.+topic%3A+nixos-container%22+sort%3Areactions-%2B1-desc).
...
## Contribute to NixOS[#](https://nix.dev/contributing/how-to-contribute#contribute-to-nixos "Link to this heading")

[NixOS](https://nix.dev/reference/glossary#term-NixOS) is a collectively developed Linux distribution that can be configured conveniently in a highly flexible way through declarative programming interfaces.
...
Contributor documentation specific to NixOS is still lacking, but most conventions for [Nixpkgs contributions](https://nix.dev/contributing/how-to-contribute#contribute-nixpkgs) apply.
...
If you know your way around, working on [popular issues](https://github.com/NixOS/nixpkgs/issues?q=is%3Aopen+is%3Aissue+label%3A%226.topic%3A+nixos%22+sort%3Areactions-%2B1-desc) will be highly appreciated by other NixOS users.

# How to get help[#](https://nix.dev/contributing/how-to-contribute#how-to-get-help "Link to this heading")
