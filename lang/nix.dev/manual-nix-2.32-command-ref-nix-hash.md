---
url: https://nix.dev/manual/nix/2.32/command-ref/nix-hash
...
# [Name](https://nix.dev/manual/nix/2.32/command-ref/nix-hash#name)

`nix-hash` - compute the cryptographic hash of a path

# [Synopsis](https://nix.dev/manual/nix/2.32/command-ref/nix-hash#synopsis)

`nix-hash` [`--flat`] [`--base32`] [`--truncate`] [`--type` *hashAlgo*] *path…*

`nix-hash` [`--to-base16`|`--to-base32`|`--to-base64`|`--to-sri`] [`--type` *hashAlgo*] *hash…*

# [Description](https://nix.dev/manual/nix/2.32/command-ref/nix-hash#description)
...
*[Nix Archive (NAR)](https://nix.dev/manual/nix/2.32/store/file-system-object/content-address#serial-nix-archive) format* produced by [`nix-store --dump`](https://nix.dev/manual/nix/2.32/command-ref/nix-store/dump). Thus, `nix-hash path`
yields the same cryptographic hash as `nix-store --dump path | md5sum`.

# [Options](https://nix.dev/manual/nix/2.32/command-ref/nix-hash#options)

* `--flat`

  Print the cryptographic hash of the contents of each regular file *path*.
  That is, instead of computing
  the hash of the [Nix Archive (NAR)](https://nix.dev/manual/nix/2.32/store/file-system-object/content-address#serial-nix-archive) of *path*,
  just [directly hash]((../store/file-system-object/content-address.md#serial-flat) *path* as is.
...
# [Examples](https://nix.dev/manual/nix/2.32/command-ref/nix-hash#examples)
