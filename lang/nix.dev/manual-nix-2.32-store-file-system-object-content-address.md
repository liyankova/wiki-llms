---
url: https://nix.dev/manual/nix/2.32/store/file-system-object/content-address
title: Content-Addressing File System Objects - Nix 2.32.2 Reference Manual
source_domain: nix.dev
---

# Content-Addressing File System Objects - Nix 2.32.2 Reference Manual

# [Content-Addressing File System Objects](https://nix.dev/manual/nix/2.32/store/file-system-object/content-address#content-addressing-file-system-objects)

For many operations, Nix needs to calculate [a content addresses](https://nix.dev/manual/nix/2.32/glossary#gloss-content-address) of [a file system object](https://nix.dev/manual/nix/2.32/store/file-system-object) (FSO).
...
## [Serialising File System Objects](https://nix.dev/manual/nix/2.32/store/file-system-object/content-address#serial)
...
### [Flat](https://nix.dev/manual/nix/2.32/store/file-system-object/content-address#serial-flat)
...
### [Nix Archive (NAR)](https://nix.dev/manual/nix/2.32/store/file-system-object/content-address#serial-nix-archive)

For the other cases of [file system objects](https://nix.dev/manual/nix/2.32/store/file-system-object), especially directories with arbitrary descendants, we need a more complex serialisation format.
...
The exact specification of the Nix Archive format is in [specified here](https://nix.dev/manual/nix/2.32/protocols/nix-archive).

## [Content addressing File System Objects beyond a single serialisation pass](https://nix.dev/manual/nix/2.32/store/file-system-object/content-address#content-addressing-file-system-objects-beyond-a-single-serialisation-pass)
...
### [Git (](https://nix.dev/manual/nix/2.32/store/file-system-object/content-address#git)[experimental](https://nix.dev/manual/nix/2.32/development/experimental-features#xp-feature-git-hashing))
...
This is similar to do what we do with [flat serialisation](https://nix.dev/manual/nix/2.32/store/file-system-object/content-address#serial-flat), which also lacks this information.
