...
# [Introduction](https://nix.dev/manual/nix/stable/#introduction)
...
## [Multiple versions](https://nix.dev/manual/nix/stable/#multiple-versions)
...
## [Complete dependencies](https://nix.dev/manual/nix/stable/#complete-dependencies)
...
## [Multi-user support](https://nix.dev/manual/nix/stable/#multi-user-support)
...
## [Atomic upgrades and rollbacks](https://nix.dev/manual/nix/stable/#atomic-upgrades-and-rollbacks)
...
## [Garbage collection](https://nix.dev/manual/nix/stable/#garbage-collection)
...
## [Functional package language](https://nix.dev/manual/nix/stable/#functional-package-language)
...
## [Transparent source/binary deployment](https://nix.dev/manual/nix/stable/#transparent-sourcebinary-deployment)
...
## [Nix Packages collection](https://nix.dev/manual/nix/stable/#nix-packages-collection)
...
## [Managing build environments](https://nix.dev/manual/nix/stable/#managing-build-environments)
...
## [Portability](https://nix.dev/manual/nix/stable/#portability)

Nix runs on Linux and macOS.

## [NixOS](https://nix.dev/manual/nix/stable/#nixos)
...
## [License](https://nix.dev/manual/nix/stable/#license)
