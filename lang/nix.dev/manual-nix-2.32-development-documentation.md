---
url: https://nix.dev/manual/nix/2.32/development/documentation
title: Documentation - Nix 2.32.2 Reference Manual
source_domain: nix.dev
---

# Documentation - Nix 2.32.2 Reference Manual

# [Contributing documentation](https://nix.dev/manual/nix/2.32/development/documentation#contributing-documentation)
...
## [Building the manual](https://nix.dev/manual/nix/2.32/development/documentation#building-the-manual)
...
To build the manual incrementally, [enter the development shell](https://nix.dev/manual/nix/2.32/development/building) and run:

```
make manual-html-open -j $NIX_BUILD_CORES
```

In order to reflect changes to the [Makefile for the manual](https://github.com/NixOS/nix/blob/master/doc/manual/local.mk), clear all generated files before re-building:

```
rm $(git ls-files doc/manual/ -o | grep -F '.md') && rmdir doc/manual/source/command-ref/new-cli && make manual-html -j $NIX_BUILD_CORES
```

## [Style guide](https://nix.dev/manual/nix/2.32/development/documentation#style-guide)
...
### [Language](https://nix.dev/manual/nix/2.32/development/documentation#language)
...
### [Links and anchors](https://nix.dev/manual/nix/2.32/development/documentation#links-and-anchors)
...
This happens late in the process, so [building the whole manual](https://nix.dev/manual/nix/2.32/development/documentation#building-the-manual) is not suitable for iterating quickly.
[`mdbook-linkcheck`](https://github.com/Michael-F-Bryan/mdbook-linkcheck) does not implement checking [URI fragments](https://en.wikipedia.org/wiki/URI_fragment) yet.

### [Markdown conventions](https://nix.dev/manual/nix/2.32/development/documentation#markdown-conventions)
...
### [The `..` variable](https://nix.dev/manual/nix/2.32/development/documentation#the--variable)
...
If the `..` literal appears in an error message from the [`mdbook-linkcheck`](https://github.com/Michael-F-Bryan/mdbook-linkcheck) tool, the `..` replacement needs to be applied to the generated source file that mentions it.
See existing `..` logic in the [Makefile for the manual](https://github.com/NixOS/nix/blob/master/doc/manual/local.mk).
Regular markdown files used for the manual have a base path of their own and they can use relative paths instead of `..`.

## [API documentation](https://nix.dev/manual/nix/2.32/development/documentation#api-documentation)

[Doxygen API documentation](https://hydra.nixos.org/job/nix/master/internal-api-docs/latest/download-by-type/doc/internal-api-docs) is available online.
...
## [C API documentation](https://nix.dev/manual/nix/2.32/development/documentation#c-api-documentation)

Note that the C API is not yet stable.
[C API documentation](https://hydra.nixos.org/job/nix/master/external-api-docs/latest/download-by-type/doc/external-api-docs) is available online.
You can also build and view it yourself:
