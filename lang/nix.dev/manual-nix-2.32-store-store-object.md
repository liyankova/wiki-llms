---
url: https://nix.dev/manual/nix/2.32/store/store-object
title: Store Object - Nix 2.32.2 Reference Manual
source_domain: nix.dev
---

# Store Object - Nix 2.32.2 Reference Manual

## [Store Object](https://nix.dev/manual/nix/2.32/store/store-object#store-object)

A Nix store is a collection of *store objects* with *references* between them.
A store object consists of

* A [file system object](https://nix.dev/manual/nix/2.32/store/file-system-object) as data
* A set of [store paths](https://nix.dev/manual/nix/2.32/store/store-path) as references to store objects

### [References](https://nix.dev/manual/nix/2.32/store/store-object#references)
...
The graph of references excluding self-references thus forms a [directed acyclic graph](https://nix.dev/manual/nix/2.32/glossary#gloss-directed-acyclic-graph).

We can take the [transitive closure](https://en.wikipedia.org/wiki/Transitive_closure) of the references graph, in which any pair of store objects have an edge if a *path* of one or more references exists from the first to the second object.
...
We can also take the [transpose graph](https://en.wikipedia.org/wiki/Transpose_graph) of the references graph, where we reverse the orientation of all edges.
...
### [Immutability](https://nix.dev/manual/nix/2.32/store/store-object#immutability)
...
### [Closure property](https://nix.dev/manual/nix/2.32/store/store-object#closure-property)
