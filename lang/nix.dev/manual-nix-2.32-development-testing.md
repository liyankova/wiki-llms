---
url: https://nix.dev/manual/nix/2.32/development/testing
title: Testing - Nix 2.32.2 Reference Manual
source_domain: nix.dev
---

# Testing - Nix 2.32.2 Reference Manual

# [Running tests](https://nix.dev/manual/nix/2.32/development/testing#running-tests)

## [Coverage analysis](https://nix.dev/manual/nix/2.32/development/testing#coverage-analysis)

A [coverage analysis report](https://hydra.nixos.org/job/nix/master/coverage/latest/download-by-type/report/coverage) is available online
...
## [Unit-tests](https://nix.dev/manual/nix/2.32/development/testing#unit-tests)

The unit tests are defined using the [googletest](https://google.github.io/googletest/) and [rapidcheck](https://github.com/emil-e/rapidcheck) frameworks.

### [Source and header layout](https://nix.dev/manual/nix/2.32/development/testing#source-and-header-layout)
...
### [Running tests](https://nix.dev/manual/nix/2.32/development/testing#running-tests-1)
...
### [Debugging tests](https://nix.dev/manual/nix/2.32/development/testing#debugging-tests)
...
### [Characterisation testing](https://nix.dev/manual/nix/2.32/development/testing#characaterisation-testing-unit)

See [functional characterisation testing](https://nix.dev/manual/nix/2.32/development/testing#characterisation-testing-functional) for a broader discussion of characterisation testing.
...
### [Unit test support libraries](https://nix.dev/manual/nix/2.32/development/testing#unit-test-support-libraries)

There are headers and code which are not just used to test the library in question, but also downstream libraries.
For example, we do [property testing](https://en.wikipedia.org/wiki/Property_testing) with the [rapidcheck](https://github.com/emil-e/rapidcheck) library.
...
## [Functional tests](https://nix.dev/manual/nix/2.32/development/testing#functional-tests)
...
### [Running the whole test suite](https://nix.dev/manual/nix/2.32/development/testing#running-the-whole-test-suite)
...
### [Grouping tests](https://nix.dev/manual/nix/2.32/development/testing#grouping-tests)
...
### [Running individual tests](https://nix.dev/manual/nix/2.32/development/testing#running-individual-tests)
...
### [Debugging failing functional tests](https://nix.dev/manual/nix/2.32/development/testing#debugging-failing-functional-tests)
...
### [Troubleshooting](https://nix.dev/manual/nix/2.32/development/testing#troubleshooting)
...
### [Characterisation testing](https://nix.dev/manual/nix/2.32/development/testing#characterisation-testing-functional)
...
This convention is shared with the [characterisation unit tests](https://nix.dev/manual/nix/2.32/development/testing#characterisation-testing-unit) too.
...
### [Running functional tests on NixOS](https://nix.dev/manual/nix/2.32/development/testing#running-functional-tests-on-nixos)
...
## [Integration tests](https://nix.dev/manual/nix/2.32/development/testing#integration-tests)
...
## [Installer tests](https://nix.dev/manual/nix/2.32/development/testing#installer-tests)
...
### [One-time setup](https://nix.dev/manual/nix/2.32/development/testing#one-time-setup)
...
## [Working on documentation](https://nix.dev/manual/nix/2.32/development/testing#working-on-documentation)

### [Using the CI-generated installer for manual testing](https://nix.dev/manual/nix/2.32/development/testing#using-the-ci-generated-installer-for-manual-testing)
