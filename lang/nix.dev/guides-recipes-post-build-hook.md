---
url: https://nix.dev/guides/recipes/post-build-hook
title: Setting up post-build hooks — nix.dev  documentation
source_domain: nix.dev
---

# Setting up post-build hooks — nix.dev  documentation

[Skip to main content](https://nix.dev/guides/recipes/post-build-hook#main-content)
...
* [.md](https://nix.dev/_sources/guides/recipes/post-build-hook.md "Download source file")

# Setting up post-build hooks

# Setting up post-build hooks[#](https://nix.dev/guides/recipes/post-build-hook#setting-up-post-build-hooks "Link to this heading")
...
## Implementation caveats[#](https://nix.dev/guides/recipes/post-build-hook#implementation-caveats "Link to this heading")
...
## Prerequisites[#](https://nix.dev/guides/recipes/post-build-hook#prerequisites "Link to this heading")
...
## Set up a signing key[#](https://nix.dev/guides/recipes/post-build-hook#set-up-a-signing-key "Link to this heading")
...
## Implementing the build hook[#](https://nix.dev/guides/recipes/post-build-hook#implementing-the-build-hook "Link to this heading")
...
## Updating Nix configuration[#](https://nix.dev/guides/recipes/post-build-hook#updating-nix-configuration "Link to this heading")
...
## Testing[#](https://nix.dev/guides/recipes/post-build-hook#testing "Link to this heading")
...
## Conclusion[#](https://nix.dev/guides/recipes/post-build-hook#conclusion "Link to this heading")

You have configured Nix to automatically sign and upload every local build to a remote S3-compatible binary cache.

Before deploying this to production, be sure to consider the [implementation caveats](https://nix.dev/guides/recipes/post-build-hook#implementation-caveats).
