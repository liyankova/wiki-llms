---
url: https://nix.dev/manual/nix/2.32/development/cxx
title: C++ style guide - Nix 2.32.2 Reference Manual
source_domain: nix.dev
---

# C++ style guide - Nix 2.32.2 Reference Manual

# [C++ style guide](https://nix.dev/manual/nix/2.32/development/cxx#c-style-guide)
...
## [The `*-impl.hh` pattern](https://nix.dev/manual/nix/2.32/development/cxx#the--implhh-pattern)
