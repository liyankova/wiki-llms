---
url: https://nix.dev/tutorials/nixos/integration-testing-using-virtual-machines
title: Integration testing with NixOS virtual machines — nix.dev  documentation
source_domain: nix.dev
---

# Integration testing with NixOS virtual machines — nix.dev  documentation

[Skip to main content](https://nix.dev/tutorials/nixos/integration-testing-using-virtual-machines#main-content)
...
* [.md](https://nix.dev/_sources/tutorials/nixos/integration-testing-using-virtual-machines.md "Download source file")

# Integration testing with NixOS virtual machines

# Integration testing with NixOS virtual machines[#](https://nix.dev/tutorials/nixos/integration-testing-using-virtual-machines#integration-testing-with-nixos-virtual-machines "Link to this heading")

## What will you learn?[#](https://nix.dev/tutorials/nixos/integration-testing-using-virtual-machines#what-will-you-learn "Link to this heading")
...
## What do you need?[#](https://nix.dev/tutorials/nixos/integration-testing-using-virtual-machines#what-do-you-need "Link to this heading")

* A working [Nix installation](https://nix.dev/install-nix#install-nix) on Linux, or [NixOS](https://nixos.org/manual/nixos/stable/index.html#sec-installation)
* Basic knowledge of the [Nix language](https://nix.dev/tutorials/nix-language#reading-nix-language)
* Basic knowledge of [NixOS configuration](https://nix.dev/tutorials/nixos/nixos-configuration-on-vm#nixos-vms)

## Introduction[#](https://nix.dev/tutorials/nixos/integration-testing-using-virtual-machines#introduction "Link to this heading")
...
They can be written and launched outside of NixOS, on any Linux machine[[1]](https://nix.dev/tutorials/nixos/integration-testing-using-virtual-machines#darwin).
...
## The `testers.runNixOSTest` function[#](https://nix.dev/tutorials/nixos/integration-testing-using-virtual-machines#the-testers-runnixostest-function "Link to this heading")
...
## Minimal example[#](https://nix.dev/tutorials/nixos/integration-testing-using-virtual-machines#minimal-example "Link to this heading")
...
1. Use a [pinned version of Nixpkgs](https://nix.dev/reference/pinning-nixpkgs#ref-pinning-nixpkgs), and [explicitly set configuration options and overlays](https://nix.dev/guides/best-practices#nixpkgs-config) to avoid them being inadvertently overridden by global configuration:
...
2. Label the test with a descriptive name:
   ...
   1name = "minimal-test";
   ```
3. Because this example only uses one virtual machine, the node we specify is simply called `machine`.
   This name is arbitrary and can be chosen freely.
   As configuration you use the relevant parts of the default configuration, [which we used in a previous tutorial](https://nix.dev/tutorials/nixos/nixos-configuration-on-vm#nixos-vms):
...
## Running tests[#](https://nix.dev/tutorials/nixos/integration-testing-using-virtual-machines#running-tests "Link to this heading")
...
## Interactive Python shell in the virtual machine[#](https://nix.dev/tutorials/nixos/integration-testing-using-virtual-machines#interactive-python-shell-in-the-virtual-machine "Link to this heading")
...
## Tests with multiple virtual machines[#](https://nix.dev/tutorials/nixos/integration-testing-using-virtual-machines#tests-with-multiple-virtual-machines "Link to this heading")
...
3. Run `curl` on the client and use `grep` to check the expected return string.
...
## Additional information regarding NixOS tests[#](https://nix.dev/tutorials/nixos/integration-testing-using-virtual-machines#additional-information-regarding-nixos-tests "Link to this heading")

* Running integration tests on CI requires hardware acceleration, which many CIs do not support.

  To run integration tests in [GitHub Actions](https://nix.dev/guides/recipes/continuous-integration-github-actions#github-actions) see [how to disable hardware acceleration](https://github.com/cachix/install-nix-action#how-do-i-run-nixos-tests).
...
## Next steps[#](https://nix.dev/tutorials/nixos/integration-testing-using-virtual-machines#next-steps "Link to this heading")
...
* [Building and running Docker images](https://nix.dev/tutorials/nixos/building-and-running-docker-images#nixos-docker-images)
