---
url: https://nix.dev/manual/nix/2.32/package-management/ssh-substituter
title: Serving a Nix store via SSH - Nix 2.32.2 Reference Manual
source_domain: nix.dev
---

# Serving a Nix store via SSH - Nix 2.32.2 Reference Manual

# [Serving a Nix store via SSH](https://nix.dev/manual/nix/2.32/package-management/ssh-substituter#serving-a-nix-store-via-ssh)
