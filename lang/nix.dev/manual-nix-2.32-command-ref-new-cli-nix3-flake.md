---
url: https://nix.dev/manual/nix/2.32/command-ref/new-cli/nix3-flake
title: nix flake - Nix 2.32.2 Reference Manual
source_domain: nix.dev
---

# nix flake - Nix 2.32.2 Reference Manual
...
# [Name](https://nix.dev/manual/nix/2.32/command-ref/new-cli/nix3-flake#name)

`nix flake` - manage Nix flakes

# [Synopsis](https://nix.dev/manual/nix/2.32/command-ref/new-cli/nix3-flake#synopsis)

`nix flake` [*option*...] *subcommand*

where *subcommand* is one of the following:

* [`nix flake archive`](https://nix.dev/manual/nix/2.32/command-ref/new-cli/nix3-flake-archive) - copy a flake and all its inputs to a store
* [`nix flake check`](https://nix.dev/manual/nix/2.32/command-ref/new-cli/nix3-flake-check) - check whether the flake evaluates and run its tests
* [`nix flake clone`](https://nix.dev/manual/nix/2.32/command-ref/new-cli/nix3-flake-clone) - clone flake repository
* [`nix flake info`](https://nix.dev/manual/nix/2.32/command-ref/new-cli/nix3-flake-info) - show flake metadata
* [`nix flake init`](https://nix.dev/manual/nix/2.32/command-ref/new-cli/nix3-flake-init) - create a flake in the current directory from a template
* [`nix flake lock`](https://nix.dev/manual/nix/2.32/command-ref/new-cli/nix3-flake-lock) - create missing lock file entries
* [`nix flake metadata`](https://nix.dev/manual/nix/2.32/command-ref/new-cli/nix3-flake-metadata) - show flake metadata
* [`nix flake new`](https://nix.dev/manual/nix/2.32/command-ref/new-cli/nix3-flake-new) - create a flake in the specified directory from a template
* [`nix flake prefetch`](https://nix.dev/manual/nix/2.32/command-ref/new-cli/nix3-flake-prefetch) - download the source tree denoted by a flake reference into the Nix store
* [`nix flake prefetch-inputs`](https://nix.dev/manual/nix/2.32/command-ref/new-cli/nix3-flake-prefetch-inputs) - fetch the inputs of a flake
* [`nix flake show`](https://nix.dev/manual/nix/2.32/command-ref/new-cli/nix3-flake-show) - show the outputs provided by a flake
* [`nix flake update`](https://nix.dev/manual/nix/2.32/command-ref/new-cli/nix3-flake-update) - update flake lock file

# [Description](https://nix.dev/manual/nix/2.32/command-ref/new-cli/nix3-flake#description)
...
# [Flake references](https://nix.dev/manual/nix/2.32/command-ref/new-cli/nix3-flake#flake-references)

Flake references (*flakerefs*) are a way to specify the location of a
flake. These have two different forms:

## [Attribute set representation](https://nix.dev/manual/nix/2.32/command-ref/new-cli/nix3-flake#attribute-set-representation)
...
## [URL-like syntax](https://nix.dev/manual/nix/2.32/command-ref/new-cli/nix3-flake#url-like-syntax)
...
### [Examples](https://nix.dev/manual/nix/2.32/command-ref/new-cli/nix3-flake#examples)
...
## [Path-like syntax](https://nix.dev/manual/nix/2.32/command-ref/new-cli/nix3-flake#path-like-syntax)
...
omitted, the path will be interpreted as [URL-like syntax](https://nix.dev/manual/nix/2.32/command-ref/new-cli/nix3-flake#url-like-syntax),
...
### [Examples](https://nix.dev/manual/nix/2.32/command-ref/new-cli/nix3-flake#examples-1)
...
## [Flake reference attributes](https://nix.dev/manual/nix/2.32/command-ref/new-cli/nix3-flake#flake-reference-attributes)
...
* `narHash`: The hash of the
  [Nix Archive (NAR) serialisation](https://nix.dev/manual/nix/2.32/store/file-system-object/content-address#serial-nix-archive)
...
## [Types](https://nix.dev/manual/nix/2.32/command-ref/new-cli/nix3-flake#types)

Currently the `type` attribute can be one of the following:

* `indirect`: *The default*. These are symbolic references to flakes
  that are looked up in [the flake registries](https://nix.dev/manual/nix/2.32/command-ref/new-cli/nix3-registry).
  These have the form
  ...
  entry in the registry; see [nix registry](https://nix.dev/manual/nix/2.32/command-ref/new-cli/nix3-registry) for
  details.
...
* `path`: arbitrary local directories. The required attribute `path`
  ...
  Note that the allowed syntax for path values in flake `inputs` may be more restrictive than general Nix, so you may need to use `path:` if your path contains certain special characters. See [Path literals](https://nix.dev/manual/nix/2.32/language/syntax#path-literal)
...
* `tarball`: Tarballs. The location of the tarball is specified by the
  ...
  This can also be used to set the location of gitea/forgejo branches. [See here](https://nix.dev/manual/nix/2.32/protocols/tarball-fetcher#gitea-and-forgejo-support)
...
# [Flake format](https://nix.dev/manual/nix/2.32/command-ref/new-cli/nix3-flake#flake-format)

As an example, here is a simple `flake.nix` that depends on the
Nixpkgs flake and provides a single package (i.e. an
[installable](https://nix.dev/manual/nix/2.32/command-ref/new-cli/nix#installables) derivation):
...
* `nixConfig`: a set of `nix.conf` options to be set when evaluating any
  ...
  set of options is allowed to be set without confirmation so long as [`accept-flake-config`](https://nix.dev/manual/nix/2.32/command-ref/conf-file#conf-accept-flake-config) is not enabled in the global configuration:
...
## [Flake inputs](https://nix.dev/manual/nix/2.32/command-ref/new-cli/nix3-flake#flake-inputs)
...
## [Self-attributes](https://nix.dev/manual/nix/2.32/command-ref/new-cli/nix3-flake#self-attributes)
...
# [Lock files](https://nix.dev/manual/nix/2.32/command-ref/new-cli/nix3-flake#lock-files)
...
* `locked`: The locked input specification, as a set of
  ...
  contents of the tree in the Nix store (as computed by `nix hash-path`), and may include input-type-specific attributes such as
...
# [Options](https://nix.dev/manual/nix/2.32/command-ref/new-cli/nix3-flake#options)

## [Logging-related options](https://nix.dev/manual/nix/2.32/command-ref/new-cli/nix3-flake#logging-related-options)

* [`--debug`](https://nix.dev/manual/nix/2.32/command-ref/new-cli/nix3-flake#opt-debug)

  Set the logging verbosity level to 'debug'.
* [`--log-format`](https://nix.dev/manual/nix/2.32/command-ref/new-cli/nix3-flake#opt-log-format) *format*

  Set the format of log output; one of `raw`, `internal-json`, `bar` or `bar-with-logs`.
* [`--print-build-logs`](https://nix.dev/manual/nix/2.32/command-ref/new-cli/nix3-flake#opt-print-build-logs) / `-L`

  Print full build logs on standard error.
* [`--quiet`](https://nix.dev/manual/nix/2.32/command-ref/new-cli/nix3-flake#opt-quiet)

  Decrease the logging verbosity level.
* [`--verbose`](https://nix.dev/manual/nix/2.32/command-ref/new-cli/nix3-flake#opt-verbose) / `-v`

  Increase the logging verbosity level.

## [Miscellaneous global options](https://nix.dev/manual/nix/2.32/command-ref/new-cli/nix3-flake#miscellaneous-global-options)

* [`--help`](https://nix.dev/manual/nix/2.32/command-ref/new-cli/nix3-flake#opt-help)

  Show usage information.
* [`--offline`](https://nix.dev/manual/nix/2.32/command-ref/new-cli/nix3-flake#opt-offline)

  Disable substituters and consider all previously downloaded files up-to-date.
* [`--option`](https://nix.dev/manual/nix/2.32/command-ref/new-cli/nix3-flake#opt-option) *name* *value*

  Set the Nix configuration setting *name* to *value* (overriding `nix.conf`).
* [`--refresh`](https://nix.dev/manual/nix/2.32/command-ref/new-cli/nix3-flake#opt-refresh)

  Consider all previously downloaded files out-of-date.
* [`--version`](https://nix.dev/manual/nix/2.32/command-ref/new-cli/nix3-flake#opt-version)
