---
url: https://nix.dev/manual/nix/2.32/command-ref/nix-store/generate-binary-cache-key
title: nix-store --generate-binary-cache-key - Nix 2.32.2 Reference Manual
source_domain: nix.dev
---

# nix-store --generate-binary-cache-key - Nix 2.32.2 Reference Manual

# [Name](https://nix.dev/manual/nix/2.32/command-ref/nix-store/generate-binary-cache-key#name)

`nix-store --generate-binary-cache-key` - generate key pair to use for a binary cache

## [Synopsis](https://nix.dev/manual/nix/2.32/command-ref/nix-store/generate-binary-cache-key#synopsis)

`nix-store` `--generate-binary-cache-key` *key-name* *secret-key-file* *public-key-file*

## [Description](https://nix.dev/manual/nix/2.32/command-ref/nix-store/generate-binary-cache-key#description)
...
# [Options](https://nix.dev/manual/nix/2.32/command-ref/nix-store/generate-binary-cache-key#options)

The following options are allowed for all `nix-store` operations, but may not always have an effect.

* [`--add-root`](https://nix.dev/manual/nix/2.32/command-ref/nix-store/generate-binary-cache-key#opt-add-root) *path*
...
# [Common Options](https://nix.dev/manual/nix/2.32/command-ref/nix-store/generate-binary-cache-key#common-options)

Most Nix commands accept the following command-line options:

* [`--help`](https://nix.dev/manual/nix/2.32/command-ref/nix-store/generate-binary-cache-key#opt-help)

  Prints out a summary of the command syntax and exits.
* [`--version`](https://nix.dev/manual/nix/2.32/command-ref/nix-store/generate-binary-cache-key#opt-version)

  Prints out the Nix version number on standard output and exits.
* [`--verbose`](https://nix.dev/manual/nix/2.32/command-ref/nix-store/generate-binary-cache-key#opt-verbose) / `-v`
...
* [`--quiet`](https://nix.dev/manual/nix/2.32/command-ref/nix-store/generate-binary-cache-key#opt-quiet)
...
* [`--log-format`](https://nix.dev/manual/nix/2.32/command-ref/nix-store/generate-binary-cache-key#opt-log-format) *format*
...
* [`--no-build-output`](https://nix.dev/manual/nix/2.32/command-ref/nix-store/generate-binary-cache-key#opt-no-build-output) / `-Q`
...
* [`--max-jobs`](https://nix.dev/manual/nix/2.32/command-ref/nix-store/generate-binary-cache-key#opt-max-jobs) / `-j` *number*
...
* [`--cores`](https://nix.dev/manual/nix/2.32/command-ref/nix-store/generate-binary-cache-key#opt-cores)
...
* [`--max-silent-time`](https://nix.dev/manual/nix/2.32/command-ref/nix-store/generate-binary-cache-key#opt-max-silent-time)
  ...
  `0` means no time-out.
* [`--timeout`](https://nix.dev/manual/nix/2.32/command-ref/nix-store/generate-binary-cache-key#opt-timeout)

  Sets the maximum number of seconds that a builder can run.
  The default is specified by the `timeout` configuration setting.
  `0` means no timeout.
* [`--keep-going`](https://nix.dev/manual/nix/2.32/command-ref/nix-store/generate-binary-cache-key#opt-keep-going) / `-k`
...
* [`--keep-failed`](https://nix.dev/manual/nix/2.32/command-ref/nix-store/generate-binary-cache-key#opt-keep-failed) / `-K`
...
* [`--fallback`](https://nix.dev/manual/nix/2.32/command-ref/nix-store/generate-binary-cache-key#opt-fallback)
...
* [`--readonly-mode`](https://nix.dev/manual/nix/2.32/command-ref/nix-store/generate-binary-cache-key#opt-readonly-mode)
...
* [`--arg`](https://nix.dev/manual/nix/2.32/command-ref/nix-store/generate-binary-cache-key#opt-arg) *name* *value*
...
* [`--arg-from-file`](https://nix.dev/manual/nix/2.32/command-ref/nix-store/generate-binary-cache-key#opt-arg-from-file) *name* *path*

  Pass the contents of file *path* as the argument *name* to Nix functions.
* [`--arg-from-stdin`](https://nix.dev/manual/nix/2.32/command-ref/nix-store/generate-binary-cache-key#opt-arg-from-stdin) *name*

  Pass the contents of stdin as the argument *name* to Nix functions.
* [`--argstr`](https://nix.dev/manual/nix/2.32/command-ref/nix-store/generate-binary-cache-key#opt-argstr) *name* *value*
...
* [`--attr`](https://nix.dev/manual/nix/2.32/command-ref/nix-store/generate-binary-cache-key#opt-attr) / `-A` *attrPath*
...
* [`--eval-store`](https://nix.dev/manual/nix/2.32/command-ref/nix-store/generate-binary-cache-key#opt-eval-store) *store-url*
...
* [`--expr`](https://nix.dev/manual/nix/2.32/command-ref/nix-store/generate-binary-cache-key#opt-expr) / `-E`
...
* [`-I` / `--include`](https://nix.dev/manual/nix/2.32/command-ref/nix-store/generate-binary-cache-key#opt-I) *path*
...
* [`--impure`](https://nix.dev/manual/nix/2.32/command-ref/nix-store/generate-binary-cache-key#opt-impure)

  Allow access to mutable paths and repositories.
* [`--option`](https://nix.dev/manual/nix/2.32/command-ref/nix-store/generate-binary-cache-key#opt-option) *name* *value*

  Set the Nix configuration option *name* to *value*.
  This overrides settings in the Nix configuration file (see nix.conf5).
* [`--repair`](https://nix.dev/manual/nix/2.32/command-ref/nix-store/generate-binary-cache-key#opt-repair)
...
# [Common Environment Variables](https://nix.dev/manual/nix/2.32/command-ref/nix-store/generate-binary-cache-key#common-environment-variables)

Most Nix commands interpret the following environment variables:

* [`IN_NIX_SHELL`](https://nix.dev/manual/nix/2.32/command-ref/nix-store/generate-binary-cache-key#env-IN_NIX_SHELL)

  Indicator that tells if the current environment was set up by
  `nix-shell`. It can have the values `pure` or `impure`.
* [`NIX_PATH`](https://nix.dev/manual/nix/2.32/command-ref/nix-store/generate-binary-cache-key#env-NIX_PATH)
  ...
  > ```
* [`NIX_IGNORE_SYMLINK_STORE`](https://nix.dev/manual/nix/2.32/command-ref/nix-store/generate-binary-cache-key#env-NIX_IGNORE_SYMLINK_STORE)
...
* [`NIX_STORE_DIR`](https://nix.dev/manual/nix/2.32/command-ref/nix-store/generate-binary-cache-key#env-NIX_STORE_DIR)

  Overrides the location of the Nix store (default `prefix/store`).
* [`NIX_DATA_DIR`](https://nix.dev/manual/nix/2.32/command-ref/nix-store/generate-binary-cache-key#env-NIX_DATA_DIR)

  Overrides the location of the Nix static data directory (default
  `prefix/share`).
* [`NIX_LOG_DIR`](https://nix.dev/manual/nix/2.32/command-ref/nix-store/generate-binary-cache-key#env-NIX_LOG_DIR)

  Overrides the location of the Nix log directory (default
  `prefix/var/log/nix`).
* [`NIX_STATE_DIR`](https://nix.dev/manual/nix/2.32/command-ref/nix-store/generate-binary-cache-key#env-NIX_STATE_DIR)

  Overrides the location of the Nix state directory (default
  `prefix/var/nix`).
* [`NIX_CONF_DIR`](https://nix.dev/manual/nix/2.32/command-ref/nix-store/generate-binary-cache-key#env-NIX_CONF_DIR)

  Overrides the location of the system Nix configuration directory
  (default `sysconfdir/nix`, i.e. `/etc/nix` on most systems).
* [`NIX_CONFIG`](https://nix.dev/manual/nix/2.32/command-ref/nix-store/generate-binary-cache-key#env-NIX_CONFIG)

  Applies settings from Nix configuration from the environment.
  The content is treated as if it was read from a Nix configuration file.
  Settings are separated by the newline character.
* [`NIX_USER_CONF_FILES`](https://nix.dev/manual/nix/2.32/command-ref/nix-store/generate-binary-cache-key#env-NIX_USER_CONF_FILES)
  ...
  See the [XDG Base Directories](https://nix.dev/manual/nix/2.32/command-ref/nix-store/generate-binary-cache-key#xdg-base-directories) sub-section for details.

  The variable is treated as a list separated by the `:` token.
* [`TMPDIR`](https://nix.dev/manual/nix/2.32/command-ref/nix-store/generate-binary-cache-key#env-TMPDIR)

  Use the specified directory to store temporary files. In particular,
  this includes temporary build directories; these can take up
  substantial amounts of disk space. The default is `/tmp`.
* [`NIX_REMOTE`](https://nix.dev/manual/nix/2.32/command-ref/nix-store/generate-binary-cache-key#env-NIX_REMOTE)
  ...
  left unset.
* [`NIX_SHOW_STATS`](https://nix.dev/manual/nix/2.32/command-ref/nix-store/generate-binary-cache-key#env-NIX_SHOW_STATS)

  If set to `1`, Nix will print some evaluation statistics, such as
  the number of values allocated.
* [`NIX_COUNT_CALLS`](https://nix.dev/manual/nix/2.32/command-ref/nix-store/generate-binary-cache-key#env-NIX_COUNT_CALLS)

  If set to `1`, Nix will print how often functions were called during
  Nix expression evaluation. This is useful for profiling your Nix
  expressions.
* [`GC_INITIAL_HEAP_SIZE`](https://nix.dev/manual/nix/2.32/command-ref/nix-store/generate-binary-cache-key#env-GC_INITIAL_HEAP_SIZE)
...
## [XDG Base Directories](https://nix.dev/manual/nix/2.32/command-ref/nix-store/generate-binary-cache-key#xdg-base-directories)
...
* [`XDG_CONFIG_HOME`](https://nix.dev/manual/nix/2.32/command-ref/nix-store/generate-binary-cache-key#env-XDG_CONFIG_HOME) (default `~/.config`)
* [`XDG_STATE_HOME`](https://nix.dev/manual/nix/2.32/command-ref/nix-store/generate-binary-cache-key#env-XDG_STATE_HOME) (default `~/.local/state`)
* [`XDG_CACHE_HOME`](https://nix.dev/manual/nix/2.32/command-ref/nix-store/generate-binary-cache-key#env-XDG_CACHE_HOME) (default `~/.cache`)

In addition, setting the following environment variables overrides the XDG base directories:

* [`NIX_CONFIG_HOME`](https://nix.dev/manual/nix/2.32/command-ref/nix-store/generate-binary-cache-key#env-NIX_CONFIG_HOME) (default `$XDG_CONFIG_HOME/nix`)
* [`NIX_STATE_HOME`](https://nix.dev/manual/nix/2.32/command-ref/nix-store/generate-binary-cache-key#env-NIX_STATE_HOME) (default `$XDG_STATE_HOME/nix`)
* [`NIX_CACHE_HOME`](https://nix.dev/manual/nix/2.32/command-ref/nix-store/generate-binary-cache-key#env-NIX_CACHE_HOME) (default `$XDG_CACHE_HOME/nix`)
