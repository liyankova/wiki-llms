---
url: https://nix.dev/manual/nix/2.32/command-ref/nix-store/repair-path
title: nix-store --repair-path - Nix 2.32.2 Reference Manual
source_domain: nix.dev
---

# nix-store --repair-path - Nix 2.32.2 Reference Manual

# [Name](https://nix.dev/manual/nix/2.32/command-ref/nix-store/repair-path#name)

`nix --repair-path` - re-download path from substituter

# [Synopsis](https://nix.dev/manual/nix/2.32/command-ref/nix-store/repair-path#synopsis)

`nix-store` `--repair-path` *paths…*

# [Description](https://nix.dev/manual/nix/2.32/command-ref/nix-store/repair-path#description)
...
# [Example](https://nix.dev/manual/nix/2.32/command-ref/nix-store/repair-path#example)
