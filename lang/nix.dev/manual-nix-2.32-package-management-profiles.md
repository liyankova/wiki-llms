---
url: https://nix.dev/manual/nix/2.32/package-management/profiles
...
# [Profiles](https://nix.dev/manual/nix/2.32/package-management/profiles#profiles)
...
![](https://nix.dev/manual/nix/2.32/figures/user-environments.png)
...
used as a root of the [garbage collector](https://nix.dev/manual/nix/2.32/package-management/garbage-collection).
