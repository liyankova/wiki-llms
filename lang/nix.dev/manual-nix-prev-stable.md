---
url: https://nix.dev/manual/nix/prev-stable/
...
# [Introduction](https://nix.dev/manual/nix/prev-stable/#introduction)
...
## [Multiple versions](https://nix.dev/manual/nix/prev-stable/#multiple-versions)
...
## [Complete dependencies](https://nix.dev/manual/nix/prev-stable/#complete-dependencies)
...
## [Multi-user support](https://nix.dev/manual/nix/prev-stable/#multi-user-support)
...
## [Atomic upgrades and rollbacks](https://nix.dev/manual/nix/prev-stable/#atomic-upgrades-and-rollbacks)
...
## [Garbage collection](https://nix.dev/manual/nix/prev-stable/#garbage-collection)
...
## [Functional package language](https://nix.dev/manual/nix/prev-stable/#functional-package-language)
...
## [Transparent source/binary deployment](https://nix.dev/manual/nix/prev-stable/#transparent-sourcebinary-deployment)
...
## [Nix Packages collection](https://nix.dev/manual/nix/prev-stable/#nix-packages-collection)
...
## [Managing build environments](https://nix.dev/manual/nix/prev-stable/#managing-build-environments)
...
## [Portability](https://nix.dev/manual/nix/prev-stable/#portability)

Nix runs on Linux and macOS.

## [NixOS](https://nix.dev/manual/nix/prev-stable/#nixos)
...
## [License](https://nix.dev/manual/nix/prev-stable/#license)
