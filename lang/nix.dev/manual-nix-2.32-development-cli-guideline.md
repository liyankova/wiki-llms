---
url: https://nix.dev/manual/nix/2.32/development/cli-guideline
title: CLI guideline - Nix 2.32.2 Reference Manual
source_domain: nix.dev
---

# CLI guideline - Nix 2.32.2 Reference Manual

# [CLI guideline](https://nix.dev/manual/nix/2.32/development/cli-guideline#cli-guideline)

## [Goals](https://nix.dev/manual/nix/2.32/development/cli-guideline#goals)
...
## [Overview](https://nix.dev/manual/nix/2.32/development/cli-guideline#overview)
...
# [Naming the `COMMANDS`](https://nix.dev/manual/nix/2.32/development/cli-guideline#naming-the-commands)
...
## [Naming rules](https://nix.dev/manual/nix/2.32/development/cli-guideline#naming-rules)
...
1: Commands naming exceptions](https://nix.dev/manual/nix/2.32/development/cli-guideline#appendix-1-commands-naming-exceptions) and
...
* `ARGUMENTS` and `OPTIONS` are discussed in [*Input* section](https://nix.dev/manual/nix/2.32/development/cli-guideline#input).

## [Classification](https://nix.dev/manual/nix/2.32/development/cli-guideline#classification)
...
* **Main commands**
  ...
  + Proper use of [colors](https://nix.dev/manual/nix/2.32/development/cli-guideline#colors), [emojis](https://nix.dev/manual/nix/2.32/development/cli-guideline#special-unicode-characters)
    and [aligning of text](https://nix.dev/manual/nix/2.32/development/cli-guideline#text-alignment).
  + [Autocomplete](https://nix.dev/manual/nix/2.32/development/cli-guideline#shell-completion) of options.
  + Show [next possible steps](https://nix.dev/manual/nix/2.32/development/cli-guideline#next-steps).
  + Showing some [“tips”](https://nix.dev/manual/nix/2.32/development/cli-guideline#educate-the-user) when running logs running tasks
    (eg. building / downloading) in order to teach users interesting bits of
    Nix ecosystem.
  + [Help pages](https://nix.dev/manual/nix/2.32/development/cli-guideline#help-is-essential) to be as good as we can write them
...
# [Help is essential](https://nix.dev/manual/nix/2.32/development/cli-guideline#help-is-essential)

Help should be built into your command line so that new users can gradually
discover new features when they need them.

## [Looking for help](https://nix.dev/manual/nix/2.32/development/cli-guideline#looking-for-help)
...
## [Anticipate where help is needed](https://nix.dev/manual/nix/2.32/development/cli-guideline#anticipate-where-help-is-needed)
...
### [Shell completion](https://nix.dev/manual/nix/2.32/development/cli-guideline#shell-completion)
...
### [Wrong input](https://nix.dev/manual/nix/2.32/development/cli-guideline#wrong-input)
...
### [Next steps](https://nix.dev/manual/nix/2.32/development/cli-guideline#next-steps)
...
### [Educate the user](https://nix.dev/manual/nix/2.32/development/cli-guideline#educate-the-user)
...
# [Input](https://nix.dev/manual/nix/2.32/development/cli-guideline#input)
...
## [Naming the `OPTIONS`](https://nix.dev/manual/nix/2.32/development/cli-guideline#naming-the-options)
...
## [Prompt when input not provided](https://nix.dev/manual/nix/2.32/development/cli-guideline#prompt-when-input-not-provided)

For *main commands* (as [per classification](https://nix.dev/manual/nix/2.32/development/cli-guideline#classification)) we want command
...
# [Output](https://nix.dev/manual/nix/2.32/development/cli-guideline#output)
...
## [Follow best practices](https://nix.dev/manual/nix/2.32/development/cli-guideline#follow-best-practices)
...
## [Errors (WIP)](https://nix.dev/manual/nix/2.32/development/cli-guideline#errors-wip)

**TODO**: Once we have implementation for the *happy path* then we will think
how to present errors.

## [Not only for humans](https://nix.dev/manual/nix/2.32/development/cli-guideline#not-only-for-humans)
...
## [Dialog with the user](https://nix.dev/manual/nix/2.32/development/cli-guideline#dialog-with-the-user)
...
## [Text alignment](https://nix.dev/manual/nix/2.32/development/cli-guideline#text-alignment)
...
## [Dim / Bright](https://nix.dev/manual/nix/2.32/development/cli-guideline#dim--bright)
...
## [Colors](https://nix.dev/manual/nix/2.32/development/cli-guideline#colors)
...
## [Special (Unicode) characters](https://nix.dev/manual/nix/2.32/development/cli-guideline#special-unicode-characters)
...
## [Emojis](https://nix.dev/manual/nix/2.32/development/cli-guideline#emojis)
...
## [Tables](https://nix.dev/manual/nix/2.32/development/cli-guideline#tables)
...
## [Interactive output](https://nix.dev/manual/nix/2.32/development/cli-guideline#interactive-output)
...
### [Progress](https://nix.dev/manual/nix/2.32/development/cli-guideline#progress)
...
### [Search](https://nix.dev/manual/nix/2.32/development/cli-guideline#search)
...
### [Prompt](https://nix.dev/manual/nix/2.32/development/cli-guideline#prompt)
...
## [Verbosity](https://nix.dev/manual/nix/2.32/development/cli-guideline#verbosity)
...
# [Appendix 1: Commands naming exceptions](https://nix.dev/manual/nix/2.32/development/cli-guideline#appendix-1-commands-naming-exceptions)
