---
url: https://nix.dev/tutorials/cross-compilation
title: Cross compilation — nix.dev  documentation
source_domain: nix.dev
---

# Cross compilation — nix.dev  documentation

[Skip to main content](https://nix.dev/tutorials/cross-compilation#main-content)
...
* [.md](https://nix.dev/_sources/tutorials/cross-compilation.md "Download source file")

# Cross compilation

# Cross compilation[#](https://nix.dev/tutorials/cross-compilation#cross-compilation "Link to this heading")

Nixpkgs offers powerful tools to cross-compile software for various system types.

## What do you need?[#](https://nix.dev/tutorials/cross-compilation#what-do-you-need "Link to this heading")
...
## Platforms[#](https://nix.dev/tutorials/cross-compilation#platforms "Link to this heading")

When compiling code, we can distinguish between the **build platform**, where the executable is *built*, and the **host platform**, where the compiled executable *runs*. [[1]](https://nix.dev/tutorials/cross-compilation#id3)
...
## What’s a target platform?[#](https://nix.dev/tutorials/cross-compilation#what-s-a-target-platform "Link to this heading")
...
## Determining the host platform config[#](https://nix.dev/tutorials/cross-compilation#determining-the-host-platform-config "Link to this heading")
...
## Choosing the host platform with Nix[#](https://nix.dev/tutorials/cross-compilation#choosing-the-host-platform-with-nix "Link to this heading")
...
## Specifying the host platform[#](https://nix.dev/tutorials/cross-compilation#specifying-the-host-platform "Link to this heading")
...
## Cross compiling for the first time[#](https://nix.dev/tutorials/cross-compilation#cross-compiling-for-the-first-time "Link to this heading")
...
## Real-world cross compiling of a Hello World example[#](https://nix.dev/tutorials/cross-compilation#real-world-cross-compiling-of-a-hello-world-example "Link to this heading")
...
## Developer environment with a cross compiler[#](https://nix.dev/tutorials/cross-compilation#developer-environment-with-a-cross-compiler "Link to this heading")

In the [tutorial for declarative reproducible environments](https://nix.dev/tutorials/first-steps/declarative-shell#declarative-reproducible-envs), we looked at how Nix helps us provide tooling and system libraries for our project.
...
## Next steps[#](https://nix.dev/tutorials/cross-compilation#next-steps "Link to this heading")

* The [official binary cache](https://cache.nixos.org) has a limited number of binaries for packages that are cross compiled, so to save time recompiling, configure [your own binary cache and CI with GitHub Actions](https://nix.dev/guides/recipes/continuous-integration-github-actions#github-actions).
