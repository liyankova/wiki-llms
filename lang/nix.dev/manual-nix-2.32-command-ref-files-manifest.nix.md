---
url: https://nix.dev/manual/nix/2.32/command-ref/files/manifest.nix
title: manifest.nix - Nix 2.32.2 Reference Manual
source_domain: nix.dev
---

# manifest.nix - Nix 2.32.2 Reference Manual

## [`manifest.nix`](https://nix.dev/manual/nix/2.32/command-ref/files/manifest.nix#manifestnix)

The manifest file records the provenance of the packages that are installed in a [profile](https://nix.dev/manual/nix/2.32/command-ref/files/profiles) managed by [`nix-env`](https://nix.dev/manual/nix/2.32/command-ref/nix-env).
