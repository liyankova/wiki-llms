---
url: https://nix.dev/contributing/documentation/writing-a-tutorial
title: How to write a tutorial — nix.dev  documentation
source_domain: nix.dev
---

# How to write a tutorial — nix.dev  documentation

[Skip to main content](https://nix.dev/contributing/documentation/writing-a-tutorial#main-content)
...
* [.md](https://nix.dev/_sources/contributing/documentation/writing-a-tutorial.md "Download source file")

# How to write a tutorial

# How to write a tutorial[#](https://nix.dev/contributing/documentation/writing-a-tutorial#how-to-write-a-tutorial "Link to this heading")
...
## Target audience[#](https://nix.dev/contributing/documentation/writing-a-tutorial#target-audience "Link to this heading")
...
## Process[#](https://nix.dev/contributing/documentation/writing-a-tutorial#process "Link to this heading")
...
### Pick a topic[#](https://nix.dev/contributing/documentation/writing-a-tutorial#pick-a-topic "Link to this heading")
...
### Submit a pull request with an outline[#](https://nix.dev/contributing/documentation/writing-a-tutorial#submit-a-pull-request-with-an-outline "Link to this heading")

Submit a pull request with an outline of the tutorial following [our recommended structure](https://nix.dev/contributing/documentation/writing-a-tutorial#structure).
...
### Expand on the outline[#](https://nix.dev/contributing/documentation/writing-a-tutorial#expand-on-the-outline "Link to this heading")

Elaborate the contents of the tutorial following your outline and the [Style guide](https://nix.dev/contributing/documentation/style-guide).

A review will ensure that you get all the required information in the right order without overwhelming learners.

### Follow up on review comments[#](https://nix.dev/contributing/documentation/writing-a-tutorial#follow-up-on-review-comments "Link to this heading")
...
## Structure[#](https://nix.dev/contributing/documentation/writing-a-tutorial#structure "Link to this heading")
...
### What will you learn?[#](https://nix.dev/contributing/documentation/writing-a-tutorial#what-will-you-learn "Link to this heading")
...
### What do you need?[#](https://nix.dev/contributing/documentation/writing-a-tutorial#what-do-you-need "Link to this heading")
...
### How long does it take?[#](https://nix.dev/contributing/documentation/writing-a-tutorial#how-long-does-it-take "Link to this heading")
...
### What to do?[#](https://nix.dev/contributing/documentation/writing-a-tutorial#what-to-do "Link to this heading")
...
### What did you learn?[#](https://nix.dev/contributing/documentation/writing-a-tutorial#what-did-you-learn "Link to this heading")
...
### Next steps[#](https://nix.dev/contributing/documentation/writing-a-tutorial#next-steps "Link to this heading")
