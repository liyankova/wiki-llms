---
url: https://nix.dev/contributing/documentation/style-guide
title: Style guide — nix.dev  documentation
source_domain: nix.dev
---

# Style guide — nix.dev  documentation

[Skip to main content](https://nix.dev/contributing/documentation/style-guide#main-content)
...
* [.md](https://nix.dev/_sources/contributing/documentation/style-guide.md "Download source file")

# Style guide

# Style guide[#](https://nix.dev/contributing/documentation/style-guide#style-guide "Link to this heading")

This document outlines the guidelines we use when writing documentation.

## Writing style[#](https://nix.dev/contributing/documentation/style-guide#writing-style "Link to this heading")

### Aim for clarity and brevity[#](https://nix.dev/contributing/documentation/style-guide#aim-for-clarity-and-brevity "Link to this heading")
...
### Use inclusive language[#](https://nix.dev/contributing/documentation/style-guide#use-inclusive-language "Link to this heading")

Adapted from [Contributor Covenant](https://github.com/EthicalSource/contributor_covenant/blob/cd7fcf684249786b7f7d47ba49c23a6bcb3233eb/content/version/2/1/code_of_conduct.md) and [The Carpentries Code of Conduct](https://github.com/carpentries/docs.carpentries.org/blob/fb188fa8d7f57ad85eb525091e335ed0d8fea16d/source/policies/coc/index.md#L13-L19):
...
### Voice[#](https://nix.dev/contributing/documentation/style-guide#voice "Link to this heading")
...
### Be correct, cite sources[#](https://nix.dev/contributing/documentation/style-guide#be-correct-cite-sources "Link to this heading")
...
## Markup and source[#](https://nix.dev/contributing/documentation/style-guide#markup-and-source "Link to this heading")

### Code samples[#](https://nix.dev/contributing/documentation/style-guide#code-samples "Link to this heading")
...
### Headers[#](https://nix.dev/contributing/documentation/style-guide#headers "Link to this heading")
...
### One line per sentence[#](https://nix.dev/contributing/documentation/style-guide#one-line-per-sentence "Link to this heading")
...
### Links[#](https://nix.dev/contributing/documentation/style-guide#links "Link to this heading")
