...
Desktop app available in beta on macOS, Windows, and Linux.[Download now](https://opencode.ai/download)[Download the desktop beta now](https://opencode.ai/download)

# The open source AI coding agent

Free models included or connect any model from any provider, including Claude, GPT, Gemini and more.

[![Your browser does not support the video tag.](/_build/assets/opencode-poster-CbUiDHgA.png)](/_build/assets/opencode-min-CiEsORKQ.mp4)
...
Fig 1. **50K** GitHub Stars

Fig 2. **500** Contributors

Fig 3. **650,000** Monthly Devs
