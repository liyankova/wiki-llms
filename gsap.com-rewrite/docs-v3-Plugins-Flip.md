...
## How do I flip between two *different* elements?[​](https://gsap.com/docs/v3/Plugins/Flip#how-do-i-flip-between-two-different-elements "Direct link to how-do-i-flip-between-two-different-elements")
