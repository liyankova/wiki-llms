---
url: https://gsap.com/docs/v3/Plugins/
...
* [Responsivity & Accessibility - matchMedia()](https://gsap.com/docs/v3/GSAP/gsap.matchMedia())
...
* [ScrollTrigger](https://gsap.com/docs/v3/Plugins/ScrollTrigger)popular
* [ScrollTo](https://gsap.com/docs/v3/Plugins/ScrollToPlugin)
* [ScrollSmoother](https://gsap.com/docs/v3/Plugins/ScrollSmoother)

  requires [ScrollTrigger](https://gsap.com/docs/v3/Plugins/ScrollTrigger)

### Text Plugins

* [SplitText](https://gsap.com/docs/v3/Plugins/SplitText)popular
* [ScrambleText](https://gsap.com/docs/v3/Plugins/ScrambleTextPlugin)
* [Text Replacement](https://gsap.com/docs/v3/Plugins/TextPlugin)

### SVG Plugins

* [DrawSVG](https://gsap.com/docs/v3/Plugins/DrawSVGPlugin)popular
...
* [Flip](https://gsap.com/docs/v3/Plugins/Flip)popular
...
* [CustomEase](https://gsap.com/docs/v3/Eases/CustomEase)popular
* [EasePack](https://gsap.com/docs/v3/Eases/CustomWiggle)

  [rough](https://gsap.com/docs/v3/Eases/RoughEase), [slow](https://gsap.com/docs/v3/Eases/SlowMo), and [expoScale](https://gsap.com/docs/v3/Eases/ExpoScaleEase)
* [CustomWiggle](https://gsap.com/docs/v3/Eases/CustomWiggle)

  requires [CustomEase](https://gsap.com/docs/v3/Eases/CustomEase)
* [CustomBounce](https://gsap.com/docs/v3/Eases/CustomBounce)

  requires [CustomEase](https://gsap.com/docs/v3/Eases/CustomEasee)
